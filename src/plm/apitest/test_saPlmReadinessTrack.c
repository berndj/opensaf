...
void getDn(int i)
{
	...
	case 1:
		...
		memcpy(entarr[0].testDnptr.value, f120_slot_1_dn.value,
	...
	case 2:
		...
		memcpy(entarr[2].testDnptr.value, amc_slot_1_eedn.value,
		       amc_slot_1_eedn.length);
		entarr[2].testDnptr.length = amc_slot_1_eedn.length;
		strcpy(entarr[2].enitytype, "EE");
		memcpy(entarr[3].testDnptr.value, f120_slot_1_eedn.value,
	...
	case 3:
		...
		entarr[0].testDnptr.length = f120_slot_1_dn.length;
		strcpy(entarr[0].enitytype, "HE");
		memcpy(entarr[1].testDnptr.value, f120_slot_1_eedn.value,
		       f120_slot_1_eedn.length);
...
void TrackCallback_01(SaPlmEntityGroupHandleT entityGroupHandle,
		      SaUint64T trackCookie, SaInvocationT invocation,
		      SaPlmTrackCauseT cause, const SaNameT *rootCauseEntity,
...
void TrackCallback_02(SaPlmEntityGroupHandleT entityGroupHandle,
		      SaUint64T trackCookie, SaInvocationT invocation,
		      SaPlmTrackCauseT cause, const SaNameT *rootCauseEntity,
		      SaNtfIdentifierT rootCorrelationId,
		      const SaPlmReadinessTrackedEntitiesT *trackedEntities,
...
void TrackCallback_03(SaPlmEntityGroupHandleT entityGroupHandle,
		      SaUint64T trackCookie, SaInvocationT invocation,
		      SaPlmTrackCauseT cause, const SaNameT *rootCauseEntity,
		      SaNtfIdentifierT rootCorrelationId,
		      const SaPlmReadinessTrackedEntitiesT *trackedEntities,
...
static void
checktrackentval(const SaPlmReadinessTrackedEntitiesT *trackedEntities)
{
	int i, j;
	if (trackedEntities->numberOfEntities != num_elements) {
		...
		for (i = 0; i < trackedEntities->numberOfEntities; i++) {
			for (j = 0; j < num_elements; j++) {
				rc_from_test = SA_AIS_INVALID_TRACKENTITY;
				/*
				if ((strcmp(groupaddoption,"subtreeEE")) == 0 &&
				(i > 0))
				{
				    if( (strncmp(entarr[j].enitytype,"EE",2)) !=
				0 ) { continue;
				    }
				} else if ((strcmp(groupaddoption,"subtreeHE"))
				== 0)
				{
				...
				if (((trackedEntities->entities + i)
					 ->entityName.length ==
				     entarr[j].testDnptr.length) &&
				    memcmp((trackedEntities->entities + i)
					       ->entityName.value,
					   entarr[j].testDnptr.value,
					   entarr[j].testDnptr.length) == 0) {
...
void InitTrackingTest(int i, SaPlmGroupOptionsT groupaddoption,
		      SaUint8T trackingoption)
{
	...
	while (select(selectionObject + 1, &read_fd, 0, 0, NULL) > 0) {
		...
		if (FD_ISSET(selectionObject, &read_fd)) {
			safassert(saPlmDispatch(plmHandle, SA_DISPATCH_ONE),
				  SA_AIS_OK);
...
void saPlmReadinessTrack_05(void)
{
	...
	memcpy(entity_list[0].entityName.value, f120_slot_1_dn.value,
	       f120_slot_1_dn.length);
	entity_list[1].entityName.length = amc_slot_1_dn.length;
	memcpy(entity_list[1].entityName.value, amc_slot_1_dn.value,
	       amc_slot_1_dn.length);
	entity_list[2].entityName.length = amc_slot_1_eedn.length;
	memcpy(entity_list[2].entityName.value, amc_slot_1_eedn.value,
	       amc_slot_1_eedn.length);
	entity_list[3].entityName.length = f120_slot_1_eedn.length;
	memcpy(entity_list[3].entityName.value, f120_slot_1_eedn.value,
	       f120_slot_1_eedn.length);
...
void saPlmReadinessTrack_07(void)
{
	...
	memcpy(entity_list[1].entityName.value, f120_slot_1_eedn.value,
	       f120_slot_1_eedn.length);
	entity_list[2].entityName.length = amc_slot_1_eedn.length;
	memcpy(entity_list[2].entityName.value, amc_slot_1_eedn.value,
	       amc_slot_1_eedn.length);
...
void saPlmReadinessTrack_22(void)
{
	...
	memcpy(entity_list[0].entityName.value, f120_slot_16_dn.value,
...
void saPlmReadinessTrack_25(void)
{
	...
	memset(&entarr[4], 0, sizeof(entity_array));
	memcpy(entarr[1].testDnptr.value, f120_slot_16_dn.value,
	       f120_slot_16_dn.length);
	entarr[1].testDnptr.length = f120_slot_16_dn.length;
	strcpy(entarr[1].enitytype, "HE");
	memcpy(entarr[2].testDnptr.value, amc_slot_16_dn.value,
	       amc_slot_16_dn.length);
	entarr[2].testDnptr.length = amc_slot_16_dn.length;
	strcpy(entarr[2].enitytype, "HE");
	memcpy(entarr[3].testDnptr.value, f120_slot_16_eedn.value,
	       f120_slot_16_eedn.length);
	entarr[3].testDnptr.length = f120_slot_16_eedn.length;
	strcpy(entarr[3].enitytype, "EE");
	memcpy(entarr[4].testDnptr.value, amc_slot_16_eedn.value,
...
void saPlmReadinessTrack_26(void)
{
	...
	memcpy(entarr[4].testDnptr.value, f120_slot_16_dn.value,
	       f120_slot_16_dn.length);
	entarr[4].testDnptr.length = f120_slot_16_dn.length;
	strcpy(entarr[4].enitytype, "HE");
	memcpy(entarr[5].testDnptr.value, amc_slot_16_dn.value,
	       amc_slot_16_dn.length);
	entarr[5].testDnptr.length = amc_slot_16_dn.length;
	strcpy(entarr[5].enitytype, "HE");
	memcpy(entarr[6].testDnptr.value, amc_slot_16_eedn.value,
	       amc_slot_16_eedn.length);
	entarr[6].testDnptr.length = amc_slot_16_eedn.length;
	strcpy(entarr[6].enitytype, "EE");
	memcpy(entarr[7].testDnptr.value, f120_slot_16_eedn.value,
	       f120_slot_16_eedn.length);
...
void saPlmReadinessTrack_28(void)
{
	...
	memset(&entarr[2], 0, sizeof(entity_array));
	memset(&entarr[3], 0, sizeof(entity_array));
	memcpy(entarr[2].testDnptr.value, f120_slot_16_dn.value,
	       f120_slot_16_dn.length);
	entarr[2].testDnptr.length = f120_slot_16_dn.length;
	strcpy(entarr[2].enitytype, "HE");
	memcpy(entarr[3].testDnptr.value, amc_slot_16_dn.value,
	       amc_slot_16_dn.length);
...
void saPlmReadinessTrack_29(void)
{
	...
	memset(&entarr[4], 0, sizeof(entity_array));
	memset(&entarr[5], 0, sizeof(entity_array));
	memcpy(entarr[3].testDnptr.value, f120_slot_16_dn.value,
	       f120_slot_16_dn.length);
	entarr[3].testDnptr.length = f120_slot_16_dn.length;
	strcpy(entarr[3].enitytype, "HE");
	memcpy(entarr[4].testDnptr.value, f120_slot_16_eedn.value,
	       f120_slot_16_eedn.length);
	entarr[4].testDnptr.length = f120_slot_16_eedn.length;
	strcpy(entarr[4].enitytype, "EE");
	memcpy(entarr[5].testDnptr.value, amc_slot_16_eedn.value,
	       amc_slot_16_eedn.length);
...
void saPlmReadinessTrack_31(void)
{
	...
	entarr[1].testDnptr.length = f120_slot_16_dn.length;
	strcpy(entarr[1].enitytype, "HE");
	memcpy(entarr[2].testDnptr.value, f120_slot_16_eedn.value,
	       f120_slot_16_eedn.length);
	entarr[2].testDnptr.length = f120_slot_16_eedn.length;
	strcpy(entarr[2].enitytype, "EE");
	memcpy(entarr[3].testDnptr.value, amc_slot_16_eedn.value,
	       amc_slot_16_eedn.length);
...
void saPlmReadinessTrack_36(void)
{
	...
	entityGrpHandle = entityGroupHandle;
	memset(&entarr[0], 0, sizeof(entity_array));
	memcpy(entarr[0].testDnptr.value, amc_slot_1_dn.value,
	       amc_slot_1_dn.length);
...
void saPlmReadinessTrack_38(void)
{
	...
	memset(&entarr[1], 0, sizeof(entity_array));
	memset(&entarr[2], 0, sizeof(entity_array));
	memcpy(entarr[0].testDnptr.value, f120_slot_16_dn.value,
	       f120_slot_16_dn.length);
	entarr[0].testDnptr.length = f120_slot_16_dn.length;
	strcpy(entarr[0].enitytype, "HE");
	memcpy(entarr[1].testDnptr.value, f120_slot_16_eedn.value,
	       f120_slot_16_eedn.length);
	entarr[1].testDnptr.length = f120_slot_16_eedn.length;
	strcpy(entarr[1].enitytype, "EE");
	memcpy(entarr[2].testDnptr.value, amc_slot_16_eedn.value,
	       amc_slot_16_eedn.length);
...
void saPlmReadinessTrack_42(void)
{
	...
	entityGrpHandle = entityGroupHandle;
	memset(&entarr[0], 0, sizeof(entity_array));
	memcpy(entarr[0].testDnptr.value, amc_slot_16_dn.value,
	       amc_slot_16_dn.length);
	memcpy(entarr[1].testDnptr.value, amc_slot_16_dn.value,
	       amc_slot_16_dn.length);
...
void saPlmReadinessTrack_44(void)
{
	...
	while (select(selectionObject + 1, &read_fd, 0, 0, NULL) > 0) {
		/* process all the PLM  messages */
		if (FD_ISSET(selectionObject, &read_fd)) {
			safassert(saPlmDispatch(plmHandle, SA_DISPATCH_ALL),
				  SA_AIS_OK);
			FD_CLR(selectionObject, &read_fd);
		}
		break;
