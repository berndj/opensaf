...
#ifndef PLM_COMMON_PLMS_UTILS_H_
...
uint32_t plms_no_aff_ent_in_grp_get(PLMS_ENTITY_GROUP_INFO *,
                                    PLMS_GROUP_ENTITY *);
...
uint32_t plms_peer_async_send(PLMS_ENTITY *, SaPlmChangeStepT,
                              SaPlmTrackCauseT);
...
SaNtfIdentifierT plms_readiness_flag_mark_unmark(PLMS_ENTITY *,
                                                 SaPlmReadinessFlagsT, SaBoolT,
                                                 PLMS_ENTITY *, SaUint16T,
                                                 SaUint16T);
...
uint32_t plms_ee_chld_of_aff_he_find(PLMS_ENTITY *, PLMS_GROUP_ENTITY *,
                                     PLMS_GROUP_ENTITY *, PLMS_GROUP_ENTITY **);
uint32_t plms_ee_not_chld_of_aff_he_find(PLMS_GROUP_ENTITY *,
                                         PLMS_GROUP_ENTITY *,
                                         PLMS_GROUP_ENTITY **);
...
void plms_inv_to_cbk_in_grp_trk_rmv(PLMS_ENTITY_GROUP_INFO *,
                                    PLMS_TRACK_INFO *);
void plms_inv_to_cbk_in_grp_inv_rmv(PLMS_ENTITY_GROUP_INFO *, SaInvocationT);
...
SaUint32T plms_attr_imm_update(PLMS_ENTITY *, SaInt8T *, SaImmValueTypeT,
                               SaUint64T);
...
SaUint32T plms_attr_saname_imm_update(PLMS_ENTITY *, SaInt8T *, SaNameT,
                                      SaImmAttrModificationTypeT);
void plms_dep_immi_flag_check_and_set(PLMS_ENTITY *, PLMS_GROUP_ENTITY **,
                                      SaUint32T *);
#endif  // PLM_COMMON_PLMS_UTILS_H_
