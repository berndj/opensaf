...
#ifndef PLM_COMMON_PLMS_MBCSV_H_
#define PLM_COMMON_PLMS_MBCSV_H_
...
#define m_PLMS_CPY_ENTITY_GROUP_INFO(dptr, sptr)                          \
  {                                                                       \
    ...
    tmp_entity_ptr = sptr->plm_entity_list;                               \
    while (tmp_entity_ptr) {                                              \
      tmp_ckpt_ent_list_ptr =                                             \
          (PLMS_CKPT_ENTITY_LIST *)malloc(sizeof(PLMS_CKPT_ENTITY_LIST)); \
      strcpy((SaInt8T *)tmp_ckpt_ent_list_ptr->entity_name.value,         \
             (SaInt8T *)tmp_entity_ptr->plm_entity->dn_name.value);       \
...
#endif  // PLM_COMMON_PLMS_MBCSV_H_
