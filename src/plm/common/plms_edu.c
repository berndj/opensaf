...
uint32_t plms_edp_agent_lib_req(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
				...
				EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_agent_lib_req_rules[] = {
	    {EDU_START, plms_edp_agent_lib_req, 0, 0, 0,
	     sizeof(PLMS_AGENT_LIB_REQ), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_LIB_REQ *)0)->lib_req_type, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_LIB_REQ *)0)->plm_handle, 0, NULL},
	    {EDU_EXEC, ncs_edp_mds_dest, 0, 0, 0,
	     (long)&((PLMS_AGENT_LIB_REQ *)0)->agent_mdest_id, 0, NULL},
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_agent_grp_op(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
			       NCSCONTEXT ptr, uint32_t *ptr_data_len,
			       EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
			       EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_agent_grp_op_rules[] = {
	    {EDU_START, plms_edp_agent_grp_op, 0, 0, 0,
	     sizeof(PLMS_AGENT_GRP_OP), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->grp_evt_type, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->plm_handle, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->grp_handle, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->entity_names_number, 0, NULL},
	    {EDU_EXEC, ncs_edp_sanamet_old, EDQ_VAR_LEN_DATA, ncs_edp_uns32, 0,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->entity_names,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->entity_names_number, NULL},
	    {EDU_EXEC_EXT, NULL, NCS_SERVICE_ID_PLMS, NULL, 0, 1, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_GRP_OP *)0)->grp_add_option, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
...
uint32_t plms_edp_readiness_status(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
				   NCSCONTEXT ptr, uint32_t *ptr_data_len,
				   EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
				   EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_readiness_status_rules[] = {
	    {EDU_START, plms_edp_readiness_status, 0, 0, 0,
	     sizeof(SaPlmReadinessStatusT), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((SaPlmReadinessStatusT *)0)->readinessState, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((SaPlmReadinessStatusT *)0)->readinessFlags, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_readiness_tracked_entity(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
					   NCSCONTEXT ptr,
					   ...
					   EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_readiness_tracked_entity_rules[] = {
	    {EDU_START, plms_edp_readiness_tracked_entity, 0, 0, 0,
	     sizeof(SaPlmReadinessTrackedEntityT), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((SaPlmReadinessTrackedEntityT *)0)->change, 0, NULL},
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((SaPlmReadinessTrackedEntityT *)0)->entityName, 0, NULL},
	    {EDU_EXEC, plms_edp_readiness_status, 0, 0, 0,
	     (long)&((SaPlmReadinessTrackedEntityT *)0)->currentReadinessStatus,
	     0, NULL},
	    {EDU_EXEC, plms_edp_readiness_status, 0, 0, 0,
	     (long)&((SaPlmReadinessTrackedEntityT *)0)
		 ->expectedReadinessStatus,
	     0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((SaPlmReadinessTrackedEntityT *)0)->plmNotificationId, 0,
	     NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn,
				 plms_readiness_tracked_entity_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
/****************************************************************************
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_readiness_tracked_entities(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
					     NCSCONTEXT ptr,
					     uint32_t *ptr_data_len,
					     EDU_BUF_ENV *buf_env,
					     EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_readiness_tracked_entities_rules[] = {
	    {EDU_START, plms_edp_readiness_tracked_entities, 0, 0, 0,
	     sizeof(SaPlmReadinessTrackedEntitiesT), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((SaPlmReadinessTrackedEntitiesT *)0)->numberOfEntities, 0,
	     NULL},
	    {EDU_EXEC, plms_edp_readiness_tracked_entity, EDQ_VAR_LEN_DATA,
	     ncs_edp_uns32, 0,
	     (long)&((SaPlmReadinessTrackedEntitiesT *)0)->entities,
	     (long)&((SaPlmReadinessTrackedEntitiesT *)0)->numberOfEntities,
	     NULL},
	    {EDU_EXEC_EXT, NULL, NCS_SERVICE_ID_PLMS, NULL, 0, 1, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn,
				 plms_readiness_tracked_entities_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
/****************************************************************************
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_agent_track_start(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
				    NCSCONTEXT ptr, uint32_t *ptr_data_len,
				    EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
				    EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_agent_track_start_rules[] = {
	    {EDU_START, plms_edp_agent_track_start, 0, 0, 0,
	     sizeof(PLMS_AGENT_TRACK_START), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_START *)0)->track_flags, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_START *)0)->track_cookie, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_START *)0)->no_of_entities, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_ntf_correlation_ids(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
				      NCSCONTEXT ptr, uint32_t *ptr_data_len,
				      EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
				      EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_ntf_correlation_ids_rules[] = {
	    {EDU_START, plms_edp_ntf_correlation_ids, 0, 0, 0,
	     sizeof(SaNtfCorrelationIdsT), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((SaNtfCorrelationIdsT *)0)->rootCorrelationId, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((SaNtfCorrelationIdsT *)0)->parentCorrelationId, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((SaNtfCorrelationIdsT *)0)->notificationId, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn,
				 plms_ntf_correlation_ids_rules, struct_ptr,
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_agent_readiness_impact(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
					 NCSCONTEXT ptr, uint32_t *ptr_data_len,
					 EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
					 EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_agent_readiness_impact_rules[] = {
	    {EDU_START, plms_edp_agent_readiness_impact, 0, 0, 0,
	     sizeof(PLMS_AGENT_READINESS_IMPACT), 0, NULL},
	    {EDU_EXEC, ncs_edp_sanamet, EDQ_POINTER, 0, 0,
	     (long)&((PLMS_AGENT_READINESS_IMPACT *)0)->impacted_entity, 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_READINESS_IMPACT *)0)->impact, 0, NULL},
	    {EDU_EXEC, plms_edp_ntf_correlation_ids, 0, 0, 0,
	     (long)&((PLMS_AGENT_READINESS_IMPACT *)0)->correlation_ids, 0,
	     NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn,
				 plms_agent_readiness_impact_rules, struct_ptr,
				 ptr_data_len, buf_env, op, o_err);
	return rc;
}
/****************************************************************************
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_agent_track_cbk_resp(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
				       NCSCONTEXT ptr, uint32_t *ptr_data_len,
				       EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
				       EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_agent_track_cbk_resp_rules[] = {
	    {EDU_START, plms_edp_agent_track_cbk_resp, 0, 0, 0,
	     sizeof(PLMS_TRACK_CBK_RES), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_TRACK_CBK_RES *)0)->invocation_id, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_TRACK_CBK_RES *)0)->response, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn,
				 plms_agent_track_cbk_resp_rules, struct_ptr,
				 ptr_data_len, buf_env, op, o_err);
	return rc;
}
/****************************************************************************
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_agent_track_cbk(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn,
				  NCSCONTEXT ptr, uint32_t *ptr_data_len,
				  EDU_BUF_ENV *buf_env, EDP_OP_TYPE op,
				  EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_agent_track_cbk_rules[] = {
	    {EDU_START, plms_edp_agent_track_cbk, 0, 0, 0,
	     sizeof(PLMS_AGENT_TRACK_CBK), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->track_cookie, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->invocation_id, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->track_cause, 0, NULL},
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->root_cause_entity, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->root_correlation_id, 0, NULL},
	    {EDU_EXEC, plms_edp_readiness_tracked_entities, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->tracked_entities, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_CBK *)0)->change_step, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, plms_agent_track_cbk_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
/****************************************************************************
...
uint32_t plms_evt_test_type_func(NCSCONTEXT arg)
{
	...
	enum { PLMS_EDU_PLMS_REQ = 1, PLMS_EDU_PLMS_RES };
...
uint32_t plms_evt_test_req_type(NCSCONTEXT arg)
{
	...
	enum { PLMS_EDU_PLMS_AGENT_LIB_REQ = 1,
...
uint32_t plms_evt_test_res_type(NCSCONTEXT arg)
{
	...
	enum { PLMS_EDU_PLMS_COMMON_RESP = 1,
...
uint32_t plms_test_track_op_type(NCSCONTEXT arg)
{
	...
	enum { PLMS_EDU_PLMS_AGENT_TRACK_START = 1,
				 ...
				 EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_edp_agent_track_op_rules[] = {
	    {EDU_START, plms_edp_agent_track_op, 0, 0, 0,
	     sizeof(PLMS_AGENT_TRACK_OP), 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->evt_type, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->agent_handle, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->grp_handle, 0, NULL},
	    {EDU_TEST, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->evt_type, 0,
	     (EDU_EXEC_RTINE)plms_test_track_op_type},

	    /* For plms agent track start */
	    {EDU_EXEC, plms_edp_agent_track_start, 0, 0, EDU_EXIT,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->track_start, 0, NULL},
	    /* For plms agent readiness impact */
	    {EDU_EXEC, plms_edp_agent_readiness_impact, 0, 0, EDU_EXIT,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->readiness_impact, 0, NULL},
	    /* For plms agent track callback response */
	    {EDU_EXEC, plms_edp_agent_track_cbk_resp, 0, 0, EDU_EXIT,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->track_cbk_res, 0, NULL},
	    /* For plms agent track callback  */
	    {EDU_EXEC, plms_edp_agent_track_cbk, 0, 0, EDU_EXIT,
	     (long)&((PLMS_AGENT_TRACK_OP *)0)->track_cbk, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc =
	    m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, plms_edp_agent_track_op_rules,
				struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_req_info(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn, NCSCONTEXT ptr,
			   ...
			   EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET plms_edp_req_info_rules[] = {
	    {EDU_START, plms_edp_req_info, 0, 0, 0, sizeof(PLMS_EVT_REQ), 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_EVT_REQ *)0)->req_type, 0, NULL},
	    {EDU_TEST, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_EVT_REQ *)0)->req_type, 0,
	     (EDU_EXEC_RTINE)plms_evt_test_req_type},

	    /* For PLMS_AGENT_LIB_REQ */
	    {EDU_EXEC, plms_edp_agent_lib_req, 0, 0, EDU_EXIT,
	     (long)&((PLMS_EVT_REQ *)0)->agent_lib_req, 0, NULL},
	    /* For PLMS_AGENT_GRP_OP */
	    {EDU_EXEC, plms_edp_agent_grp_op, 0, 0, EDU_EXIT,
	     (long)&((PLMS_EVT_REQ *)0)->agent_grp_op, 0, NULL},
	    /* For PLMS_AGENT_TRACK_OP */
	    {EDU_EXEC, plms_edp_agent_track_op, 0, 0, EDU_EXIT,
	     (long)&((PLMS_EVT_REQ *)0)->agent_track, 0, NULL},
	    {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
	};
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, plms_edp_req_info_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_res_info(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn, NCSCONTEXT ptr,
			   uint32_t *ptr_data_len, EDU_BUF_ENV *buf_env,
			   EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uint32_t rc = NCSCC_RC_SUCCESS;
	...
	EDU_INST_SET plms_edp_res_info_rules[] = {
	    {EDU_START, plms_edp_res_info, 0, 0, 0, sizeof(PLMS_EVT_RES), 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_EVT_RES *)0)->res_type, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_EVT_RES *)0)->error, 0, NULL},
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, 0,
	     (long)&((PLMS_EVT_RES *)0)->ntf_id, 0, NULL},
	    {EDU_TEST, ncs_edp_uns32, 0, 0, 0,
	     (long)&((PLMS_EVT_RES *)0)->res_type, 0,
	     (EDU_EXEC_RTINE)plms_evt_test_res_type},

	    /* For plms responses other than readiness tracked entities */
	    {EDU_EXEC, ncs_edp_uns64, 0, 0, EDU_EXIT,
	     (long)&((PLMS_EVT_RES *)0)->hdl, 0, NULL},
	    /* For plms response for readiness tracked entities */
	    {EDU_EXEC, plms_edp_readiness_tracked_entities, EDQ_POINTER, 0,
	     EDU_EXIT, (long)&((PLMS_EVT_RES *)0)->entities, 0, NULL},
	...
	if (op == EDP_OP_TYPE_ENC) {
		...
		(*d_ptr)->entities =
		    malloc(sizeof(SaPlmReadinessTrackedEntitiesT));
		memset((*d_ptr)->entities, '\0',
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, plms_edp_res_info_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
 ...
 * Notes         : None.
 *****************************************************************************/
uint32_t plms_edp_plms_evt(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn, NCSCONTEXT ptr,
			   uint32_t *ptr_data_len, EDU_BUF_ENV *buf_env,
			   EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uint32_t rc = NCSCC_RC_SUCCESS;
	...
	EDU_INST_SET test_plms_evt_rules[] = {
	    ...
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((PLMS_EVT *)0)->req_res,
	     0, NULL},
	    {EDU_TEST, ncs_edp_uns32, 0, 0, 0, (long)&((PLMS_EVT *)0)->req_res,
	     0, (EDU_EXEC_RTINE)plms_evt_test_type_func},

	    /* For PLM request type */
	    {EDU_EXEC, plms_edp_req_info, 0, 0, EDU_EXIT,
	     (long)&((PLMS_EVT *)0)->req_evt, 0, NULL},

	    /* For PLM response type */
	    {EDU_EXEC, plms_edp_res_info, 0, 0, EDU_EXIT,
	     (long)&((PLMS_EVT *)0)->res_evt, 0, NULL},
	...
	rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, test_plms_evt_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
