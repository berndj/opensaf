...
#ifndef LIBJAVA_J_AIS_CLM_H_
#define LIBJAVA_J_AIS_CLM_H_
...
extern void SaClmClusterNodeGetCallback(
    SaInvocationT saInvocation, const SaClmClusterNodeT *saClusterNodePtr,
    SaAisErrorT saError);

extern void SaClmClusterNodeGetCallback_4(
    SaInvocationT saInvocation, const SaClmClusterNodeT_4 *saClusterNodePtr,
    SaAisErrorT saError);
...
extern jobject JNU_ClusterNode_create(
    JNIEnv *jniEnv, const SaClmClusterNodeT *saClusterNodePtr);
extern jobject JNU_ClusterNode_create_4(
    JNIEnv *jniEnv, const SaClmClusterNodeT_4 *saClusterNodePtr);
