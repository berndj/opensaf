...
static jboolean
JNU_ClusterMembershipManager_initIDs_FromClass_OK(JNIEnv *jniEnv,
						  jclass classClmHandle);
static void
JNU_invokeSaClmClusterTrack_Async(JNIEnv *jniEnv,
				  jobject thisClusterMembershipManager,
				  const SaUint8T saTrackFlags);
static jobject
JNU_invokeSaClmClusterTrack_Sync(JNIEnv *jniEnv,
				 jobject thisClusterMembershipManager,
				 const SaUint8T saTrackFlags);
static jboolean JNU_invokeSaClmClusterTrack_SyncNtfBuf(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager,
    const SaUint8T saTrackFlags, jobject sNotificationBuffer);
#ifndef IMPL_CLIENT_ALLOC
static jboolean JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocAPI(
    JNIEnv *jniEnv, SaClmHandleT saClmHandle, const SaUint8T saTrackFlags,
...
static jboolean JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocClient(
    JNIEnv *jniEnv, SaClmHandleT saClmHandle, const SaUint8T saTrackFlags,
    SaClmClusterNotificationBufferT *saNotificationBufferPtr,
    SaClmClusterNotificationT *saNotifications, jboolean *bufferOnStack);
static jboolean JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocClient_4(
    JNIEnv *jniEnv, SaClmHandleT saClmHandle, const SaUint8T saTrackFlags,
    SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr,
    SaClmClusterNotificationT_4 *saNotifications, jboolean *bufferOnStack);
...
jboolean JNU_ClusterMembershipManager_initIDs_OK(JNIEnv *jniEnv)
{
	...
	// get ClusterMembershipManager class & create a global reference right
	// away
	/*
	...
	ClassClusterMembershipManager = JNU_GetGlobalClassRef(
	    jniEnv, "org/opensaf/ais/clm/ClusterMembershipManagerImpl");
	...
	// get IDs
	return JNU_ClusterMembershipManager_initIDs_FromClass_OK(
	    jniEnv, ClassClusterMembershipManager);
}
...
static jboolean JNU_ClusterMembershipManager_initIDs_FromClass_OK(
    JNIEnv *jniEnv, jclass classClusterMembershipManager)
{
	...
	FID_clmLibraryHandle = (*jniEnv)->GetFieldID(
	    jniEnv, classClusterMembershipManager, "clmLibraryHandle",
...
Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getCluster__(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager)
{
	// BODY
	...
	return JNU_invokeSaClmClusterTrack_Sync(
	    jniEnv, thisClusterMembershipManager, SA_TRACK_CURRENT);
}

/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterAsync__ TYPE:
 *native method Class:     ais_clm_ClusterMembershipManager Method:
 *getClusterAsync Signature: ()V
 *************************************************************************/
JNIEXPORT void JNICALL
Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterAsync__(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager)
{
...
/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterAsyncThenStartTracking
 * TYPE:      native method
...
/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_startClusterTracking
 * TYPE:      native method
 *  Class:     org_opensaf_ais_clm_ClusterMembershipManagerImpl
...
/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterThenStartTracking
 * TYPE:      native method
 *  Class:     ais_clm_ClusterMembershipManager
 *  Method:    getClusterThenStartTracking
 * Signature:
 *(Lorg/saforum/ais/TrackFlags;)Lorg/saforum/ais/clm/ClusterNotificationBuffer;
 *************************************************************************/
JNIEXPORT jobject JNICALL
    ...
    JNIEnv *jniEnv, jobject thisClusterMembershipManager, jobject trackFlags)
{
	...
	*/
	...
	return JNU_invokeSaClmClusterTrack_Sync(
	    jniEnv, thisClusterMembershipManager,
	    _saTrackFlags | SA_TRACK_CURRENT);
}

/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_stopClusterTracking
 * TYPE:      native method
 *  Class:     ais_clm_ClusterMembershipManager
    ...
    JNIEnv *jniEnv, jobject thisClusterMembershipManager)
{
	...
	_clmLibraryHandle = (*jniEnv)->GetObjectField(
	    jniEnv, thisClusterMembershipManager, FID_clmLibraryHandle);
	// get native library handle

	_saClmHandle = (SaClmHandleT)(*jniEnv)->GetLongField(
	    jniEnv, _clmLibraryHandle, FID_saClmHandle);
...
/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterNode TYPE:
 *native method Class:     ais_clm_ClusterMembershipManager Method:
 *getClusterNode Signature: (IJ)Lorg/saforum/ais/clm/ClusterNode;
 *************************************************************************/
JNIEXPORT jobject JNICALL
Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterNode(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager, jint nodeId,
    jlong timeout)
{
	...
	// get Version
	_saVersion =
	    (*jniEnv)->GetObjectField(jniEnv, _clmLibraryHandle, FID_saVersion);

	_majorVersion =
	    (*jniEnv)->GetShortField(jniEnv, _saVersion, FID_majorVersion);

	_minorVersion =
	    (*jniEnv)->GetShortField(jniEnv, _saVersion, FID_minorVersion);
	...
	if (_majorVersion == 1 && _minorVersion == 1) {
		...
		_saStatus =
		    saClmClusterNodeGet(_saClmHandle, (SaClmNodeIdT)nodeId,
					(SaTimeT)timeout, &_saClusterNode);
		...
		_saStatus =
		    saClmClusterNodeGet_4(_saClmHandle, (SaClmNodeIdT)nodeId,
					  (SaTimeT)timeout, &_saClusterNode4);
...
/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterNodeAsync
 * TYPE:      native method
 *  Class:     ais_clm_ClusterMembershipManager
...
JNIEXPORT void JNICALL
Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterNodeAsync(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager, jlong saInvocation,
    jint nodeId)
{
	...
	_saStatus = saClmClusterNodeGetAsync(
	    _saClmHandle, (SaInvocationT)saInvocation, (SaClmNodeIdT)nodeId);
				  ...
				  const SaUint8T saTrackFlags)
{
	...
	if (_majorversion == 1 && _minorversion == 1) {
		...
		_saStatus =
		    saClmClusterTrack_4(_saClmHandle, saTrackFlags, NULL);
				 ...
				 const SaUint8T saTrackFlags)
{
	...
	// invoke saClmClusterTrack
	if (JNU_invokeSaClmClusterTrack_SyncNtfBuf(
		jniEnv, thisClusterMembershipManager, saTrackFlags,
...
#ifndef IMPL_CLIENT_ALLOC
	// if we use JNU_invokeSaClmClusterTrack_SyncAllocAPI, then the API
	// reserves the buffer from the heap
	jboolean _bufferOnStack = JNI_FALSE;
#else  // IMPL_CLIENT_ALLOC
	// if we use JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocClient, then
...
// call saClmClusterTrack
		...
		if (JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocAPI(
			jniEnv, _saClmHandle, saTrackFlags,
		...
		if (JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocClient_4(
			jniEnv, _saClmHandle, saTrackFlags,
			&_saNotificationBuffer4, _saNotifications4,
			&_bufferOnStack) != JNI_TRUE) {
			// error, some exception has been thrown already!
			return JNI_FALSE; // EXIT POINT!!!
		}
	...
	if (_majorversion == 1 && _minorversion == 1) {
		...
		if (JNU_ClusterNotificationBuffer_set(
			jniEnv, sNotificationBuffer, &_saNotificationBuffer) !=
		    JNI_TRUE) {
			_ok = JNI_FALSE;
		}
		...
		if (JNU_ClusterNotificationBuffer_set_4(
			jniEnv, sNotificationBuffer, &_saNotificationBuffer4) !=
		    JNI_TRUE) {
			_ok = JNI_FALSE;
		}
		// free notification buffer
    ...
    SaClmClusterNotificationBufferT *saNotificationBufferPtr)
{
	...
	assert((saTrackFlags & (~(SA_TRACK_CURRENT | SA_TRACK_CHANGES |
				  SA_TRACK_CHANGES_ONLY | SA_TRACK_LOCAL))) ==
	       0);
	...
	// call saClmClusterTrack
	if (JNU_callSaClmClusterTrack_Sync(jniEnv, saClmHandle, saTrackFlags,
...
static jboolean JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocClient(
    JNIEnv *jniEnv, SaClmHandleT saClmHandle, const SaUint8T saTrackFlags,
    SaClmClusterNotificationBufferT *saNotificationBufferPtr,
    SaClmClusterNotificationT *saNotifications, jboolean *bufferOnStackPtr)
{
	// VARIABLES
	SaAisErrorT _saStatus;
	...
	if (JNU_callSaClmClusterTrack_Sync(jniEnv, saClmHandle, saTrackFlags,
		...
		if (_saStatus == SA_AIS_ERR_NO_SPACE) {
			...
			*bufferOnStackPtr = JNI_FALSE;
			...
			if (JNU_callSaClmClusterTrack_Sync(
				jniEnv, saClmHandle, saTrackFlags,
				saNotificationBufferPtr,
				&_saStatus) != JNI_TRUE) {
    ...
    SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr)
{
	...
	saNotificationBufferPtr->notification =
	    NULL; // let AIS to reserve the memory
	// call saClmClusterTrack
	if (JNU_callSaClmClusterTrack_Sync_4(jniEnv, saClmHandle, saTrackFlags,
					     saNotificationBufferPtr,
					     &_saStatus) != JNI_TRUE) {
		// error, some exception has been thrown already!
		// TODO handle NO_SPACE case!!
...
static jboolean JNU_invokeSaClmClusterTrack_SyncNtfBuf_AllocClient_4(
    JNIEnv *jniEnv, SaClmHandleT saClmHandle, const SaUint8T saTrackFlags,
    SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr,
    SaClmClusterNotificationT_4 *saNotifications, jboolean *bufferOnStackPtr)
{
	// VARIABLES
	SaAisErrorT _saStatus;
	...
	if (JNU_callSaClmClusterTrack_Sync_4(jniEnv, saClmHandle, saTrackFlags,
		...
		if (_saStatus == SA_AIS_ERR_NO_SPACE) {
			...
			*bufferOnStackPtr = JNI_FALSE;
			...
			if (JNU_callSaClmClusterTrack_Sync_4(
				jniEnv, saClmHandle, saTrackFlags,
				saNotificationBufferPtr,
				&_saStatus) != JNI_TRUE) {
				// error handling (some exception has been
    ...
    SaAisErrorT *saStatusPtr)
{
	...
	*saStatusPtr = saClmClusterTrack(saClmHandle, saTrackFlags,
					 saNotificationBufferPtr);
    ...
    SaAisErrorT *saStatusPtr)
{
	...
	*saStatusPtr = saClmClusterTrack_4(saClmHandle, saTrackFlags,
					   saNotificationBufferPtr);
 ...
 *************************************************************************/
JNIEXPORT jobject JNICALL
Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getCluster__Z(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager, jboolean local)
{
	...
	return JNU_invokeSaClmClusterTrack_Sync(
	    jniEnv, thisClusterMembershipManager, _saTrackFlags);
}

/**************************************************************************
 * FUNCTION:
 *Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterAsync TYPE:
 *native method Class:     ais_clm_ClusterMembershipManager Method:
 *getClusterAsync Signature: (Z)V;
 *************************************************************************/
JNIEXPORT void JNICALL
Java_org_opensaf_ais_clm_ClusterMembershipManagerImpl_getClusterAsync__Z(
    JNIEnv *jniEnv, jobject thisClusterMembershipManager, jboolean local)
{
    ...
    jboolean local, jint trackStep)
{
	...
	return JNU_invokeSaClmClusterTrack_Sync(
	    jniEnv, thisClusterMembershipManager, _saTrackFlags | trackStep);
}
