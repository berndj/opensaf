...
void SaAmfCSISetCallback(SaInvocationT saInvocation,
			 const SaNameT *saCompNamePtr, SaAmfHAStateT saHaState,
...
void SaAmfComponentTerminateCallback(SaInvocationT saInvocation,
				     const SaNameT *saCompNamePtr);
void SaAmfProxiedComponentInstantiateCallback(
...
static jboolean
JNU_CsiDescriptor_initIDs_FromClass_OK(JNIEnv *jniEnv,
				       jclass classCsiDescriptor);
jobject JNU_CsiDescriptor_create(JNIEnv *jniEnv,
				 const SaAmfCSIDescriptorT *saCsiDescriptorPtr,
				 SaAmfHAStateT saHaState);
static jboolean
JNU_CsiDescriptor_set(JNIEnv *jniEnv, jobject sCsiDescriptor,
		      const SaAmfCSIDescriptorT *saCsiDescriptorPtr,
		      SaAmfHAStateT saHaState);
...
static jboolean
JNU_CsiActiveDescriptor_initIDs_FromClass_OK(JNIEnv *jniEnv,
					     jclass classCsiActiveDescriptor);
jobject JNU_CsiActiveDescriptor_create(
    JNIEnv *jniEnv, const SaAmfCSIActiveDescriptorT *saCsiActiveDescriptorPtr);
static jboolean JNU_CsiActiveDescriptor_set(
    JNIEnv *jniEnv, jobject sCsiActiveDescriptor,
    const SaAmfCSIActiveDescriptorT *saCsiActiveDescriptorPtr);

// ENUM ais.amf.CsiActiveDescriptor$TransitionDescriptor
jboolean JNU_TransitionDescriptor_initIDs_OK(JNIEnv *jniEnv);
static jboolean
JNU_TransitionDescriptor_initIDs_FromClass_OK(JNIEnv *jniEnv,
					      jclass enumTransitionDescriptor);
static jobject JNU_TransitionDescriptor_getEnum(
    JNIEnv *jniEnv, SaAmfCSITransitionDescriptorT saTransitionDescriptor);

// CLASS ais.amf.CsiStandbyDescriptor
jboolean JNU_CsiStandbyDescriptor_initIDs_OK(JNIEnv *jniEnv);
static jboolean
JNU_CsiStandbyDescriptor_initIDs_FromClass_OK(JNIEnv *jniEnv,
					      jclass classCsiStandbyDescriptor);
jobject JNU_CsiStandbyDescriptor_create(
    JNIEnv *jniEnv,
    const SaAmfCSIStandbyDescriptorT *saCsiStandbyDescriptorPtr);
static jboolean JNU_CsiStandbyDescriptor_set(
    JNIEnv *jniEnv, jobject sCsiStandbyDescriptor,
    const SaAmfCSIStandbyDescriptorT *saCsiStandbyDescriptorPtr);
...
static jobject
JNU_CsiAttribute_create(JNIEnv *jniEnv,
			const SaAmfCSIAttributeT *saCsiAttributePtr);
static jboolean
JNU_CsiAttribute_set(JNIEnv *jniEnv, jobject sCsiAttribute,
		     const SaAmfCSIAttributeT *saCsiAttributePtr);

// ENUM ais.amf.RecommendedRecovery
jboolean JNU_RecommendedRecovery_initIDs_OK(JNIEnv *jniEnv);
static jboolean
JNU_RecommendedRecovery_initIDs_FromClass_OK(JNIEnv *jniEnv,
					     jclass enumRecommendedRecovery);
			      ...
			      SaAmfHealthcheckKeyT *saHealthcheckKeyPtr)
{
	...
	_healthcheckKeyArray =
	    (jbyteArray)(*_jniEnv)->NewByteArray(_jniEnv, _hKeyLen);
	...
	(*_jniEnv)->SetByteArrayRegion(_jniEnv, _healthcheckKeyArray, (jsize)0,
				       _hKeyLen,
	...
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassAmfHandle, MID_s_invokeHealthcheckCallback,
	    (jlong)saInvocation, _compNameString, _healthcheckKeyArray);
}
			 ...
			 SaAmfCSIDescriptorT saCsiDescriptor)
{
	...
	// CSI descriptor
	_csiDescriptor =
	    JNU_CsiDescriptor_create(_jniEnv, &saCsiDescriptor, saHaState);
	...
	// invoke Java callback
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassAmfHandle, MID_s_invokeSetCsiCallback,
	    (jlong)saInvocation, _compNameString, _haState, _csiDescriptor);
}
			    ...
			    SaAmfCSIFlagsT saCsiFlags)
{
	...
	// invoke Java callback
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassAmfHandle, MID_s_invokeRemoveCsiCallback,
	    (jlong)saInvocation, _compNameString, _csiNameString, _csiFlags);
}
				     ...
				     const SaNameT *saCompNamePtr)
{
	...
	// invoke Java callback
	(*_jniEnv)->CallStaticVoidMethod(_jniEnv, ClassAmfHandle,
    ...
    SaInvocationT saInvocation, const SaNameT *saProxiedCompNamePtr)
{
	...
	_proxiedCompNameString =
	    JNU_newStringFromSaNameT(_jniEnv, saProxiedCompNamePtr);
	...
	// invoke Java callback
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassAmfHandle,
	    MID_s_invokeInstantiateProxiedComponentCallback,
	    (jlong)saInvocation, _proxiedCompNameString);
}
					  ...
					  const SaNameT *saProxiedCompNamePtr)
{
	...
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassAmfHandle,
	    MID_s_invokeCleanupProxiedComponentCallback, (jlong)saInvocation,
	    _proxiedCompNameString);
}
    ...
    SaUint32T saNumberOfMembers, SaAisErrorT saError)
{
	...
	/*
	  ...
	  _TRACE2( "NATIVE CALLBACK ERROR: _sClusterNotificationBuffer is
	  NULL\n" );
	...
	*/
	...
	if (saNotificationBufferPtr != NULL) {
		_sProtectionGroupNotificationBuffer =
		    JNU_ProtectionGroupNotificationArray_create(
			_jniEnv, saNotificationBufferPtr);
	} else {
	...
	// invoke Java callback
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassAmfHandle, MID_s_invokeTrackProtectionGroupCallback,
	    _csiNameString, _sProtectionGroupNotificationBuffer,
	    (jint)saNumberOfMembers, (jint)saError);
	_TRACE2(
...
jboolean JNU_CsiDescriptor_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassCsiDescriptor =
	    JNU_GetGlobalClassRef(jniEnv, "org/saforum/ais/amf/CsiDescriptor");
				       ...
				       jclass classCsiDescriptor)
{
	...
	CID_CsiDescriptor_constructor =
	    (*jniEnv)->GetMethodID(jniEnv, classCsiDescriptor, "<init>", "()V");
	...
	// get field IDs
	FID_csiFlags = (*jniEnv)->GetFieldID(
	    jniEnv, classCsiDescriptor, "csiFlags",
	...
	FID_csiName = (*jniEnv)->GetFieldID(jniEnv, classCsiDescriptor,
	...
	FID_csiStateDescriptor = (*jniEnv)->GetFieldID(
	    jniEnv, classCsiDescriptor, "csiStateDescriptor",
	...
	FID_csiAttribute =
	    (*jniEnv)->GetFieldID(jniEnv, classCsiDescriptor, "csiAttribute",
				 ...
				 SaAmfHAStateT saHaState)
{
	...
	_sCsiDescriptor = (*jniEnv)->NewObject(jniEnv, ClassCsiDescriptor,
					       CID_CsiDescriptor_constructor);
	...
	if (JNU_CsiDescriptor_set(jniEnv, _sCsiDescriptor, saCsiDescriptorPtr,
				  saHaState) != JNI_TRUE) {
		// TODO error handling
		      ...
		      SaAmfHAStateT saHaState)
{
	...
	(*jniEnv)->SetObjectField(jniEnv, sCsiDescriptor, FID_csiFlags,
				  _csiFlags);
	// csiName
	if (saCsiDescriptorPtr->csiFlags == SA_AMF_CSI_TARGET_ALL) {
		// When TARGET_ALL is set in csiFlags, csiName is not used
		(*jniEnv)->SetObjectField(jniEnv, sCsiDescriptor, FID_csiName,
					  NULL);
	} else {
		_csiNameString = JNU_newStringFromSaNameT(
		    jniEnv, &(saCsiDescriptorPtr->csiName));
		if (_csiNameString == NULL) {
			// TODO error handling
	...
	case SA_AMF_HA_ACTIVE:
		_csiActiveDescriptor = JNU_CsiActiveDescriptor_create(
		    jniEnv,
		    &(saCsiDescriptorPtr->csiStateDescriptor.activeDescriptor));
		...
		(*jniEnv)->SetObjectField(jniEnv, sCsiDescriptor,
					  FID_csiStateDescriptor,
					  _csiActiveDescriptor);
		break;
	case SA_AMF_HA_STANDBY:
		_csiStandbyDescriptor = JNU_CsiStandbyDescriptor_create(
		    jniEnv, &(saCsiDescriptorPtr->csiStateDescriptor
				  .standbyDescriptor));
	...
	case SA_AMF_HA_QUIESCING:
		// this is only necessary if the CsiDescriptor object is not
		// newly created...
		(*jniEnv)->SetObjectField(jniEnv, sCsiDescriptor,
	...
	if (saCsiDescriptorPtr->csiFlags == SA_AMF_CSI_ADD_ONE) {
		// When ADD_ONE is set in csiFlags, csiAttribute refers to the
		// attributes of the newly assigned component service instance
		// create attribute array
		_arraySCsiAttribute = (*jniEnv)->NewObjectArray(
		    jniEnv, saCsiDescriptorPtr->csiAttr.number,
		    ClassCsiAttribute, NULL);
		...
		for (_idx = 0; _idx < saCsiDescriptorPtr->csiAttr.number;
		     _idx++) {
			_sCsiAttribute = JNU_CsiAttribute_create(
			    jniEnv, &(saCsiDescriptorPtr->csiAttr.attr[_idx]));
			...
			(*jniEnv)->SetObjectArrayElement(
			    jniEnv, _arraySCsiAttribute, (jsize)_idx,
			    _sCsiAttribute);
...
jboolean JNU_CsiActiveDescriptor_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassCsiActiveDescriptor = (*jniEnv)->NewGlobalRef(
	    jniEnv, (*jniEnv)->FindClass(
			jniEnv, "org/saforum/ais/amf/CsiActiveDescriptor"));
	...
	// get IDs
	return JNU_CsiActiveDescriptor_initIDs_FromClass_OK(
	    jniEnv, ClassCsiActiveDescriptor);
}
					     ...
					     jclass classCsiActiveDescriptor)
{
	...
	// get constructor IDs
	CID_CsiActiveDescriptor_constructor = (*jniEnv)->GetMethodID(
	    jniEnv, classCsiActiveDescriptor, "<init>", "()V");
	...
	// get field IDs
	FID_transitionDescriptor = (*jniEnv)->GetFieldID(
	    jniEnv, classCsiActiveDescriptor, "transitionDescriptor",
	...
	FID_AD_activeComponentName =
	    (*jniEnv)->GetFieldID(jniEnv, classCsiActiveDescriptor,
				  "activeComponentName", "Ljava/lang/String;");
    ...
    JNIEnv *jniEnv, const SaAmfCSIActiveDescriptorT *saCsiActiveDescriptorPtr)
{
	...
	_sCsiActiveDescriptor =
	    (*jniEnv)->NewObject(jniEnv, ClassCsiActiveDescriptor,
	...
	if (JNU_CsiActiveDescriptor_set(jniEnv, _sCsiActiveDescriptor,
    ...
    const SaAmfCSIActiveDescriptorT *saCsiActiveDescriptorPtr)
{
	...
	_transitionDescriptor = JNU_TransitionDescriptor_getEnum(
	    jniEnv, saCsiActiveDescriptorPtr->transitionDescriptor);
	if (_transitionDescriptor == NULL) {
		// TODO error handling
		return JNI_FALSE; // exception thrown already...
	}
	(*jniEnv)->SetObjectField(jniEnv, sCsiActiveDescriptor,
				  FID_transitionDescriptor,
				  _transitionDescriptor);
	// active Component name
	_activeComponentNameString = JNU_newStringFromSaNameT(
	    jniEnv, &(saCsiActiveDescriptorPtr->activeCompName));
...
jboolean JNU_TransitionDescriptor_initIDs_OK(JNIEnv *jniEnv)
{
	...
	EnumTransitionDescriptor = (*jniEnv)->NewGlobalRef(
	    jniEnv,
	    (*jniEnv)->FindClass(
		jniEnv,
	...
	// get IDs
	return JNU_TransitionDescriptor_initIDs_FromClass_OK(
	    jniEnv, EnumTransitionDescriptor);
}
					      ...
					      jclass enumTransitionDescriptor)
{
	...
	FID_TD_NEW_ASSIGN = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumTransitionDescriptor, "NEW_ASSIGN",
	    "Lorg/saforum/ais/amf/CsiActiveDescriptor$TransitionDescriptor;");
	...
	FID_TD_QUIESCED = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumTransitionDescriptor, "QUIESCED",
	    "Lorg/saforum/ais/amf/CsiActiveDescriptor$TransitionDescriptor;");
	...
	FID_TD_NOT_QUIESCED = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumTransitionDescriptor, "NOT_QUIESCED",
	    "Lorg/saforum/ais/amf/CsiActiveDescriptor$TransitionDescriptor;");
	...
	FID_TD_STILL_ACTIVE = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumTransitionDescriptor, "STILL_ACTIVE",
	    "Lorg/saforum/ais/amf/CsiActiveDescriptor$TransitionDescriptor;");
 ...
 *                NULL if an illegal SaAmfCSITransitionDescriptorT value was
 *passed. NOTE: If NULL is returned, then an exception is already pending!
 *************************************************************************/
static jobject JNU_TransitionDescriptor_getEnum(
    JNIEnv *jniEnv, SaAmfCSITransitionDescriptorT saTransitionDescriptor)
{
	...
	case SA_AMF_CSI_NEW_ASSIGN:
		_transitionDescriptor = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumTransitionDescriptor, FID_TD_NEW_ASSIGN);
	...
	case SA_AMF_CSI_QUIESCED:
		_transitionDescriptor = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumTransitionDescriptor, FID_TD_QUIESCED);
	...
	case SA_AMF_CSI_NOT_QUIESCED:
		_transitionDescriptor = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumTransitionDescriptor, FID_TD_NOT_QUIESCED);
	...
	case SA_AMF_CSI_STILL_ACTIVE:
		_transitionDescriptor = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumTransitionDescriptor, FID_TD_STILL_ACTIVE);
...
jboolean JNU_CsiStandbyDescriptor_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassCsiStandbyDescriptor = (*jniEnv)->NewGlobalRef(
	    jniEnv, (*jniEnv)->FindClass(
			jniEnv, "org/saforum/ais/amf/CsiStandbyDescriptor"));
	...
	// get IDs
	return JNU_CsiStandbyDescriptor_initIDs_FromClass_OK(
	    jniEnv, ClassCsiStandbyDescriptor);
}
					      ...
					      jclass classCsiStandbyDescriptor)
{
	...
	// get constructor IDs
	CID_CsiStandbyDescriptor_constructor = (*jniEnv)->GetMethodID(
	    jniEnv, classCsiStandbyDescriptor, "<init>", "()V");
	...
	FID_SD_activeComponentName =
	    (*jniEnv)->GetFieldID(jniEnv, classCsiStandbyDescriptor,
				  "activeComponentName", "Ljava/lang/String;");
	...
	FID_standbyRank = (*jniEnv)->GetFieldID(
	    jniEnv, classCsiStandbyDescriptor, "standbyRank", "I");
 ...
 *************************************************************************/
jobject JNU_CsiStandbyDescriptor_create(
    JNIEnv *jniEnv, const SaAmfCSIStandbyDescriptorT *saCsiStandbyDescriptorPtr)
{
	// VARIABLES
	// JNI
	...
	_sCsiStandbyDescriptor =
	    (*jniEnv)->NewObject(jniEnv, ClassCsiStandbyDescriptor,
	...
	if (JNU_CsiStandbyDescriptor_set(jniEnv, _sCsiStandbyDescriptor,
    ...
    const SaAmfCSIStandbyDescriptorT *saCsiStandbyDescriptorPtr)
{
	...
	// U_printSaCsiStandbyDescriptor( "Input values of
	// saCsiStandbyDescriptor: \n", saCsiStandbyDescriptorPtr );

	// active Component name
	_activeComponentNameString = JNU_newStringFromSaNameT(
	    jniEnv, &(saCsiStandbyDescriptorPtr->activeCompName));
	if (_activeComponentNameString == NULL) {
		// TODO error handling
		return JNI_FALSE; // OutOfMemoryError thrown already...
	}
	(*jniEnv)->SetObjectField(jniEnv, sCsiStandbyDescriptor,
				  FID_SD_activeComponentName,
				  _activeComponentNameString);
	// standby rank
	(*jniEnv)->SetIntField(jniEnv, sCsiStandbyDescriptor, FID_standbyRank,
...
jboolean JNU_HaState_initIDs_OK(JNIEnv *jniEnv)
{
	...
	EnumHaState = (*jniEnv)->NewGlobalRef(
	    jniEnv,
	    (*jniEnv)->FindClass(jniEnv, "org/saforum/ais/amf/HaState"));
	if (EnumHaState == NULL) {
						 ...
						 jclass enumHaState)
{
	...
	// get field IDs (the two predefined enum values)
	FID_ACTIVE = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumHaState, "ACTIVE", "Lorg/saforum/ais/amf/HaState;");
	if (FID_ACTIVE == NULL) {
	...
	FID_STANDBY = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumHaState, "STANDBY", "Lorg/saforum/ais/amf/HaState;");
	if (FID_STANDBY == NULL) {
	...
	FID_QUIESCED = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumHaState, "QUIESCED", "Lorg/saforum/ais/amf/HaState;");
	...
	FID_QUIESCING = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumHaState, "QUIESCING", "Lorg/saforum/ais/amf/HaState;");
 ...
 * INTERFACE:
 *   parameters:  TODO
 *   returns:     an HaState object equivalent with the specified SaAmfHAStateT
 *parameter or NULL if an illegal SaAmfHAStateT value was passed. NOTE: If NULL
...
jobject JNU_HaState_getEnum(JNIEnv *jniEnv, SaAmfHAStateT saHaState)
{
	...
	switch (saHaState) {
	case SA_AMF_HA_ACTIVE:
		_haState = (*jniEnv)->GetStaticObjectField(jniEnv, EnumHaState,
							   FID_ACTIVE);
...
jboolean JNU_CsiFlags_initIDs_OK(JNIEnv *jniEnv)
{
	...
	EnumCsiFlags = (*jniEnv)->NewGlobalRef(
	    jniEnv, (*jniEnv)->FindClass(
			jniEnv, "org/saforum/ais/amf/CsiDescriptor$CsiFlags"));
						  ...
						  jclass enumCsiFlags)
{
	...
	// get field IDs (the two predefined enum values)
	FID_ADD_ONE = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumCsiFlags, "ADD_ONE",
	    "Lorg/saforum/ais/amf/CsiDescriptor$CsiFlags;");
	if (FID_ADD_ONE == NULL) {
	...
	FID_TARGET_ONE = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumCsiFlags, "TARGET_ONE",
	    "Lorg/saforum/ais/amf/CsiDescriptor$CsiFlags;");
	...
	FID_TARGET_ALL = (*jniEnv)->GetStaticFieldID(
	    jniEnv, enumCsiFlags, "TARGET_ALL",
	    "Lorg/saforum/ais/amf/CsiDescriptor$CsiFlags;");
 ...
 * INTERFACE:
 *   parameters:  TODO
 *   returns:     an CsiFlags object equivalent with the specified
 *SaAmfCSIFlagsT parameter or NULL if an illegal SaAmfCSIFlagsT value was
 *passed. NOTE: If NULL is returned, then an exception is
 *already pending!
 *************************************************************************/
static jobject JNU_CsiFlags_getEnum(JNIEnv *jniEnv, SaAmfCSIFlagsT saCsiFlags)
{
	...
	case SA_AMF_CSI_ADD_ONE:
		_csiFlags = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumCsiFlags, FID_ADD_ONE);
	...
	case SA_AMF_CSI_TARGET_ONE:
		_csiFlags = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumCsiFlags, FID_TARGET_ONE);
	...
	case SA_AMF_CSI_TARGET_ALL:
		_csiFlags = (*jniEnv)->GetStaticObjectField(
		    jniEnv, EnumCsiFlags, FID_TARGET_ALL);
...
jboolean JNU_CsiAttribute_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassCsiAttribute = (*jniEnv)->NewGlobalRef(
	    jniEnv,
	    (*jniEnv)->FindClass(jniEnv, "org/saforum/ais/amf/CsiAttribute"));
						      ...
						      jclass classCsiAttribute)
{
	...
	CID_CsiAttribute_constructor =
	    (*jniEnv)->GetMethodID(jniEnv, classCsiAttribute, "<init>", "()V");
	...
	// get field IDs
	FID_CA_name = (*jniEnv)->GetFieldID(jniEnv, classCsiAttribute, "name",
					    "Ljava/lang/String;");
	if (FID_CA_name == NULL) {
	...
	FID_CA_value = (*jniEnv)->GetFieldID(jniEnv, classCsiAttribute, "value",
					     "Ljava/lang/String;");
			...
			const SaAmfCSIAttributeT *saCsiAttributePtr)
{
	...
	_sCsiAttribute = (*jniEnv)->NewObject(jniEnv, ClassCsiAttribute,
					      CID_CsiAttribute_constructor);
	if (_sCsiAttribute == NULL) {
	...
	if (JNU_CsiAttribute_set(jniEnv, _sCsiAttribute, saCsiAttributePtr) !=
	    JNI_TRUE) {
		// TODO error handling
		return NULL; // exception thrown already...
	}
		     ...
		     const SaAmfCSIAttributeT *saCsiAttributePtr)
{
	...
	// name
	_nameString = (*jniEnv)->NewStringUTF(
	    jniEnv, (char *)saCsiAttributePtr->attrName);
	if (_nameString == NULL) {
		// TODO error handling
		return JNI_FALSE; // OutOfMemoryError thrown already...
	}
	(*jniEnv)->SetObjectField(jniEnv, sCsiAttribute, FID_CA_name,
				  _nameString);
	// value
	_valueString = (*jniEnv)->NewStringUTF(
	    jniEnv, (char *)saCsiAttributePtr->attrValue);
	if (_valueString == NULL) {
		// TODO error handling
		return JNI_FALSE; // OutOfMemoryError thrown already...
	}
	(*jniEnv)->SetObjectField(jniEnv, sCsiAttribute, FID_CA_value,
				  _valueString);
...
jboolean JNU_RecommendedRecovery_initIDs_OK(JNIEnv *jniEnv)
{
	...
	EnumRecommendedRecovery = (*jniEnv)->NewGlobalRef(
	    jniEnv, (*jniEnv)->FindClass(
			jniEnv, "org/saforum/ais/amf/RecommendedRecovery"));
	...
	// get IDs
	return JNU_RecommendedRecovery_initIDs_FromClass_OK(
	    jniEnv, EnumRecommendedRecovery);
}
					     ...
					     jclass enumRecommendedRecovery)
{
	...
	// get field IDs
	FID_RR_value = (*jniEnv)->GetFieldID(jniEnv, enumRecommendedRecovery,
					     "value", "I");
