...
Java_org_opensaf_ais_clm_ClmHandleImpl_finalizeClmHandle(JNIEnv *, jobject);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_clm_ClmHandleImpl_invokeSaClmInitialize(JNIEnv *, jobject,
                                                             jobject);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_clm_ClmHandleImpl_invokeSaClmDispatch(JNIEnv *, jobject,
                                                           jint);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_clm_ClmHandleImpl_invokeSaClmResponse(JNIEnv *, jobject,
                                                           jlong, jobject);
