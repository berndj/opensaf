...
#ifndef LIBJAVA_TRACER_H_
#define LIBJAVA_TRACER_H_
...
#define _TRACE2(format, ...) jTrace(__FILE__, __LINE__, format, ##__VA_ARGS__);
...
#define _TRACE_INLINE(format, ...) jTrace(NULL, 0, format, ##__VA_ARGS__);
#else
