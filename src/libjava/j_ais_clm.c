...
jobject JNU_ClusterNode_create_4(JNIEnv *jniEnv,
				 const SaClmClusterNodeT_4 *saClusterNodePtr);
static jboolean JNU_ClusterNode_set(JNIEnv *jniEnv, jobject sClusterNode,
				    const SaClmClusterNodeT *saClusterNodePtr);
static jboolean
JNU_ClusterNode_set_4(JNIEnv *jniEnv, jobject sClusterNode,
		      const SaClmClusterNodeT_4 *saClusterNodePtr);
...
static jboolean
JNU_NodeAddressIPv4_initIDs_FromClass_OK(JNIEnv *jniEnv,
					 jclass classNodeAddressIPv4);

// CLASS ais.clm.NodeAddressIPv6
jboolean JNU_NodeAddressIPv6_initIDs_OK(JNIEnv *jniEnv);
static jboolean
JNU_NodeAddressIPv6_initIDs_FromClass_OK(JNIEnv *jniEnv,
					 jclass classNodeAddressIPv6);

// CLASS ais.clm.ClusterNotificationBuffer
jboolean JNU_ClusterNotificationBuffer_initIDs_OK(JNIEnv *jniEnv);
static jboolean JNU_ClusterNotificationBuffer_initIDs_FromClass_OK(
    JNIEnv *jniEnv, jclass classClusterNotificationBuffer);
static jobject JNU_ClusterNotificationBuffer_create(
    JNIEnv *jniEnv,
    const SaClmClusterNotificationBufferT *saNotificationBufferPtr);
static jobject JNU_ClusterNotificationBuffer_create_4(
    JNIEnv *jniEnv,
    const SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr);
jboolean JNU_ClusterNotificationBuffer_set(
    JNIEnv *jniEnv, jobject sClusterNotificationBuffer,
    const SaClmClusterNotificationBufferT *saNotificationBufferPtr);
jboolean JNU_ClusterNotificationBuffer_set_4(
    JNIEnv *jniEnv, jobject sClusterNotificationBuffer,
    const SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr);
// CLASS ais.clm.ClusterNotification
jboolean JNU_ClusterNotification_initIDs_OK(JNIEnv *jniEnv);
static jboolean
JNU_ClusterNotification_initIDs_FromClass_OK(JNIEnv *jniEnv,
					     jclass classClusterNotification);
static jobject JNU_ClusterNotification_create(
    JNIEnv *jniEnv, const SaClmClusterNotificationT *saNotificationPtr);
static jobject JNU_ClusterNotification_create_4(
    JNIEnv *jniEnv, const SaClmClusterNotificationT_4 *saNotificationPtr);
static jboolean JNU_ClusterNotification_set(
    JNIEnv *jniEnv, jobject sClusterNotification,
    const SaClmClusterNotificationT *saClusterNotificationPtr);
static jboolean JNU_ClusterNotification_set_4(
    JNIEnv *jniEnv, jobject sClusterNotification,
				 ...
				 SaAisErrorT saError)
{
	...
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassClmHandle, MID_s_invokeGetClusterNodeCallback,
	    (jlong)saInvocation, _sClusterNode, (jint)saError);
    ...
    SaUint32T saNumberOfMembers, SaAisErrorT saError)
{
	...
	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassClmHandle, MID_s_invokeTrackClusterCallback,
	    _sClusterNotificationBuffer, (jint)saNumberOfMembers,
	    (jint)saError);
    ...
    SaClmChangeStepT step, SaTimeT timeSupervision, SaAisErrorT saError)
{
	...
	// create new ClusterNotificationBuffer object
	_sClusterNotificationBuffer = JNU_ClusterNotificationBuffer_create_4(
	    _jniEnv, saNotificationBufferPtr);
	if (_sClusterNotificationBuffer == NULL) {
	...
	_rootCauseEntity =
	    (*_jniEnv)->NewStringUTF(_jniEnv, (char *)rootCauseEntity->value);

	/* invoke Java callback */

	(*_jniEnv)->CallStaticVoidMethod(
	    _jniEnv, ClassClmHandle, MID_s_invokeTrackClusterCallback_4,
	    _sClusterNotificationBuffer, (jint)saNumberOfMembers,
	    (jlong)invocation, _rootCauseEntity, NULL, (jint)step,
...
jboolean JNU_ClusterNode_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassClusterNode =
	    JNU_GetGlobalClassRef(jniEnv, "org/saforum/ais/clm/ClusterNode");
						     ...
						     jclass classClusterNode)
{
	...
	CID_ClusterNode_constructor =
	    (*jniEnv)->GetMethodID(jniEnv, classClusterNode, "<init>", "()V");
	...
	// get field IDs
	FID_nodeId =
	    (*jniEnv)->GetFieldID(jniEnv, classClusterNode, "nodeId", "I");
	if (FID_nodeId == NULL) {
	...
	FID_nodeAddress =
	    (*jniEnv)->GetFieldID(jniEnv, classClusterNode, "nodeAddress",
	...
	FID_nodeName = (*jniEnv)->GetFieldID(jniEnv, classClusterNode,
	...
	FID_member =
	    (*jniEnv)->GetFieldID(jniEnv, classClusterNode, "member", "Z");
	if (FID_member == NULL) {
	...
	FID_bootTimestamp = (*jniEnv)->GetFieldID(jniEnv, classClusterNode,
						  "bootTimestamp", "J");
	...
	FID_initialViewNumber = (*jniEnv)->GetFieldID(jniEnv, classClusterNode,
						      "initialViewNumber", "J");
	...
	FID_executionEnvironment =
	    (*jniEnv)->GetFieldID(jniEnv, classClusterNode,
				  "executionEnvironment", "Ljava/lang/String;");
			       ...
			       const SaClmClusterNodeT *saClusterNodePtr)
{
	...
	// create new ClusterNode object
	_sClusterNode = (*jniEnv)->NewObject(jniEnv, ClassClusterNode,
					     CID_ClusterNode_constructor);
	if (_sClusterNode == NULL) {
	...
	if (JNU_ClusterNode_set(jniEnv, _sClusterNode, saClusterNodePtr) !=
	    JNI_TRUE) {
		// TODO error handling
				 ...
				 const SaClmClusterNodeT_4 *saClusterNodePtr)
{
	...
	// set ClusterNode object
	if (JNU_ClusterNode_set_4(jniEnv, _sClusterNode, saClusterNodePtr) !=
	    JNI_TRUE) {
		// TODO error handling
		return NULL; // exception thrown already...
	}
				    ...
				    const SaClmClusterNodeT *saClusterNodePtr)
{
	...
	// nodeId
	(*jniEnv)->SetIntField(jniEnv, sClusterNode, FID_nodeId,
			       (jint)saClusterNodePtr->nodeId);
	// nodeAddress
	_nodeAddressString = JNU_newStringFromSaNodeAddressT(
	    jniEnv, &(saClusterNodePtr->nodeAddress));
	...
	_sNodeAddress =
	    (saClusterNodePtr->nodeAddress.family == SA_CLM_AF_INET)
		? (*jniEnv)->NewObject(jniEnv, ClassNodeAddressIPv4,
	...
	(*jniEnv)->SetObjectField(jniEnv, _sNodeAddress, FID_NodeAddress_value,
				  _nodeAddressString);
	(*jniEnv)->SetObjectField(jniEnv, sClusterNode, FID_nodeAddress,
				  _sNodeAddress);
	// nodeName
	_nodeNameString =
	    JNU_newStringFromSaNameT(jniEnv, &(saClusterNodePtr->nodeName));
	if (_nodeNameString == NULL) {
		// TODO error handling
		return JNI_FALSE; // OutOfMemoryError thrown already...
	}
	(*jniEnv)->SetObjectField(jniEnv, sClusterNode, FID_nodeName,
				  _nodeNameString);
	// member
	(*jniEnv)->SetBooleanField(jniEnv, sClusterNode, FID_member,
				   (jboolean)saClusterNodePtr->member);

	// bootTimestamp
	(*jniEnv)->SetLongField(jniEnv, sClusterNode, FID_bootTimestamp,
				(jlong)saClusterNodePtr->bootTimestamp);
	// initialViewNumber
	(*jniEnv)->SetLongField(jniEnv, sClusterNode, FID_initialViewNumber,
		      ...
		      const SaClmClusterNodeT_4 *saClusterNodePtr)
{
	...
	_executionEnvironment = JNU_newStringFromSaNameT(
	    jniEnv, &(saClusterNodePtr->executionEnvironment));

	(*jniEnv)->SetObjectField(jniEnv, sClusterNode,
				  FID_executionEnvironment,
...
jboolean JNU_NodeAddress_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassNodeAddress =
	    JNU_GetGlobalClassRef(jniEnv, "org/saforum/ais/clm/NodeAddress");
						     ...
						     jclass classNodeAddress)
{
	...
	// get field IDs
	FID_NodeAddress_value = (*jniEnv)->GetFieldID(
	    jniEnv, classNodeAddress, "value", "Ljava/lang/String;");
...
jboolean JNU_NodeAddressIPv4_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassNodeAddressIPv4 = JNU_GetGlobalClassRef(
	    jniEnv, "org/saforum/ais/clm/NodeAddressIPv4");
					 ...
					 jclass classNodeAddressIPv4)
{
	...
	// get constructor IDs
	CID_NodeAddressIPv4_constructor = (*jniEnv)->GetMethodID(
	    jniEnv, classNodeAddressIPv4, "<init>", "()V");
...
jboolean JNU_NodeAddressIPv6_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassNodeAddressIPv6 = JNU_GetGlobalClassRef(
	    jniEnv, "org/saforum/ais/clm/NodeAddressIPv6");
					 ...
					 jclass classNodeAddressIPv6)
{
	...
	// get constructor IDs
	CID_NodeAddressIPv6_constructor = (*jniEnv)->GetMethodID(
	    jniEnv, classNodeAddressIPv6, "<init>", "()V");
...
jboolean JNU_ClusterNotificationBuffer_initIDs_OK(JNIEnv *jniEnv)
{
	...
	// get ClusterNotificationBuffer class & create a global reference right
	// away
	/*
	...
	ClassClusterNotificationBuffer = JNU_GetGlobalClassRef(
	    jniEnv, "org/saforum/ais/clm/ClusterNotificationBuffer");
	...
	// get IDs
	return JNU_ClusterNotificationBuffer_initIDs_FromClass_OK(
	    jniEnv, ClassClusterNotificationBuffer);
}
    ...
    JNIEnv *jniEnv, jclass classClusterNotificationBuffer)
{
	...
	// get constructor IDs
	CID_ClusterNotificationBuffer_constructor = (*jniEnv)->GetMethodID(
	    jniEnv, classClusterNotificationBuffer, "<init>", "()V");
	...
	// get field IDs
	FID_viewNumber = (*jniEnv)->GetFieldID(
	    jniEnv, classClusterNotificationBuffer, "viewNumber", "J");
	...
	FID_notifications = (*jniEnv)->GetFieldID(
	    jniEnv, classClusterNotificationBuffer, "notifications",
    ...
    const SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr)
{
	...
	_sClusterNotificationBuffer =
	    (*jniEnv)->NewObject(jniEnv, ClassClusterNotificationBuffer,
	...
	if (JNU_ClusterNotificationBuffer_set_4(
		jniEnv, _sClusterNotificationBuffer, saNotificationBufferPtr) !=
	    JNI_TRUE) {
		// TODO error handling
		return NULL; // exception thrown already...
	}
    ...
    const SaClmClusterNotificationBufferT *saNotificationBufferPtr)
{
	...
	// set ClusterNotificationBuffer object
	if (JNU_ClusterNotificationBuffer_set(
		jniEnv, _sClusterNotificationBuffer, saNotificationBufferPtr) !=
	    JNI_TRUE) {
		// TODO error handling
		return NULL; // exception thrown already...
    ...
    const SaClmClusterNotificationBufferT_4 *saNotificationBufferPtr)
{
	...
	// viewNumber
	(*jniEnv)->SetLongField(jniEnv, sClusterNotificationBuffer,
				FID_viewNumber,
				(jlong)saNotificationBufferPtr->viewNumber);

	// create notification array
	_arraySClusterNotification = (*jniEnv)->NewObjectArray(
	    jniEnv, saNotificationBufferPtr->numberOfItems,
	    ClassClusterNotification, NULL);
	...
	for (_idx = 0; _idx < saNotificationBufferPtr->numberOfItems; _idx++) {
		...
		(*jniEnv)->SetObjectArrayElement(
		    jniEnv, _arraySClusterNotification, (jsize)_idx,
    ...
    const SaClmClusterNotificationBufferT *saNotificationBufferPtr)
{
	...
	// create & assign array elements
	for (_idx = 0; _idx < saNotificationBufferPtr->numberOfItems; _idx++) {
		_sClusterNotification = JNU_ClusterNotification_create(
		    jniEnv, &(saNotificationBufferPtr->notification[_idx]));
		if (_sClusterNotification == NULL) {
...
jboolean JNU_ClusterNotification_initIDs_OK(JNIEnv *jniEnv)
{
	...
	ClassClusterNotification = JNU_GetGlobalClassRef(
	    jniEnv, "org/saforum/ais/clm/ClusterNotification");
	...
	// get IDs
	return JNU_ClusterNotification_initIDs_FromClass_OK(
	    jniEnv, ClassClusterNotification);
}
					     ...
					     jclass classClusterNotification)
{
	...
	// get constructor IDs
	CID_ClusterNotification_constructor = (*jniEnv)->GetMethodID(
	    jniEnv, classClusterNotification, "<init>", "()V");
	...
	// get field IDs
	FID_clusterChange = (*jniEnv)->GetFieldID(
	    jniEnv, classClusterNotification, "clusterChange",
	...
	FID_clusterNode = (*jniEnv)->GetFieldID(
	    jniEnv, classClusterNotification, "clusterNode",
    ...
    JNIEnv *jniEnv, const SaClmClusterNotificationT *saNotificationPtr)
{
	...
	_sClusterNotification =
	    (*jniEnv)->NewObject(jniEnv, ClassClusterNotification,
	...
	if (JNU_ClusterNotification_set(jniEnv, _sClusterNotification,
    ...
    JNIEnv *jniEnv, const SaClmClusterNotificationT_4 *saNotificationPtr)
{
	...
	// set ClusterNotification object
	if (JNU_ClusterNotification_set_4(jniEnv, _sClusterNotification,
					  saNotificationPtr) != JNI_TRUE) {
		// TODO error handling
		return NULL; // exception thrown already...
	}
    ...
    const SaClmClusterNotificationT *saClusterNotificationPtr)
{
	...
	jobject _clusterChange = (*jniEnv)->CallStaticObjectMethod(
	    jniEnv, ClassClmHandle, MID_s_getClusterChange,
	    saClusterNotificationPtr->clusterChange);

	assert(_clusterChange != NULL);

	// clusterChange
	(*jniEnv)->SetObjectField(jniEnv, sClusterNotification,
				  FID_clusterChange, _clusterChange);
	// clusterNode
	_sClusterNode = JNU_ClusterNode_create(
	    jniEnv, &(saClusterNotificationPtr->clusterNode));
	if (_sClusterNode == NULL) {
	...
	(*jniEnv)->SetObjectField(jniEnv, sClusterNotification, FID_clusterNode,
				  _sClusterNode);
    ...
    const SaClmClusterNotificationT_4 *saClusterNotificationPtr)
{
	...
	(*jniEnv)->SetObjectField(jniEnv, sClusterNotification,
				  FID_clusterChange, _clusterChange);
	// clusterNode
	_sClusterNode = JNU_ClusterNode_create_4(
	    jniEnv, &(saClusterNotificationPtr->clusterNode));
	if (_sClusterNode == NULL) {
