...
Java_org_opensaf_ais_amf_AmfHandleImpl_finalizeAmfHandle(JNIEnv *, jobject);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_AmfHandleImpl_invokeSaAmfInitialize(JNIEnv *, jobject,
                                                             jobject);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_AmfHandleImpl_invokeSaAmfDispatch(JNIEnv *, jobject,
                                                           jint);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_ComponentRegistryImpl_registerComponent(JNIEnv *,
                                                                 jobject);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_CsiManagerImpl_completedCsiQuiescing(JNIEnv *, jobject,
                                                              jlong, jint);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_ErrorReportingImpl_clearComponentError(JNIEnv *,
                                                                jobject,
                                                                jstring, jlong);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_HealthcheckImpl_confirmHealthcheck(JNIEnv *, jobject,
                                                            jstring, jbyteArray,
                                                            jint);
 ...
 */
JNIEXPORT void JNICALL
Java_org_opensaf_ais_amf_HealthcheckImpl_startHealthcheck(JNIEnv *, jobject,
                                                          jstring, jbyteArray,
                                                          jobject, jobject);
 ...
 * Signature:
 * (Ljava/lang/String;Lorg/saforum/ais/amf/ProcessMonitoring/PmStopQualifier;JI)V
 */
JNIEXPORT void JNICALL
