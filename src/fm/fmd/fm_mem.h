...
#ifndef FM_FMD_FM_MEM_H_
#define FM_FMD_FM_MEM_H_
...
#define m_MMGR_FREE_FM_EVT(ptr)                                      \
  m_NCS_MEM_FREE(ptr, NCS_MEM_REGION_PERSISTENT, NCS_SERVICE_ID_GFM, \
                 NCS_FM_SVC_SUB_ID_FM_EVT)

#define m_MMGR_ALLOC_FM_FM_MSG                                                 \
  (GFM_GFM_MSG*)m_NCS_MEM_ALLOC(sizeof(GFM_GFM_MSG),                           \
                                NCS_MEM_REGION_PERSISTENT, NCS_SERVICE_ID_GFM, \
                                NCS_FM_SVC_SUB_ID_GFM_GFM)

#define m_MMGR_FREE_FM_FM_MSG(p)                                   \
  m_NCS_MEM_FREE(p, NCS_MEM_REGION_PERSISTENT, NCS_SERVICE_ID_GFM, \
                 NCS_FM_SVC_SUB_ID_GFM_GFM)

#endif  // FM_FMD_FM_MEM_H_
