...
static void clmTrackbuf_4(SaClmClusterNotificationBufferT_4 *notificationBuffer)
{
	...
	for (i = 0; i < notificationBuffer->numberOfItems; i++) {
		...
		printf(
		    "Node  nodeAddress family  = %d,node address length = %d, node address value = %s\n",
		    notificationBuffer->notification[i]
...
static void
clmTrackCallback1(const SaClmClusterNotificationBufferT *notificationBuffer,
...
void saClmClusterTrack_36(void)
{
	...
	trackFlags =
	    SA_TRACK_CHANGES | SA_TRACK_START_STEP | SA_TRACK_VALIDATE_STEP;
...
__attribute__((constructor)) static void saClmClusterTrack_constructor(void)
{
	test_suite_add(
	    7,
	    "Test case for saClmClusterTrack. ** For all tests to pass, Run a payload with node_name PL-3 **\n");
	test_case_add(7, saClmClusterTrack_01,
		      "saClmClusterTrack with valid param");
	test_case_add(7, saClmClusterTrack_02,
		      "saClmClusterTrack_4 with valid param");
	test_case_add(
	    7, saClmClusterTrack_03,
	    "saClmClusterTrack with (SA_TRACK_CURRENT | SA_TRACK_LOCAL)");
	test_case_add(
	    7, saClmClusterTrack_04,
	...
	test_case_add(7, saClmClusterTrack_06,
		      "saClmClusterTrack with null flags)");
	test_case_add(7, saClmClusterTrack_07,
		      "saClmClusterTrack with null buffer & null callbacks)");
	test_case_add(
	    7, saClmClusterTrack_08,
	    "saClmClusterTrack_4 with null handle or invalid handle)");
	test_case_add(7, saClmClusterTrack_09,
		      "saClmClusterTrack_4 with null flags");
	...
	test_case_add(
	    7, saClmClusterTrack_17,
	    "saClmClusterTrack_4 with SA_TRACK_CHANGES and SA_TRACK_CHANGES_ONLY track flags");
	test_case_add(
	    7, saClmClusterTrack_18,
	...
	test_case_add(
	    7, saClmClusterTrack_20,
	    "saClmClusterTrack with SA_TRACK_CHANGES and SA_TRACK_CHANGES_ONLY track flags");
	test_case_add(
	    7, saClmClusterTrack_21,
	    "saClmClusterTrack_4 with SA_TRACK_CHANGES_ONLY track flags - admin lock");
	test_case_add(
	    7, saClmClusterTrack_22,
