...
__attribute__((constructor)) static void saClmClusterNodeGet_constructor(void)
{
	...
	test_case_add(
	    5, saClmClusterNodeGet_06,
	    "saClmClusterNodeGet & saClmClusterNodeGet_4 with nodeId which does not exist");
	test_case_add(
	    5, saClmClusterNodeGet_07,
	    "saClmClusterNodeGet & saClmClusterNodeGet_4 with nodeId of non member node");
	test_case_add(
	    5, saClmClusterNodeGet_08,
	    "saClmClusterNodeGet & saClmClusterNodeGet_4 call with cross version");
	test_case_add(
	    5, saClmClusterNodeGet_09,
	    "saClmClusterNodeGet & saClmClusterNodeGet_4 with nodeId as SA_CLM_LOCAL_NODE_ID");
}
