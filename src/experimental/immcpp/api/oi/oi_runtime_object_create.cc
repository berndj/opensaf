...
namespace immoi {
//-----------------------------------------------------------------------------
// ImmOiRtObjectCreate class
//-----------------------------------------------------------------------------
ImmOiRtObjectCreate::ImmOiRtObjectCreate(
...
bool ImmOiRtObjectCreate::CreateObject() {
  TRACE_ENTER();
  SaNameT name;
  ...
  while (wtime.is_timeout() == false) {
    ais_error_ = saImmOiRtObjectCreate_2(
        oi_handle_,
...
void ImmOiRtObjectCreate::FreeAllocatedMemory() {
  TRACE_ENTER();
  for (auto& attribute : list_of_attribute_properties_) {
