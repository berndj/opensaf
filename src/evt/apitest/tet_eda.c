...
SaEvtEventPatternT gl_pattern[2] = {
    {5, 5, (SaUint8T *)"Hello"}, {4, 4, (SaUint8T *)"Moto"},
};
SaEvtEventFilterT gl_filter[1] = {{3, {5, 5, (SaUint8T *)"Hello"}}};
const char *gl_saf_error[] = {
    "SA_AIS_NOT_VALID", "SA_AIS_OK", "SA_AIS_ERR_LIBRARY", "SA_AIS_ERR_VERSION",
    "SA_AIS_ERR_INIT", "SA_AIS_ERR_TIMEOUT", "SA_AIS_ERR_TRY_AGAIN",
    "SA_AIS_ERR_INVALID_PARAM", "SA_AIS_ERR_NO_MEMORY", "SA_AIS_ERR_BAD_HANDLE",
    "SA_AIS_ERR_BUSY", "SA_AIS_ERR_ACCESS", "SA_AIS_ERR_NOT_EXIST",
    "SA_AIS_ERR_NAME_TOO_LONG", "SA_AIS_ERR_EXIST", "SA_AIS_ERR_NO_SPACE",
    "SA_AIS_ERR_INTERRUPT", "SA_AIS_ERR_NAME_NOT_FOUND",
    "SA_AIS_ERR_NO_RESOURCES", "SA_AIS_ERR_NOT_SUPPORTED",
    "SA_AIS_ERR_BAD_OPERATION", "SA_AIS_ERR_FAILED_OPERATION",
    "SA_AIS_ERR_MESSAGE_ERROR", "SA_AIS_ERR_QUEUE_FULL",
    "SA_AIS_ERR_QUEUE_NOT_AVAILABLE", "SA_AIS_ERR_BAD_FLAGS",
    "SA_AIS_ERR_TOO_BIG", "SA_AIS_ERR_NO_SECTIONS",
    /* B03 Additions */
    "SA_AIS_ERR_NO_OP", "SA_AIS_ERR_REPAIR_PENDING", "SA_AIS_ERR_NO_BINDINGS",
...
void tet_saEvtInitializeCases(int iOption)
{
 ...
 saEvtEventDeliverCallback",
	...
	case 10:
		...
		gl_rc = saEvtInitialize(&gl_evtHandle, &gl_evtCallbacks,
					&gl_version);
		result("saEvtInitialize() with error version",
		       SA_AIS_ERR_VERSION);
	...
	case 11:
		...
		gl_rc = saEvtInitialize(&gl_evtHandle, &gl_evtCallbacks,
					&gl_version);
		result("saEvtInitialize() with minor version set to 0",
		       SA_AIS_OK);
		printf("\nVersion Delivered : %c %d %d", gl_version.releaseCode,
		       gl_version.majorVersion, gl_version.minorVersion);
		tet_printf("Version Delivered : %c %d %d",
	...
	case 13:
		...
		gl_rc = saEvtInitialize(&gl_evtHandle, &gl_evtCallbacks,
					&gl_version);
		result("saEvtInitialize() with major version set to 0",
		       SA_AIS_ERR_VERSION);
	...
	case 16:
		...
		gl_rc = saEvtInitialize(&gl_evtHandle, &gl_evtCallbacks,
					&gl_version);
		result("saEvtInitialize() after locking the node",
		       SA_AIS_ERR_UNAVAILABLE);
...
{
	printf("\n---------- tet_saEvtChannelOpenCases : %d -------------",
	       iOption);
	SaNameT emptyName = {0, ""}, errName = {4, "Test"};

	switch (iOption) {
	case 1:
		gl_rc = saEvtChannelOpen((SaEvtHandleT)(long)NULL,
					 &gl_channelName, SA_EVT_CHANNEL_CREATE,
	...
	case 3:
		gl_rc = saEvtChannelOpen(123, &gl_channelName,
					 SA_EVT_CHANNEL_CREATE, gl_timeout,
					 &gl_channelHandle);
	...
	case 5:
		...
		gl_rc =
		    saEvtChannelOpen(gl_evtHandle, NULL, SA_EVT_CHANNEL_CREATE,
				     gl_timeout, &gl_channelHandle);
	...
	case 6:
		...
		gl_rc = saEvtChannelOpen(gl_evtHandle, &emptyName,
					 SA_EVT_CHANNEL_CREATE, gl_timeout,
					 &gl_channelHandle);
	...
	case 8:
		...
		gl_rc = saEvtChannelOpen(gl_evtHandle, &gl_channelName,
					 gl_channelOpenFlags, gl_timeout,
					 &gl_channelHandle);
		result(
	...
	case 9:
		...
		gl_rc = saEvtChannelOpen(gl_evtHandle, &gl_channelName, 24,
					 gl_timeout, &gl_channelHandle);
	...
	case 10:
		...
		gl_rc = saEvtChannelOpen(gl_evtHandle, &errName,
					 SA_EVT_CHANNEL_PUBLISHER, gl_timeout,
					 &gl_channelHandle);
		result(
 ...
 name(Test) is given",
	...
	case 11:
		...
		gl_rc = saEvtChannelOpen(gl_evtHandle, &errName,
					 SA_EVT_CHANNEL_SUBSCRIBER, gl_timeout,
					 &gl_channelHandle);
		result(
 ...
 name(Test) is given",
	...
	case 12:
		...
		gl_rc = saEvtChannelOpen(
		    gl_evtHandle, &gl_channelName, SA_EVT_CHANNEL_CREATE,
	...
	case 15:
		...
		gl_rc =
		    saEvtChannelOpen(gl_evtHandle, &gl_channelName,
...
void Initialize_Thread() { tet_saEvtInitialize(&gl_evtHandle); }
void SelectionObjectGet_Thread()
{
	tet_saEvtSelectionObjectGet(&gl_evtHandle, &gl_selObject);
}
void Dispatch_Thread() { tet_saEvtDispatch(&gl_evtHandle); }
...
void AttributesGet_Thread() { tet_saEvtEventAttributesGet(&gl_eventHandle); }
void Publish_Thread() { tet_saEvtEventPublish(&gl_eventHandle, &gl_evtId); }
void Free_Thread() { tet_saEvtEventFree(&gl_eventHandle); }
void ChannelClose_Thread() { tet_saEvtChannelClose(&gl_channelHandle); }
void ChannelUnlink_Thread() { tet_saEvtChannelUnlink(&gl_evtHandle); }
void Finalize_Thread() { tet_saEvtFinalize(&gl_evtHandle); }
void tet_Publish_Thread()
{
	...
	var_initialize();
	/*Initialize thread*/
	if (tet_create_task((NCS_OS_CB)Initialize_Thread) == NCSCC_RC_SUCCESS) {
		...
		fflush(stdout);
		/*Now Release the Initialize Thread*/
		if (m_NCS_TASK_RELEASE(gl_t_handle) == NCSCC_RC_SUCCESS) {
			printf("\tTASK is released\n");
		}
	}
	...
	/*Dispatch thread*/
	if (tet_create_task((NCS_OS_CB)Dispatch_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
	...
	/*Allocate thread*/
	if (tet_create_task((NCS_OS_CB)Allocate_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
	...
	/*Publish thread*/
	if (tet_create_task((NCS_OS_CB)Publish_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
	...
	/*Free thread*/
	if (tet_create_task((NCS_OS_CB)Free_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
	...
	/*Finalize thread*/
	if (tet_create_task((NCS_OS_CB)Finalize_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
...
void tet_saEvtChannelOpenAsyncCases(int iOption)
{
	...
	switch (iOption) {
	case 1:
		gl_rc = saEvtChannelOpenAsync((SaEvtHandleT)(long)NULL,
					      gl_invocation, &asyncchannelName,
	...
	case 2:
		...
		gl_rc = saEvtChannelOpenAsync(gl_evtHandle, gl_invocation,
					      &asyncchannelName,
					      SA_EVT_CHANNEL_CREATE);
		result(
	...
	case 3:
		gl_rc =
		    saEvtChannelOpenAsync(123, gl_invocation, &asyncchannelName,
					  SA_EVT_CHANNEL_CREATE);
	...
	case 6:
		...
		gl_rc = saEvtChannelOpenAsync(gl_evtHandle, gl_invocation,
					      ...
					      gl_channelOpenFlags);
		result(
		    "saEvtChannelOpenAsync() with NULL event Deliver Callback",
		    SA_AIS_OK);
 ...
 channel name(Temp)",
	...
	case 8:
		...
		result(
		    "saEvtChannelOpenAsync() with SA_EVT_CHANNEL_SUBSCRIBER on async\
 channel name(Temp)",
		    SA_AIS_OK);
		thread_creation(&gl_evtHandle);
		DISPATCH_SLEEP();
	...
	case 9:
		...
		gl_rc = saEvtChannelOpenAsync(
		    gl_evtHandle, (SaInvocationT)(long)NULL, &asyncchannelName,
		    SA_EVT_CHANNEL_CREATE);
		result("saEvtChannelOpenAsync() with NULL invocation",
		       SA_AIS_OK);
		thread_creation(&gl_evtHandle);
		DISPATCH_SLEEP();
	...
	case 11:
		...
		gl_rc = saEvtChannelOpenAsync(gl_evtHandle, gl_invocation,
					      &asyncchannelName,
					      SA_EVT_CHANNEL_CREATE);
		result("saEvtChannelOpenAsync() with initialized invocation",
		       SA_AIS_OK);
		thread_creation(&gl_evtHandle);
		DISPATCH_SLEEP();
	...
	case 12:
		...
		gl_rc =
		    saEvtChannelOpenAsync(gl_evtHandle, -123, &asyncchannelName,
					  SA_EVT_CHANNEL_CREATE);
		result("saEvtChannelOpenAsync() with garbage invocation",
		       SA_AIS_OK);
		thread_creation(&gl_evtHandle);
		DISPATCH_SLEEP();
	...
	case 14:
		...
		gl_rc =
		    saEvtChannelOpenAsync(gl_evtHandle, gl_invocation,
					  &emptyName, SA_EVT_CHANNEL_CREATE);
		result(
	...
	case 15:
		...
		gl_rc = saEvtChannelOpenAsync(
		    gl_evtHandle, gl_invocation, &asyncchannelName,
		    (SaEvtChannelOpenFlagsT)(long)NULL);
...
void ChannelOpenAsync_Thread() { tet_saEvtChannelOpenAsync(&gl_evtHandle); }
...
void tet_saEvtChannelUnlinkCases(int iOption)
{
	...
	switch (iOption) {
	case 1:
		gl_rc = saEvtChannelUnlink((SaEvtHandleT)(long)NULL,
					   &gl_channelName);
...
void tet_saEvtEventAllocateCases(int iOption)
{
	...
	switch (iOption) {
	case 1:
		gl_rc = saEvtEventAllocate((SaEvtChannelHandleT)(long)NULL,
					   &gl_eventHandle);
	...
	case 4:
		...
		gl_channelOpenFlags =
		    SA_EVT_CHANNEL_CREATE | SA_EVT_CHANNEL_PUBLISHER;
		tet_saEvtChannelOpen(&gl_evtHandle, &gl_channelHandle);
	...
	case 5:
		...
		gl_channelOpenFlags =
		    SA_EVT_CHANNEL_CREATE | SA_EVT_CHANNEL_SUBSCRIBER;
		tet_saEvtChannelOpen(&gl_evtHandle, &gl_channelHandle);
...
void tet_saEvtEventAttributesGetCases(int iOption)
{
	...
	printf(
	    ...
	    iOption);
	SaEvtEventPatternT maxPatternSize[1] = {{3, 255, (SaUint8T *)"Hello"}};
	...
	case 1:
		var_initialize();
		tet_saEvtInitialize(&gl_evtHandle);
		gl_rc = saEvtEventAttributesGet(
		    (SaEvtEventHandleT)(long)NULL, &gl_patternArray,
	...
	case 2:
		...
		gl_rc = saEvtEventAttributesGet(
		    gl_eventHandle, &gl_patternArray, &gl_priority,
		    &gl_retentionTime, &gl_publisherName, &gl_publishTime,
		    &gl_evtId);
		result(
	...
	case 3:
		...
		tet_saEvtInitialize(&gl_evtHandle);
		gl_rc = saEvtEventAttributesGet(
		    123, &gl_patternArray, &gl_priority, &gl_retentionTime,
	...
	case 4:
		...
		gl_rc = saEvtEventAttributesGet(
		    gl_eventHandle, NULL, &gl_priority, &gl_retentionTime,
		    &gl_publisherName, &gl_publishTime, &gl_evtId);
	...
	case 6:
		...
		gl_rc = saEvtEventAttributesGet(
		    gl_eventHandle, &gl_patternArray, NULL, &gl_retentionTime,
		    &gl_publisherName, &gl_publishTime, &gl_evtId);
	...
	case 8:
		...
		gl_rc = saEvtEventAttributesGet(
		    gl_eventHandle, &gl_patternArray, &gl_priority, NULL,
		    &gl_publisherName, &gl_publishTime, &gl_evtId);
	...
	case 13:
		...
		temp = (SaEvtEventPatternArrayT *)malloc(
		...
		gl_rc = saEvtEventAttributesGet(
		    gl_eventHandle, temp, &gl_priority, &gl_retentionTime,
		    &gl_publisherName, &gl_publishTime, &gl_evtId);
		result(
	...
	case 16:
		...
		gl_rc = saEvtEventPatternFree(gl_eventHandle, temp->patterns);
		result(
		    "saEvtEventPatternsFree() for already saEvtEventFreed patterns",
		    SA_AIS_ERR_BAD_HANDLE);
...
void tet_saEvtEventAttributesSetCases(int iOption)
{
	...
	SaEvtEventPatternT maxPatternSize[1] = {{3, 444, (SaUint8T *)"Hello"}};
	switch (iOption) {
	case 1:
		var_initialize();
		tet_saEvtInitialize(&gl_evtHandle);
		gl_rc = saEvtEventAttributesSet(
		    (SaEvtEventHandleT)(long)NULL, &gl_patternArray,
		    gl_priority, gl_retentionTime, &gl_publisherName);
	...
	case 3:
		var_initialize();
		tet_saEvtInitialize(&gl_evtHandle);
		gl_rc = saEvtEventAttributesSet(123, &gl_patternArray,
	...
	case 4:
		...
		gl_rc = saEvtEventAttributesSet(gl_eventHandle, NULL,
						gl_priority, gl_retentionTime,
						&gl_publisherName);
	...
	case 6:
		...
		gl_patternArray.patterns = gl_pattern;
		gl_rc = saEvtEventAttributesSet(
		    gl_eventHandle, &gl_patternArray,
	...
	case 7:
		...
		gl_rc = saEvtEventAttributesSet(
		    gl_eventHandle, &gl_patternArray, 5, gl_retentionTime,
		    &gl_publisherName);
	...
	case 9:
		...
		gl_patternArray.patternsNumber = 2;
		gl_patternArray.patterns = gl_pattern;
		gl_rc = saEvtEventAttributesSet(gl_eventHandle,
						&gl_patternArray, gl_priority,
...
void tet_saEvtEventDataGetCases(int iOption)
{
	...
	printf("\n---------- tet_saEvtEventDataGetCases : %d -------------",
	       iOption);
	switch (iOption) {
	case 1:
		var_initialize();
		tet_saEvtInitialize(&gl_evtHandle);
		gl_rc = saEvtEventDataGet((SaEvtEventHandleT)(long)NULL,
	...
	case 2:
		...
		gl_rc = saEvtEventDataGet(gl_eventHandle, &gl_eventData,
					  &gl_eventDataSize);
	...
	case 4:
		...
		gl_rc = saEvtEventDataGet(gl_eventDeliverHandle, NULL,
					  &gl_eventDataSize);
	...
	case 5:
		...
		result(
		    "saEvtEventDataGet() with NULL event data and event data size",
		    SA_AIS_OK);
		tet_saEvtEventFree(&gl_eventHandle);
	...
	case 7:
		...
		gl_rc = saEvtEventDataGet(gl_eventDeliverHandle, &tempData,
					  &eventDataSize);
		result(
...
void DataGet_Thread() { tet_saEvtEventDataGet(&gl_eventDeliverHandle); }
void tet_DataGet_Thread()
{
	...
	/*DataGet thread*/
	if (tet_create_task((NCS_OS_CB)DataGet_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
...
{
	printf("\n---------- tet_saEvtEventPublishCases : %d -------------",
	       iOption);
	switch (iOption) {
	case 1:
		gl_rc = saEvtEventPublish((SaEvtEventHandleT)(long)NULL,
					  &gl_eventData, gl_eventDataSize,
					  &gl_evtId);
	...
	case 3:
		gl_rc = saEvtEventPublish(123, &gl_eventData, gl_eventDataSize,
					  &gl_evtId);
	...
	case 10:
		...
		gl_rc = saEvtEventAttributesSet(gl_eventHandle, NULL,
						...
						&gl_publisherName);
		resultSuccess(
		    "saEvtEventAttributesSet() invoked with NULL pattern \
array",
		    gl_rc);
...
void tet_saEvtEventSubscribeCases(int iOption)
{
	...
	switch (iOption) {
	case 1:
		gl_rc = saEvtEventSubscribe((SaEvtChannelHandleT)(long)NULL,
	...
	case 3:
		gl_rc = saEvtEventSubscribe(123, &gl_filterArray,
					    gl_subscriptionId);
	...
	case 5:
		...
		gl_rc = saEvtEventSubscribe(gl_channelHandle, NULL,
					    gl_subscriptionId);
...
void Unsubscribe_Thread() { tet_saEvtEventUnsubscribe(&gl_channelHandle); }
void tet_Subscribe_Thread()
{
	...
	/*Subscribe thread*/
	if (tet_create_task((NCS_OS_CB)Subscribe_Thread) == NCSCC_RC_SUCCESS) {
		printf("\tTask has been Created\t");
		fflush(stdout);
...
void tet_saEvtEventUnsubscribeCases(int iOption)
{
	...
	switch (iOption) {
	case 1:
		gl_rc = saEvtEventUnsubscribe((SaEvtChannelHandleT)(long)NULL,
					      gl_subscriptionId);
	...
	case 4:
		...
		gl_rc = saEvtEventUnsubscribe(gl_channelHandle,
					      (SaEvtSubscriptionIdT)(long)NULL);
...
void tet_saEvtEventRetentionTimeClearCases(int iOption)
{
	...
	case 1:
		...
		gl_rc = saEvtEventRetentionTimeClear(
		    (SaEvtChannelHandleT)(long)NULL, gl_evtId);
		result(
	...
	case 2:
		...
		gl_rc =
		    saEvtEventRetentionTimeClear(gl_channelHandle, gl_evtId);
		result(
...
void tet_saEvtLimitGetCases(int iOption)
{
	...
	case 2:
		...
		gl_rc = saEvtLimitGet((SaEvtHandleT)(long)NULL, gl_limitId,
				      &gl_limitValue);
