...
function #       is defined as tet_edsv_startup(), as well as the tet_cleanup
function is defined #       as tet_edsv_end(). #   2.  If "tetware-patch" is not
used, Combine edsv_test[], api_test[], func_test[] and #       b03_test[] arrays
into a single array and named it as tet_testlist[]. #   3.  If "tetware-patch"
is not used, delete the third parameter of each item in test #       cases
array. And add some functions to implement the function of those parameters. #
4.  If "tetware-patch" is not used, delete parts of tet_run_edsv_app() function,
which #       invoke the functions in the patch. #   5.  If "tetware-patch" is
required, one can add a macro definition "TET_PATCH=1" in #       compilation
process.
#
*******************************************************************************************/
...
struct tet_testlist edsv_test[] = {
    ...
    {NULL, 0}};
struct tet_testlist api_test[] = {{tet_Initialize, 1},
				  {tet_ChannelOpen, 2},
...
struct tet_testlist func_test[] = {
    ...
    {tet_ChannelOpen_MultipleEvtHandle_SamePatterns,
     5}, /*run in a loop failing*/
    ...
    {tet_EventSubscribe_PatternMatch_DifferentSubscriptions,
     24}, /*snmp printfs added till here*/
...
struct tet_testlist b03_test[] = {
    ...
    {tet_saEvtEventAttributesGetCases, 3,
     15}, /*saEvtEventPatternFree cases by EventAlloc*/
...
struct tet_testlist *edsv_testlist[] = {
	[EDSV_TEST] = edsv_test, [EDSV_API_TEST] = api_test,
	[EDSV_FUNC_TEST] = func_test, [EDSV_CLM_TEST] = b03_test,
};
...
void tet_run_edsv_app()
{
	...
	for (iterCount = 1; iterCount <= gl_iteration; iterCount++) {
		...
		if (gl_listNumber == -1) {
			{
				for (listCount = 1; listCount <= 4;
				     listCount++) {
					tet_test_start(
					    gl_tCase, edsv_testlist[listCount]);
				}
			}
		} else {
			if (gl_listNumber != 4) {
				tet_test_start(gl_tCase,
					       edsv_testlist[gl_listNumber]);
			}
		}
...
/********** Test Case************/
void tet_saEvtInitializeCases_01() { tet_saEvtInitializeCases(1); }

void tet_saEvtInitializeCases_02() { tet_saEvtInitializeCases(2); }

void tet_saEvtInitializeCases_03() { tet_saEvtInitializeCases(3); }

void tet_saEvtInitializeCases_04() { tet_saEvtInitializeCases(4); }

void tet_saEvtInitializeCases_05() { tet_saEvtInitializeCases(5); }

void tet_saEvtInitializeCases_06() { tet_saEvtInitializeCases(6); }

void tet_saEvtInitializeCases_07() { tet_saEvtInitializeCases(7); }

void tet_saEvtInitializeCases_08() { tet_saEvtInitializeCases(8); }

void tet_saEvtInitializeCases_09() { tet_saEvtInitializeCases(9); }

void tet_saEvtInitializeCases_10() { tet_saEvtInitializeCases(10); }

void tet_saEvtInitializeCases_11() { tet_saEvtInitializeCases(11); }

void tet_saEvtInitializeCases_12() { tet_saEvtInitializeCases(12); }

void tet_saEvtInitializeCases_13() { tet_saEvtInitializeCases(13); }

void tet_saEvtInitializeCases_14() { tet_saEvtInitializeCases(14); }

void tet_saEvtInitializeCases_15() { tet_saEvtInitializeCases(15); }
...
void tet_saEvtDispatchCases_01() { tet_saEvtDispatchCases(1); }

void tet_saEvtDispatchCases_02() { tet_saEvtDispatchCases(2); }

void tet_saEvtDispatchCases_03() { tet_saEvtDispatchCases(3); }

void tet_saEvtDispatchCases_04() { tet_saEvtDispatchCases(4); }

void tet_saEvtDispatchCases_05() { tet_saEvtDispatchCases(5); }

void tet_saEvtDispatchCases_06() { tet_saEvtDispatchCases(6); }

void tet_saEvtDispatchCases_07() { tet_saEvtDispatchCases(7); }

void tet_saEvtDispatchCases_08() { tet_saEvtDispatchCases(8); }

void tet_saEvtDispatchCases_09() { tet_saEvtDispatchCases(9); }

void tet_saEvtFinalizeCases_01() { tet_saEvtFinalizeCases(1); }

void tet_saEvtFinalizeCases_02() { tet_saEvtFinalizeCases(2); }

void tet_saEvtFinalizeCases_03() { tet_saEvtFinalizeCases(3); }

void tet_saEvtFinalizeCases_04() { tet_saEvtFinalizeCases(4); }

void tet_saEvtChannelOpenCases_01() { tet_saEvtChannelOpenCases(1); }

void tet_saEvtChannelOpenCases_02() { tet_saEvtChannelOpenCases(2); }

void tet_saEvtChannelOpenCases_03() { tet_saEvtChannelOpenCases(3); }

void tet_saEvtChannelOpenCases_04() { tet_saEvtChannelOpenCases(4); }

void tet_saEvtChannelOpenCases_05() { tet_saEvtChannelOpenCases(5); }

void tet_saEvtChannelOpenCases_06() { tet_saEvtChannelOpenCases(6); }

void tet_saEvtChannelOpenCases_07() { tet_saEvtChannelOpenCases(7); }

void tet_saEvtChannelOpenCases_08() { tet_saEvtChannelOpenCases(8); }

void tet_saEvtChannelOpenCases_09() { tet_saEvtChannelOpenCases(9); }

void tet_saEvtChannelOpenCases_10() { tet_saEvtChannelOpenCases(10); }

void tet_saEvtChannelOpenCases_11() { tet_saEvtChannelOpenCases(11); }

void tet_saEvtChannelOpenCases_12() { tet_saEvtChannelOpenCases(12); }

void tet_saEvtChannelOpenCases_13() { tet_saEvtChannelOpenCases(13); }

void tet_saEvtChannelOpenCases_14() { tet_saEvtChannelOpenCases(14); }

void tet_saEvtChannelOpenCases_15() { tet_saEvtChannelOpenCases(15); }

void tet_saEvtChannelOpenCases_16() { tet_saEvtChannelOpenCases(16); }

void tet_saEvtChannelOpenAsyncCases_01() { tet_saEvtChannelOpenAsyncCases(1); }

void tet_saEvtChannelOpenAsyncCases_02() { tet_saEvtChannelOpenAsyncCases(2); }

void tet_saEvtChannelOpenAsyncCases_03() { tet_saEvtChannelOpenAsyncCases(3); }

void tet_saEvtChannelOpenAsyncCases_04() { tet_saEvtChannelOpenAsyncCases(4); }

void tet_saEvtChannelOpenAsyncCases_05() { tet_saEvtChannelOpenAsyncCases(5); }

void tet_saEvtChannelOpenAsyncCases_06() { tet_saEvtChannelOpenAsyncCases(6); }

void tet_saEvtChannelOpenAsyncCases_07() { tet_saEvtChannelOpenAsyncCases(7); }

void tet_saEvtChannelOpenAsyncCases_08() { tet_saEvtChannelOpenAsyncCases(8); }

void tet_saEvtChannelOpenAsyncCases_09() { tet_saEvtChannelOpenAsyncCases(9); }

void tet_saEvtChannelOpenAsyncCases_10() { tet_saEvtChannelOpenAsyncCases(10); }

void tet_saEvtChannelOpenAsyncCases_11() { tet_saEvtChannelOpenAsyncCases(11); }

void tet_saEvtChannelOpenAsyncCases_12() { tet_saEvtChannelOpenAsyncCases(12); }

void tet_saEvtChannelOpenAsyncCases_13() { tet_saEvtChannelOpenAsyncCases(13); }

void tet_saEvtChannelOpenAsyncCases_14() { tet_saEvtChannelOpenAsyncCases(14); }

void tet_saEvtChannelOpenAsyncCases_15() { tet_saEvtChannelOpenAsyncCases(15); }

void tet_saEvtChannelOpenAsyncCases_16() { tet_saEvtChannelOpenAsyncCases(16); }

void tet_saEvtChannelOpenAsyncCases_17() { tet_saEvtChannelOpenAsyncCases(17); }

void tet_saEvtChannelOpenAsyncCases_18() { tet_saEvtChannelOpenAsyncCases(18); }

void tet_saEvtChannelCloseCases_01() { tet_saEvtChannelCloseCases(1); }

void tet_saEvtChannelCloseCases_02() { tet_saEvtChannelCloseCases(2); }

void tet_saEvtChannelCloseCases_03() { tet_saEvtChannelCloseCases(3); }

void tet_saEvtChannelCloseCases_04() { tet_saEvtChannelCloseCases(4); }

void tet_saEvtChannelUnlinkCases_01() { tet_saEvtChannelUnlinkCases(1); }

void tet_saEvtChannelUnlinkCases_02() { tet_saEvtChannelUnlinkCases(2); }

void tet_saEvtChannelUnlinkCases_03() { tet_saEvtChannelUnlinkCases(3); }

void tet_saEvtChannelUnlinkCases_04() { tet_saEvtChannelUnlinkCases(4); }

void tet_saEvtChannelUnlinkCases_05() { tet_saEvtChannelUnlinkCases(5); }

void tet_saEvtChannelUnlinkCases_06() { tet_saEvtChannelUnlinkCases(6); }

void tet_saEvtChannelUnlinkCases_07() { tet_saEvtChannelUnlinkCases(7); }

void tet_saEvtChannelUnlinkCases_08() { tet_saEvtChannelUnlinkCases(8); }

void tet_saEvtEventAllocateCases_01() { tet_saEvtEventAllocateCases(1); }

void tet_saEvtEventAllocateCases_02() { tet_saEvtEventAllocateCases(2); }

void tet_saEvtEventAllocateCases_03() { tet_saEvtEventAllocateCases(3); }

void tet_saEvtEventAllocateCases_04() { tet_saEvtEventAllocateCases(4); }

void tet_saEvtEventAllocateCases_05() { tet_saEvtEventAllocateCases(5); }

void tet_saEvtEventAllocateCases_06() { tet_saEvtEventAllocateCases(6); }

void tet_saEvtEventAllocateCases_07() { tet_saEvtEventAllocateCases(7); }

void tet_saEvtEventFreeCases_01() { tet_saEvtEventFreeCases(1); }

void tet_saEvtEventFreeCases_02() { tet_saEvtEventFreeCases(2); }

void tet_saEvtEventFreeCases_03() { tet_saEvtEventFreeCases(3); }

void tet_saEvtEventFreeCases_04() { tet_saEvtEventFreeCases(4); }

void tet_saEvtEventFreeCases_05() { tet_saEvtEventFreeCases(5); }

void tet_saEvtEventFreeCases_06() { tet_saEvtEventFreeCases(6); }
...
void tet_saEvtEventDataGetCases_01() { tet_saEvtEventDataGetCases(1); }

void tet_saEvtEventDataGetCases_02() { tet_saEvtEventDataGetCases(2); }

void tet_saEvtEventDataGetCases_03() { tet_saEvtEventDataGetCases(3); }

void tet_saEvtEventDataGetCases_04() { tet_saEvtEventDataGetCases(4); }

void tet_saEvtEventDataGetCases_05() { tet_saEvtEventDataGetCases(5); }

void tet_saEvtEventDataGetCases_06() { tet_saEvtEventDataGetCases(6); }

void tet_saEvtEventDataGetCases_07() { tet_saEvtEventDataGetCases(7); }

void tet_saEvtEventDataGetCases_08() { tet_saEvtEventDataGetCases(8); }

void tet_saEvtEventDataGetCases_09() { tet_saEvtEventDataGetCases(9); }

void tet_saEvtEventDataGetCases_10() { tet_saEvtEventDataGetCases(10); }

void tet_saEvtEventPublishCases_01() { tet_saEvtEventPublishCases(1); }

void tet_saEvtEventPublishCases_02() { tet_saEvtEventPublishCases(2); }

void tet_saEvtEventPublishCases_03() { tet_saEvtEventPublishCases(3); }

void tet_saEvtEventPublishCases_04() { tet_saEvtEventPublishCases(4); }

void tet_saEvtEventPublishCases_05() { tet_saEvtEventPublishCases(5); }

void tet_saEvtEventPublishCases_06() { tet_saEvtEventPublishCases(6); }

void tet_saEvtEventPublishCases_07() { tet_saEvtEventPublishCases(7); }

void tet_saEvtEventPublishCases_08() { tet_saEvtEventPublishCases(8); }

void tet_saEvtEventPublishCases_09() { tet_saEvtEventPublishCases(9); }

void tet_saEvtEventPublishCases_10() { tet_saEvtEventPublishCases(10); }

void tet_saEvtEventPublishCases_11() { tet_saEvtEventPublishCases(11); }

void tet_saEvtEventPublishCases_12() { tet_saEvtEventPublishCases(12); }

void tet_saEvtEventPublishCases_13() { tet_saEvtEventPublishCases(13); }

void tet_saEvtEventSubscribeCases_01() { tet_saEvtEventSubscribeCases(1); }

void tet_saEvtEventSubscribeCases_02() { tet_saEvtEventSubscribeCases(2); }

void tet_saEvtEventSubscribeCases_03() { tet_saEvtEventSubscribeCases(3); }

void tet_saEvtEventSubscribeCases_04() { tet_saEvtEventSubscribeCases(4); }

void tet_saEvtEventSubscribeCases_05() { tet_saEvtEventSubscribeCases(5); }

void tet_saEvtEventSubscribeCases_06() { tet_saEvtEventSubscribeCases(6); }

void tet_saEvtEventSubscribeCases_07() { tet_saEvtEventSubscribeCases(7); }

void tet_saEvtEventSubscribeCases_08() { tet_saEvtEventSubscribeCases(8); }

void tet_saEvtEventSubscribeCases_09() { tet_saEvtEventSubscribeCases(9); }

void tet_saEvtEventSubscribeCases_10() { tet_saEvtEventSubscribeCases(10); }

void tet_saEvtEventSubscribeCases_11() { tet_saEvtEventSubscribeCases(11); }

void tet_saEvtEventSubscribeCases_12() { tet_saEvtEventSubscribeCases(12); }

void tet_saEvtEventSubscribeCases_13() { tet_saEvtEventSubscribeCases(13); }

void tet_saEvtEventUnsubscribeCases_01() { tet_saEvtEventUnsubscribeCases(1); }

void tet_saEvtEventUnsubscribeCases_02() { tet_saEvtEventUnsubscribeCases(2); }

void tet_saEvtEventUnsubscribeCases_03() { tet_saEvtEventUnsubscribeCases(3); }

void tet_saEvtEventUnsubscribeCases_04() { tet_saEvtEventUnsubscribeCases(4); }

void tet_saEvtEventUnsubscribeCases_05() { tet_saEvtEventUnsubscribeCases(5); }

void tet_saEvtEventUnsubscribeCases_06() { tet_saEvtEventUnsubscribeCases(6); }

void tet_saEvtEventUnsubscribeCases_07() { tet_saEvtEventUnsubscribeCases(7); }

void tet_saEvtEventUnsubscribeCases_08() { tet_saEvtEventUnsubscribeCases(8); }
...
void tet_saEvtLimitGetCases_01() { tet_saEvtLimitGetCases(1); }

void tet_saEvtLimitGetCases_02() { tet_saEvtLimitGetCases(2); }

void tet_saEvtLimitGetCases_03() { tet_saEvtLimitGetCases(3); }

void tet_saEvtLimitGetCases_04() { tet_saEvtLimitGetCases(4); }

void tet_saEvtLimitGetCases_05() { tet_saEvtLimitGetCases(5); }

void tet_saEvtLimitGetCases_06() { tet_saEvtLimitGetCases(6); }

void tet_saEvtLimitGetCases_07() { tet_saEvtLimitGetCases(7); }

void tet_saEvtLimitGetCases_08() { tet_saEvtLimitGetCases(8); }

void tet_saEvtLimitGetCases_09() { tet_saEvtLimitGetCases(9); }
...
struct tet_testlist tet_testlist[] = {
    ...
    {tet_EventSubscribe_PatternMatch_DifferentSubscriptions,
     19}, /*snmp printfs added till here*/
    ...
    {tet_saEvtEventAttributesGetCases_15,
     12}, /*saEvtEventPatternFree cases by EventAlloc*/
