...
void saImmOmAdminOperationContinuationClear_01(void)
{
	...
	test_validate(saImmOmAdminOperationContinuationClear(
			  ownerHandle, &rootObj, continuationId),
		      SA_AIS_ERR_NOT_SUPPORTED);
...
saImmOmAdminOperationContinue_constructor(void)
{
	test_suite_add(7, "Administrative Operations Invocation");
	test_case_add(
	    7, saImmOmAdminOperationContinue_01,
	    "saImmOmAdminOperationContinue - SA_AIS_ERR_NOT_SUPPORTED");
	test_case_add(
	    7, saImmOmAdminOperationContinue_02,
	    "saImmOmAdminOperationContinue_o2 - SA_AIS_ERR_NOT_SUPPORTED");
	test_case_add(
	    7, saImmOmAdminOperationContinueAsync_01,
	    "saImmOmAdminOperationContinueAsync - SA_AIS_ERR_NOT_SUPPORTED");
	test_case_add(
	    7, saImmOmAdminOperationContinuationClear_01,
	    "saImmOmAdminOperationContinuationClear - SA_AIS_ERR_NOT_SUPPORTED");
	test_case_add(
	    7, saImmOmAdminOwnerSet_07,
	    "saImmOmAdminOwnerInvokeAsync_2 - SA_AIS_ERR_INIT, no OM callback provided");
}
