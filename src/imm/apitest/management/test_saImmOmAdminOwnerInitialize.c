...
saImmOmAdminOwnerInitialize_constructor(void)
{
	test_suite_add(5, "Object Administration Ownership");
	test_case_add(5, saImmOmAdminOwnerInitialize_01,
		      "saImmOmAdminOwnerInitialize - SA_AIS_OK");
	test_case_add(5, saImmOmAdminOwnerInitialize_02,
		      "saImmOmAdminOwnerInitialize - SA_AIS_ERR_BAD_HANDLE");
	test_case_add(
	    5, saImmOmAdminOwnerInitialize_03,
	    "saImmOmAdminOwnerInitialize - SA_AIS_ERR_INVALID_PARAM, invalid releaseOwnershipOnFinalize");

	test_case_add(5, saImmOmAdminOwnerSet_01,
		      "saImmOmAdminOwnerSet - SA_AIS_OK");
	test_case_add(5, saImmOmAdminOwnerSet_02,
		      "saImmOmAdminOwnerSet - SA_AIS_ERR_BAD_HANDLE");
	test_case_add(
	    5, saImmOmAdminOwnerSet_03,
	    "saImmOmAdminOwnerSet - SA_AIS_ERR_INVALID_PARAM, Invalid scope");
	test_case_add(
	    5, saImmOmAdminOwnerSet_04,
	    "saImmOmAdminOwnerSet - SA_AIS_ERR_INVALID_PARAM, no object names");
	test_case_add(
	    5, saImmOmAdminOwnerSet_05,
	    "saImmOmAdminOwnerSet - SA_AIS_ERR_NOT_EXIST, no existing object");
	test_case_add(
	    5, saImmOmAdminOwnerSet_06,
	    "saImmOmAdminOwnerSet - SA_AIS_ERR_EXIST, different admin owner already exist");
	test_case_add(5, saImmOmAdminOwnerRelease_01,
		      "saImmOmAdminOwnerRelease - SA_AIS_OK");
	test_case_add(5, saImmOmAdminOwnerRelease_02,
		      "saImmOmAdminOwnerRelease - SA_AIS_ERR_BAD_HANDLE");
	test_case_add(
	    5, saImmOmAdminOwnerRelease_03,
	    "saImmOmAdminOwnerRelease - SA_AIS_ERR_INVALID_PARAM, objectNames is NULL");
	test_case_add(
	    5, saImmOmAdminOwnerRelease_04,
	    "saImmOmAdminOwnerRelease - SA_AIS_ERR_INVALID_PARAM, Invalid scope");
	test_case_add(
	    5, saImmOmAdminOwnerRelease_05,
	    "saImmOmAdminOwnerRelease - SA_AIS_ERR_NOT_EXIST, no existing object");
	test_case_add(5, saImmOmAdminOwnerFinalize_01,
		      "saImmOmAdminOwnerFinalize - SA_AIS_OK");
	test_case_add(5, saImmOmAdminOwnerFinalize_02,
		      "saImmOmAdminOwnerFinalize - SA_AIS_ERR_BAD_HANDLE");
	test_case_add(5, saImmOmAdminOwnerFinalize_03,
		      "ABT: saImmOmAdminOwnerFinalize - SA_AIS_OK");

	test_case_add(5, saImmOmAdminOwnerClear_01,
		      "saImmOmAdminOwnerClear - SA_AIS_OK");
	test_case_add(5, saImmOmAdminOwnerClear_02,
		      "saImmOmAdminOwnerClear - SA_AIS_ERR_BAD_HANDLE");
	test_case_add(5, saImmOmAdminOwnerClear_03,
		      "saImmOmAdminOwnerClear - SA_AIS_ERR_INVALID_PARAM");
	test_case_add(5, saImmOmAdminOwnerClear_04,
		      "saImmOmAdminOwnerClear - SA_AIS_ERR_NOT_EXIST");

	test_case_add(
	    5, saImmOmAdminOwnerInitialize_04,
	    "saImmOmAdminOperationInvoke_o2 - SA_AIS_ERR_VERSION, invalid invocation of A.2.11 API using A.2.1 version");
	test_case_add(
	    5, saImmOmAdminOwnerInitialize_05,
	    "saImmOmAdminOwnerInitialize - SA_AIS_ERR_INVALID_PARAM, empty admin-owner-name");
}
