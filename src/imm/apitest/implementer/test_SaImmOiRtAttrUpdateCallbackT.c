...
static SaNameT testObjectName = {.value = "safComp=MyConfigHandler1",
...
static void setup(SaImmAdminOwnerNameT admoName)
{
	...
	SaImmAttrDefinitionT_2 d1 = {"safComp", SA_IMM_ATTR_SANAMET,
				     SA_IMM_ATTR_CONFIG | SA_IMM_ATTR_RDN |
					 SA_IMM_ATTR_INITIALIZED,
				     NULL};

	SaImmAttrDefinitionT_2 d2 = {"saAmfCompRestartCount",
				     SA_IMM_ATTR_SAINT32T, SA_IMM_ATTR_RUNTIME,
				     NULL};
	...
	*/
	...
	SaImmAttrValuesT_2 v1 = {"safComp", SA_IMM_ATTR_SANAMET, 1,
				 (void **)nameValues};
...
void SaImmOiRtAttrUpdateCallbackT_01(void)
{
	...
	TRACE_ENTER();
	setup(admoName);
	immOiCallbacks.saImmOiRtAttrUpdateCallback =
