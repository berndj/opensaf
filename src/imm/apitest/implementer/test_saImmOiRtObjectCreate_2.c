...
static SaImmAttrValuesT_2 v1 = {"saLogStreamFixedLogRecordSize",
				SA_IMM_ATTR_SAUINT32T, 1, (void **)int1Values};
static SaImmAttrValuesT_2 v2 = {"safLgStr", SA_IMM_ATTR_SASTRINGT, 1,
				(void **)nameValues};
static SaImmAttrValuesT_2 v3 = {"saLogStreamFileName", SA_IMM_ATTR_SASTRINGT, 1,
				(void **)strValues};
static SaImmAttrValuesT_2 v4 = {"saLogStreamPathName", SA_IMM_ATTR_SASTRINGT, 1,
				(void **)strValues2};
static SaImmAttrValuesT_2 v5 = {"saLogStreamMaxLogFileSize",
				SA_IMM_ATTR_SAUINT64T, 1, (void **)lint1Values};
static SaImmAttrValuesT_2 v6 = {"saLogStreamLogFullAction",
				SA_IMM_ATTR_SAUINT32T, 1, (void **)int1Values};
static SaImmAttrValuesT_2 v7 = {"saLogStreamHaProperty", SA_IMM_ATTR_SAUINT32T,
				1, (void **)int1Values};
static SaImmAttrValuesT_2 v8 = {"saLogStreamMaxFilesRotated",
				SA_IMM_ATTR_SAUINT32T, 1, (void **)int1Values};
static SaImmAttrValuesT_2 v9 = {"saLogStreamLogFileFormat",
				SA_IMM_ATTR_SASTRINGT, 1, (void **)strValues};
static SaImmAttrValuesT_2 v10 = {"saLogStreamSeverityFilter",
				 SA_IMM_ATTR_SAUINT32T, 1, (void **)int1Values};
...
void saImmOiRtObjectCreate_2_06(void)
{
	...
	const SaImmOiImplementerNameT implementerName =
	    (SaImmOiImplementerNameT) __FUNCTION__;
	const SaImmOiImplementerNameT implementerName2 =
...
saImmOiRtObjectCreate_2_constructor(void)
{
	...
	test_case_add(3, saImmOiRtObjectCreate_2_01,
		      "saImmOiRtObjectCreate_2 - SA_AIS_OK");
	test_case_add(
	    3, saImmOiRtObjectCreate_2_03,
	    "saImmOiRtObjectCreate_2 - SA_AIS_ERR_BAD_HANDLE - invalid handle");
	test_case_add(
	    3, saImmOiRtObjectCreate_2_04,
	    "saImmOiRtObjectCreate_2 - SA_AIS_ERR_BAD_OPERATION - immOiHandle not associated with implementer name");
	test_case_add(
	    3, saImmOiRtObjectCreate_2_05,
	    "saImmOiRtObjectCreate_2 - SA_AIS_ERR_NOT_EXIST - className non existing");
	test_case_add(
	    3, saImmOiRtObjectCreate_2_06,
	    "saImmOiRtObjectCreate_2 - SA_AIS_ERR_EXIST - object already created");

	test_case_add(
	    3, saImmOiRtObjectCreate_2_07,
	    "saImmOiRtObjectCreate_2 - SA_AIS_ERR_NAME_TOO_LONG - size of dn for new object too big. Not valid test with extended names");

	test_case_add(3, saImmOiRtObjectDelete_01,
		      "saImmOiRtObjectDelete - SA_AIS_OK");
	test_case_add(
	    3, saImmOiRtObjectDelete_03,
	    "saImmOiRtObjectDelete - SA_AIS_ERR_BAD_HANDLE - invalid handle");
	test_case_add(
	    3, saImmOiRtObjectDelete_04,
	    "saImmOiRtObjectDelete - SA_AIS_ERR_BAD_OPERATION - immOiHandle not associated with implementer name");
	test_case_add(
	    3, saImmOiRtObjectDelete_05,
	    "saImmOiRtObjectDelete - SA_AIS_ERR_INVALID_PARAM - non existing object");
	test_case_add(
	    3, saImmOiRtObjectDelete_06,
	    "saImmOiRtObjectDelete - SA_AIS_ERR_BAD_OPERATION - delete configuration object");

	test_case_add(3, saImmOiRtObjectUpdate_2_01,
		      "saImmOiRtObjectUpdate_2 - SA_AIS_OK");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_02,
	    "saImmOiRtObjectUpdate_2 - SA_AIS_ERR_BAD_HANDLE - invalid handle");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_03,
	    "saImmOiRtObjectUpdate_2 - SA_AIS_ERR_BAD_OPERATION - immOiHandle not associated with implementer name");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_04,
	    "saImmOiRtObjectUpdate_2 - SA_AIS_ERR_BAD_OPERATION - update object not owned by implementer");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_05,
	    "saImmOiRtObjectUpdate_2 - SA_AIS_ERR_INVALID_PARAM - new value for the RDN attr");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_06,
	    "saImmOiRtObjectUpdate_2 - SA_AIS_ERR_INVALID_PARAM - update configuration attribute");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_07,
	    "saImmOiRtObjectUpdate_2 - STRONG_DEFAULT, Set value of runtime attribute to NULL");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_08,
	    "saImmOiRtObjectUpdate_2 - STRONG_DEFAULT, Set value of multi-valued runtime attribute to NULL");
	test_case_add(
	    3, saImmOiRtObjectUpdate_2_09,
	    "saImmOiRtObjectUpdate_2 - STRONG_DEFAULT, Delete all values of multi-valued runtime attribute");
