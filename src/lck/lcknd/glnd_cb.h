...
GLND_RESOURCE_REQ_LIST *glnd_resource_req_node_add(
    GLND_CB *glnd_cb, struct glsv_evt_rsc_info_tag *rsc_info,
...
/* Queue Prototypes */
void glnd_evt_backup_queue_add(GLND_CB *glnd_cb,
                               struct glsv_glnd_evt *glnd_evt);
