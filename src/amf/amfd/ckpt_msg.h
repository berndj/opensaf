 ...
 */
#ifndef AMF_AMFD_CKPT_MSG_H_
#define AMF_AMFD_CKPT_MSG_H_
...
#define m_AVSV_SEND_CKPT_UPDT_ASYNC(cb, act, r_hdl, r_type)          \
  avsv_send_ckpt_data(cb, act, NCS_PTR_TO_UNS64_CAST(r_hdl), r_type, \
...
#define m_AVSV_SEND_CKPT_UPDT_SYNC(cb, act, r_hdl)                             \
  avsv_send_ckpt_data(cb, act, NCS_PTR_TO_UNS64_CAST(r_hdl), AVSV_SYNC_COMMIT, \
                      NCS_MBCSV_SND_SYNC)

#endif  // AMF_AMFD_CKPT_MSG_H_
