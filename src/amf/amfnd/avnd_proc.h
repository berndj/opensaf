 ...
 */
#ifndef AMF_AMFND_AVND_PROC_H_
#define AMF_AMFND_AVND_PROC_H_
...
uint32_t avnd_evt_avd_info_su_si_assign_evh(struct avnd_cb_tag *,
                                            struct avnd_evt_tag *);
uint32_t avnd_evt_avd_pg_track_act_rsp_evh(struct avnd_cb_tag *,
                                           struct avnd_evt_tag *);
uint32_t avnd_evt_avd_pg_upd_evh(struct avnd_cb_tag *, struct avnd_evt_tag *);
uint32_t avnd_evt_avd_operation_request_evh(struct avnd_cb_tag *,
                                            struct avnd_evt_tag *);
uint32_t avnd_evt_avd_su_pres_evh(struct avnd_cb_tag *, struct avnd_evt_tag *);
uint32_t avnd_evt_avd_oper_state_resp_msg(struct avnd_cb_tag *,
                                          struct avnd_evt_tag *);
uint32_t avnd_evt_avd_comp_validation_resp_evh(struct avnd_cb_tag *,
                                               struct avnd_evt_tag *);
uint32_t avnd_evt_avd_role_change_evh(struct avnd_cb_tag *,
                                      struct avnd_evt_tag *);
...
uint32_t avnd_evt_ava_comp_unreg_evh(struct avnd_cb_tag *,
                                     struct avnd_evt_tag *);
...
uint32_t avnd_evt_ava_hc_confirm_evh(struct avnd_cb_tag *,
                                     struct avnd_evt_tag *);
uint32_t avnd_evt_ava_csi_quiescing_compl_evh(struct avnd_cb_tag *,
                                              struct avnd_evt_tag *);
...
uint32_t avnd_evt_ava_err_clear_evh(struct avnd_cb_tag *,
                                    struct avnd_evt_tag *);
...
uint32_t avnd_evt_cla_node_async_get(struct avnd_cb_tag *,
                                     struct avnd_evt_tag *);
...
uint32_t avnd_evt_tmr_rcv_msg_rsp_evh(struct avnd_cb_tag *,
                                      struct avnd_evt_tag *);
uint32_t avnd_evt_tmr_clc_comp_reg_evh(struct avnd_cb_tag *,
                                       struct avnd_evt_tag *);
uint32_t avnd_evt_tmr_su_err_esc_evh(struct avnd_cb_tag *,
                                     struct avnd_evt_tag *);
uint32_t avnd_evt_tmr_node_err_esc_evh(struct avnd_cb_tag *,
                                       struct avnd_evt_tag *);
uint32_t avnd_evt_tmr_clc_pxied_comp_inst_evh(struct avnd_cb_tag *,
                                              struct avnd_evt_tag *);
uint32_t avnd_evt_tmr_clc_pxied_comp_reg_evh(struct avnd_cb_tag *,
                                             struct avnd_evt_tag *);
uint32_t avnd_evt_tmr_qscing_cmpl_evh(struct avnd_cb_tag *,
                                      struct avnd_evt_tag *);
...
uint32_t avnd_evt_comp_pres_fsm_evh(struct avnd_cb_tag *,
                                    struct avnd_evt_tag *);
...
uint32_t avnd_evt_avd_clm_node_on_fover(struct avnd_cb_tag *cb,
                                        struct avnd_evt_tag *evt);

uint32_t avnd_evt_last_step_term_evh(struct avnd_cb_tag *,
                                     struct avnd_evt_tag *);
...
uint32_t avnd_evt_ha_state_change_evh(struct avnd_cb_tag *,
                                      struct avnd_evt_tag *);
uint32_t avnd_evt_comp_admin_op_req(struct avnd_cb_tag *,
                                    struct avnd_evt_tag *);
uint32_t avnd_evt_avd_admin_op_req_evh(struct avnd_cb_tag *cb,
                                       struct avnd_evt_tag *evt);
