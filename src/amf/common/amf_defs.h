 ...
 */
#ifndef AMF_COMMON_AMF_DEFS_H_
#define AMF_COMMON_AMF_DEFS_H_
...
/* This enums represent classes defined in AMF Spec B.04.01, sorted from figure
 * 28 ch 8.5 */
typedef enum {
