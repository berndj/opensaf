			   ...
			   EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avsv_edp_cbq_info_rules[] = {
	    {EDU_START, avsv_edp_cbq_info, 0, 0, 0, sizeof(AVSV_AMF_CBK_INFO),
	     0, NULL},
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
	     (long)&((AVSV_AMF_CBK_INFO *)0)->param.comp_term.comp_name, 0,
	     NULL},
	    ...
	    {EDU_EXEC, m_NCS_EDP_SAAMFCSIFLAGST, 0, 0, 0,
	     (long)&((AVSV_AMF_CBK_INFO *)0)->param.csi_set.csi_desc.csiFlags,
	     0, NULL},
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_CBK_INFO *)0)->param.csi_set.csi_desc.csiName, 0,
	     NULL},
	    ...
	    {EDU_EXEC, m_NCS_EDP_SAAMFCSITRANSITIONDESCRIPTORT, 0, 0, 0,
	     (long)&((AVSV_AMF_CBK_INFO *)0)
		 ->param.csi_set.csi_desc.csiStateDescriptor.activeDescriptor
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_CBK_INFO *)0)
		 ->param.csi_set.csi_desc.csiStateDescriptor.standbyDescriptor
		 .activeCompName,
	     0, NULL},
	    ...
	    {EDU_EXEC, avsv_edp_saamfprotectiongroupnotificationbuffert, 0, 0,
	     EDU_EXIT, (long)&((AVSV_AMF_CBK_INFO *)0)->param.pg_track.buf, 0,
	     NULL},

	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
	     (long)&((AVSV_AMF_CBK_INFO *)0)->param.pxied_comp_inst.comp_name,
	     0, NULL},

	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
	     (long)&((AVSV_AMF_CBK_INFO *)0)->param.pxied_comp_clean.comp_name,
	     0, NULL},
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avsv_edp_cbq_info_rules,
...
*****************************************************************************/
uint32_t avsv_edp_api_resp_info(EDU_HDL *hdl, EDU_TKN *edu_tkn, NCSCONTEXT ptr,
				uint32_t *ptr_data_len, EDU_BUF_ENV *buf_env,
				EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uint32_t rc = NCSCC_RC_SUCCESS;
	...
	EDU_INST_SET avsv_api_resp_info_rules[] = {
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_RESP_INFO *)0)->param.ha_get.comp_name, 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_RESP_INFO *)0)->param.ha_get.csi_name, 0,
	     NULL},
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avsv_api_resp_info_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
...
*****************************************************************************/
uint32_t avsv_edp_api_info(EDU_HDL *hdl, EDU_TKN *edu_tkn, NCSCONTEXT ptr,
			   uint32_t *ptr_data_len, EDU_BUF_ENV *buf_env,
			   EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uint32_t rc = NCSCC_RC_SUCCESS;
	...
	EDU_INST_SET avsv_edp_api_info_rules[] = {
	    {EDU_START, avsv_edp_api_info, 0, 0, 0, sizeof(AVSV_AMF_API_INFO),
	     0, NULL},
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.finalize.comp_name, 0,
	     NULL},
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.hc_start.comp_name, 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.hc_start.proxy_comp_name, 0,
	     NULL},
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.hc_stop.proxy_comp_name, 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_saamfhealthcheckkeyt, 0, 0, EDU_EXIT,
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.hc_confirm.comp_name, 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.hc_confirm.proxy_comp_name,
	     0, NULL},
	    {EDU_EXEC, ncs_edp_saamfhealthcheckkeyt, 0, 0, 0,
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.csiq_compl.comp_name, 0,
	     NULL},
	    ...
	    {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.err_rep.detect_time, 0,
	     NULL},
	    {EDU_EXEC, m_NCS_EDP_SAAMFRECOMMENDEDRECOVERYT, 0, 0, EDU_EXIT,
	    ...
	    {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
	     (long)&((AVSV_AMF_API_INFO *)0)->param.err_clear.comp_name, 0,
	     NULL},
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avsv_edp_api_info_rules,
				 struct_ptr, ptr_data_len, buf_env, op, o_err);
	return rc;
}
			  ...
			  EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avsv_nda_msg_rules[] = {
	    {EDU_START, avsv_edp_nda_msg, 0, 0, 0, sizeof(AVSV_NDA_AVA_MSG), 0,
	     NULL},
	    {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
...
{
	enum { LCL_JMP_OFFSET_AVSV_N2A_API_INFO = 1,
...
{
	enum { LCL_JMP_OFFSET_AVSV_N2A_HC_CBQ_INFO = 1,
...
{
	enum { LCL_JMP_OFFSET_AVSV_N2A_HA_GET_API_RESP_INFO = 1,
...
{
	enum { LCL_JMP_OFFSET_AVSV_N2A_FINALIZE_API_INFO = 1,
...
{
	enum { LCL_JMP_OFFSET_AVSV_HA_STATE_ACTIVE = 1,
