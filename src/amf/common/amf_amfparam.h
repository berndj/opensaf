...
#ifndef AMF_COMMON_AMF_AMFPARAM_H_
#define AMF_COMMON_AMF_AMFPARAM_H_
...
/* initialize - not reqd */
typedef struct avsv_amf_init_param_tag { void *dummy; } AVSV_AMF_INIT_PARAM;
...
#endif  // AMF_COMMON_AMF_AMFPARAM_H_
