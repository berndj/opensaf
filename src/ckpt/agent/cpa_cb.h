...
#ifndef CKPT_AGENT_CPA_CB_H_
#define CKPT_AGENT_CPA_CB_H_
...
#define m_CPA_RETRIEVE_CB(cb)                                      \
  {                                                                \
    ...
    if (!cb) LOG_ER("CPND CB TAKE HDL FAILED ");                   \
  }
...
#define CPA_WRT_CPND_SUBPART_VER_RANGE \
  (CPA_WRT_CPND_SUBPART_VER_MAX - CPA_WRT_CPND_SUBPART_VER_MIN + 1)
...
#define CPA_WRT_CPD_SUBPART_VER_RANGE \
  (CPA_WRT_CPD_SUBPART_VER_MAX - CPA_WRT_CPD_SUBPART_VER_MIN + 1)
