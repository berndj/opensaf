...
#ifndef MDS_APITEST_MDSTIPC_H_
#define MDS_APITEST_MDSTIPC_H_
...
uint32_t mds_service_install(MDS_HDL, MDS_SVC_ID, MDS_SVC_PVT_SUB_PART_VER,
                             NCSMDS_SCOPE_TYPE, bool, bool);
uint32_t mds_service_subscribe(MDS_HDL, MDS_SVC_ID, NCSMDS_SCOPE_TYPE, uint8_t,
                               MDS_SVC_ID *);
uint32_t mds_service_redundant_subscribe(MDS_HDL, MDS_SVC_ID, NCSMDS_SCOPE_TYPE,
                                         uint8_t, MDS_SVC_ID *);
...
uint32_t mds_send_message(MDS_HDL, MDS_SVC_ID, NCSCONTEXT, MDS_SVC_ID,
                          MDS_SEND_PRIORITY_TYPE, MDS_SENDTYPES, MDS_DEST,
                          uint32_t, MDS_DIRECT_BUFF, uint16_t,
...
uint32_t mds_direct_send_message(MDS_HDL, MDS_SVC_ID, MDS_SVC_ID,
                                 ...
                                 MDS_DEST, int64_t, MDS_SEND_PRIORITY_TYPE,
                                 char *);
