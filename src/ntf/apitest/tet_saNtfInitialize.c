...
__attribute__((constructor)) static void saNtfInitialize_constructor(void)
{
	...
	test_case_add(1, saNtfInitialize_02,
		      "saNtfInitialize with NULL pointer to handle");
	test_case_add(1, saNtfInitialize_03,
		      "saNtfInitialize with NULL pointer to callbacks");
	test_case_add(1, saNtfInitialize_04,
		      "saNtfInitialize with NULL callbacks AND version");
	test_case_add(1, saNtfInitialize_05,
		      "saNtfInitialize with uninitialized handle");
	test_case_add(1, saNtfInitialize_06,
		      "saNtfInitialize with uninitialized version");
	test_case_add(1, saNtfInitialize_07,
		      "saNtfInitialize with too high release level");
	test_case_add(1, saNtfInitialize_08,
		      "saNtfInitialize with minor version set too high");
	test_case_add(1, saNtfInitialize_09,
		      "saNtfInitialize with major version set too high");
	test_case_add(1, saNtfInitialize_10,
		      "saNtfInitialize with minor version set to lower");
	test_case_add(1, saNtfInitialize_11,
