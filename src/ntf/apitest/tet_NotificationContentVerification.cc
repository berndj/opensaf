...
static void saNtfNotificationCallbackT(SaNtfSubscriptionIdT subscriptionId,
  ...
  case SA_NTF_TYPE_OBJECT_CREATE_DELETE:
    ...
    if (myNotificationFilterHandles
      ...
      errors += verifyObjectCreateDeleteNotification(
          &myObjCrDelNotfification,
  ...
  case SA_NTF_TYPE_ATTRIBUTE_CHANGE:
    ...
    if (myNotificationFilterHandles.attributeChangeFilterHandle ==
      ...
      errors += verifyAttributeChangeNotification(
  ...
  case SA_NTF_TYPE_STATE_CHANGE:
    ...
    if (myNotificationFilterHandles.stateChangeFilterHandle == 0)
      ...
      errors += verifyStateChangeNotification(
  ...
  case SA_NTF_TYPE_ALARM:
    ...
    if (myNotificationFilterHandles.alarmFilterHandle == 0)
      ...
      errors += verifyAlarmNotification(
          &myAlarmNotification,
  ...
  case SA_NTF_TYPE_SECURITY_ALARM:
    ...
    if (myNotificationFilterHandles.securityAlarmFilterHandle == 0)
      ...
      errors += verifySecurityAlarmNotification(
...
void alarmNotificationTest2(void) {
  ...
  *(myAlarmNotification.probableCause) = SA_NTF_BANDWIDTH_REDUCED;
  ...
  myAlarmNotification.monitoredAttributes[0].attributeType =
      SA_NTF_VALUE_INT64;
  myAlarmNotification.monitoredAttributes[0].attributeValue.int64Val =
      987654321;

  myAlarmNotification.monitoredAttributes[1].attributeId = 2;
  myAlarmNotification.monitoredAttributes[1].attributeType =
      SA_NTF_VALUE_INT8;
  ...
  myAlarmNotification.proposedRepairActions[1].actionValueType =
      SA_NTF_VALUE_INT32;
  ...
  for (i = 0; i < myAlarmNotification.numSpecificProblems; i++) {
    ...
    myAlarmNotification.specificProblems[i].problemClassId.majorId =
        1;
    myAlarmNotification.specificProblems[i].problemClassId.minorId =
        2;
    myAlarmNotification.specificProblems[i]
        .problemClassId.vendorId = 33;
    myAlarmNotification.specificProblems[i].problemType =
        SA_NTF_VALUE_UINT32;
    myAlarmNotification.specificProblems[i].problemValue.uint32Val =
        (SaUint32T)(600 + i);
  }

  for (i = 0; i < myAlarmNotification.numProposedRepairActions; i++) {
    myAlarmNotification.proposedRepairActions[i].actionId = i;
    myAlarmNotification.proposedRepairActions[i].actionValueType =
        SA_NTF_VALUE_UINT32;
    myAlarmNotification.proposedRepairActions[i]
        .actionValue.uint32Val = (SaUint32T)(700 + i);
  }
  *myAlarmNotification.trend = SA_NTF_TREND_MORE_SEVERE;
  myAlarmNotification.thresholdInformation->thresholdValueType =
      SA_NTF_VALUE_UINT32;
  ...
  myAlarmNotification.notificationHeader.correlatedNotifications[0] =
      1999;
  myAlarmNotification.notificationHeader.correlatedNotifications[1] =
      1984;
...
void objectCreateDeleteNotificationTest(void) {
  ...
  if ((rc = saNtfObjectCreateDeleteNotificationFilterAllocate(
    ...
    createObjectCreateDeleteNotification(ntfHandle,
                 &myObjCrDelNotfification);
    safassert(NtfTest::saNtfNotificationSend(
        myObjCrDelNotfification.notificationHandle), SA_AIS_OK);

    /* Delay to let the notification slip through */
    poll_until_received(
        ntfHandle,
        *myObjCrDelNotfification.notificationHeader.notificationId);
    ...
    safassert(saNtfNotificationFree(
            myObjCrDelNotfification.notificationHandle),
        SA_AIS_OK);
...
notificationContentVerification_constructor(void) {
  ...
  test_case_add(30, objectCreateDeleteNotificationTest,
          "ObjectCreateDeleteNotification");
  test_case_add(30, attributeChangeNotificationTest,
          "AttributeChangeNotification");
  test_case_add(30, stateChangeNotificationTest,
          "StateChangeNotification");
  test_case_add(30, securityAlarmNotificationTest,
          "SecurityAlarmNotification");
  test_case_add(30, miscellaneousNotificationTest,
          "MiscellaneousNotification, Not supported");
