...
void headerTest(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
            ntfHandle, &myAlarmFilter, 1, 1, 1, 1, 0, 0, 0), SA_AIS_OK);
  ...
  safassert(saNtfAlarmNotificationAllocate(
          ...
          0, SA_NTF_ALLOC_SYSTEM_LIMIT), SA_AIS_OK);
...
void headerTest2(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 2, 0, 0, 0, 0, 0, 0), SA_AIS_OK);
...
void headerTest3(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 2, 0, 0, 0, 0, 0), SA_AIS_OK);
...
void headerTest4(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 0, 2, 0, 0, 0, 0), SA_AIS_OK);
  /* only these su objects should be received */
...
void headerTest5(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 0, 0, 2, 0, 0, 0), SA_AIS_OK);
...
void alarmNotificationFilterTest(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 0, 0, 0, 1, 1, 1), SA_AIS_OK);
...
void alarmNotificationFilterTest2(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 0, 0, 0, 3, 0, 0), SA_AIS_OK);
  /* Set perceived severities */
  myAlarmFilter.probableCauses[0] = SA_NTF_BANDWIDTH_REDUCED;
...
void alarmNotificationFilterTest3(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 0, 0, 0, 0, 2, 0), SA_AIS_OK);
  /* Set perceived severities */
...
void alarmNotificationFilterTest4(void) {
  ...
  safassert(saNtfAlarmNotificationFilterAllocate(
          ntfHandle, &myAlarmFilter, 0, 0, 0, 0, 0, 0, 2), SA_AIS_OK);
  /* Set perceived severities */
  myAlarmFilter.trends[0] = SA_NTF_TREND_MORE_SEVERE;
...
void combinedNotificationFilterTest(void) {
  ...
  if ((rc = saNtfAlarmNotificationFilterAllocate(
     ntfHandle, &myAlarmFilter, 1, 1, 1, 1, 1, 1, 1)) == SA_AIS_OK) {
    fillFilterHeader(&myAlarmFilter.notificationFilterHeader);
    myAlarmFilter.perceivedSeverities[0] = SA_NTF_SEVERITY_WARNING;
    myAlarmFilter.probableCauses[0] = SA_NTF_BANDWIDTH_REDUCED;
    myAlarmFilter.trends[0] = SA_NTF_TREND_MORE_SEVERE;
    ...
    if ((rc = saNtfObjectCreateDeleteNotificationFilterAllocate(
       ntfHandle, &myObjCrDeFilter, 1, 1, 1, 1, 1)) == SA_AIS_OK) {
      ...
      if ((rc =
        ...
        if ((rc =
          ...
          safassert(saNtfNotificationFilterFree(
            mySecAlarmFilter.notificationFilterHandle), SA_AIS_OK);
        }
        safassert(saNtfNotificationFilterFree(
                myAttrChangeFilter.notificationFilterHandle), SA_AIS_OK);
      }
      safassert(saNtfNotificationFilterFree(
              myObjCrDeFilter.notificationFilterHandle), SA_AIS_OK);
    }
    safassert(saNtfNotificationFilterFree(
