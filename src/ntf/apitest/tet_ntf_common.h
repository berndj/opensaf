...
extern int cmpSaNtfValueT(const SaNtfValueTypeT type, const SaNtfValueT *val1,
...
SaAisErrorT ntftest_saNtfNotificationReadNext(
...
SaAisErrorT ntftest_saNtfPtrValAllocate(
    SaNtfNotificationHandleT notificationHandle, SaUint16T dataSize,
    void **dataPtr, SaNtfValueT *value);
