...
function #      is defined as tet_mbcsv_startup(), as well as the tet_cleanup
function is defined #      as tet_mbcsv_end(). #  2.  If "tetware-patch" is not
used, change the name of test case array from api_test[] #      to
...
parts of mbcstm_startup() function, which #      invoke the functions in the
...
void tet_mbcsv_initialize_01() { tet_mbcsv_initialize(1); }

void tet_mbcsv_initialize_02() { tet_mbcsv_initialize(2); }

void tet_mbcsv_initialize_03() { tet_mbcsv_initialize(3); }

void tet_mbcsv_initialize_04() { tet_mbcsv_initialize(4); }

void tet_mbcsv_initialize_06() { tet_mbcsv_initialize(6); }

void tet_mbcsv_initialize_07() { tet_mbcsv_initialize(7); }

void tet_mbcsv_initialize_08() { tet_mbcsv_initialize(8); }

void tet_mbcsv_open_close_01() { tet_mbcsv_open_close(1); }

void tet_mbcsv_open_close_02() { tet_mbcsv_open_close(2); }

void tet_mbcsv_open_close_03() { tet_mbcsv_open_close(3); }

void tet_mbcsv_open_close_04() { tet_mbcsv_open_close(4); }

void tet_mbcsv_open_close_05() { tet_mbcsv_open_close(5); }

void tet_mbcsv_open_close_06() { tet_mbcsv_open_close(6); }

void tet_mbcsv_change_role_01() { tet_mbcsv_change_role(1); }

void tet_mbcsv_change_role_02() { tet_mbcsv_change_role(2); }

void tet_mbcsv_change_role_03() { tet_mbcsv_change_role(3); }

void tet_mbcsv_change_role_04() { tet_mbcsv_change_role(4); }

void tet_mbcsv_change_role_05() { tet_mbcsv_change_role(5); }

void tet_mbcsv_change_role_06() { tet_mbcsv_change_role(6); }

void tet_mbcsv_change_role_07() { tet_mbcsv_change_role(7); }

void tet_mbcsv_change_role_08() { tet_mbcsv_change_role(8); }

void tet_mbcsv_change_role_09() { tet_mbcsv_change_role(9); }

void tet_mbcsv_change_role_10() { tet_mbcsv_change_role(10); }

void tet_mbcsv_change_role_11() { tet_mbcsv_change_role(11); }

void tet_mbcsv_change_role_12() { tet_mbcsv_change_role(12); }

void tet_mbcsv_op_01() { tet_mbcsv_op(1); }

void tet_mbcsv_op_02() { tet_mbcsv_op(2); }

void tet_mbcsv_op_03() { tet_mbcsv_op(3); }
...
void tet_mbcsv_cleanup() { tet_infoline(" Ending the agony.. "); }
