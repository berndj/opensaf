...
typedef enum ncs_service_id
{
  ...
  NCS_SERVICE_ID_OSPRIMS,
  NCS_SERVICE_ID_SAR_DRIVERS,
  NCS_SERVICE_ID_SOCKET,
  NCS_SERVICE_ID_L2SOCKET,
  NCS_SERVICE_ID_APPLICATION,
  NCS_SERVICE_ID_TIMER,
  NCS_SERVICE_ID_CLI,
  NCS_SERVICE_ID_INTF,
  NCS_SERVICE_ID_TDS, /* Topology Discovery Service */
  NCS_SERVICE_ID_DTSV,
  NCS_SERVICE_ID_IFSV,
  NCS_SERVICE_ID_IFD,
  NCS_SERVICE_ID_IFND,
  ...
  UD_SERVICE_ID_STUB1,
  UD_SERVICE_ID_STUB2,
  NCS_SERVICE_ID_SWITCH_NODE_DIR,
  NCS_SERVICE_ID_LHCSC,
  NCS_SERVICE_ID_LHCSMM,
  NCS_SERVICE_ID_LHCPAY,
  NCS_SERVICE_ID_VDS,
  NCS_SERVICE_ID_HPM_NODE_DIR,
  NCS_SERVICE_ID_RDE,
  NCS_SERVICE_ID_POWERCODE, /* Must be last one before 'MAX' */
  ...
  NCS_SERVICE_ID_PROXY,
  NCS_SERVICE_ID_UNKNOWN,
