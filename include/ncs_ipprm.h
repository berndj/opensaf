...
extern uns32 ip_svc_mcrs_open(struct ncs_socket_entry_tag*    se,
                              NCS_IPV4_ADDR        muticast_addr);

#define m_IP_SVC_MCRS_CLOSE(se,maddr) ip_svc_mcrs_close(se,maddr)
extern uns32 ip_svc_mcrs_close(struct ncs_socket_entry_tag*    se,
                               NCS_IPV4_ADDR muticast_addr);
...
typedef uns32 (*NCS_SOCKET_HANDLER) (struct ncs_socket_entry_tag    *se,
                                    NCSCONTEXT                      arg);
