...
$Header: /ncs/software/leap/base/common/inc/ncs_ipv6.h
..............................................................................
...
EXTERN_C NCS_BOOL ncs_is_ipv6_addr_all_zero(NCS_IPV6_ADDR *addr);
...
EXTERN_C NCS_BOOL ncs_is_valid_ipv6_uc(NCS_IPV6_ADDR *addr, uns8 bits);
#define m_NCS_IS_VALID_IPV6_UC(addr, bits) ncs_is_valid_ipv6_uc(addr, bits)


EXTERN_C void ncs_mask_prefix_addr(NCS_IPV6_ADDR *addr,uns32 pfxlen,
...
EXTERN_C void ncs_str_to_ipv6addr(NCS_IPV6_ADDR *o_v6addr, int8* i_str);
#define m_NCS_STR_TO_IPV6_ADDR(o_v6addr, i_str) \
        ncs_str_to_ipv6addr(o_v6addr, i_str)


EXTERN_C void ncs_str_to_ipv6pfx(NCS_IPV6_ADDR *o_v6addr, uns32 *o_pfx_len, 
                                int8* str);
#define m_NCS_STR_TO_IPV6_PREFIX(o_v6addr, o_pfx_len, i_str) \
        ncs_str_to_ipv6pfx(o_v6addr, o_pfx_len, i_str)


EXTERN_C void ncs_ipv6_str_from_ipv6addr(NCS_IPV6_ADDR *i_v6addr, int8 *o_str);
#define m_NCS_IPV6ADDR_TO_STR(i_v6addr, o_str) \
        ncs_ipv6_str_from_ipv6addr(i_v6addr, o_str)


EXTERN_C NCS_BOOL ncs_is_ipv6_linkloc_addr (NCS_IPV6_ADDR *v6addr_ptr);

EXTERN_C NCS_BOOL ncs_is_ipv6_6to4_addr (NCS_IPV6_ADDR *v6addr_ptr);
