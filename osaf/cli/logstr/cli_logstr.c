...
const NCSFL_STR cli_hdln_set[] = {
	...
	{NCSCLI_HDLN_CLI_DLIB_SYM_FAILED,
	 "CLI cli_apps_cefs_load(): m_NCS_OS_DLIB_SYMBOL() failed (lib name, func name, error)"},
	...
	{NCSCLI_HDLN_CLI_CONF_FILE_CORRUPTED,
	 "CLI cli_apps_cefs_load(): CLI CEFs configuration file corrupted (filename, read_args):"},
