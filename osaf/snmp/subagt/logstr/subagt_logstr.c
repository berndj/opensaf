...
const NCSFL_STR subagt_log_hdln_str[] = {
	...
	{SNMPSUBAGT_AGT_RESTART_THRSLD_CROSSED,
	 "SNMP Agent restart crossed the threshold. Recommending the AMF Framework for a switchover"},
...
const NCSFL_STR subagt_log_errors_str[] = {
	...
	{SNMPSUBAGT_TIME_TO_WAIT_DISCREPANCY,
	 "NCS SSA: snmp_select_info() returned more time to block than ping interval."},
	{0, 0}
};
...
const NCSFL_STR subagt_log_error_strs_str[] = {
	...
	{SNMPSUBAGT_AGT_MONITOR_RSTRT_SCP_PERMISSIONS,
	 "motAgentRestartScript  does not have executable permissions -- "},
	{0, 0}
};
 ...
 * Notes         : None.
 *****************************************************************************/
uns32 subagt_log_str_lib_req(NCS_LIB_REQ_INFO *req_info)
{
 ...
 *  Note:
 ******************************************************************************/
uns32 snmpsubagt_canned_str_reg(NCS_SERVICE_ID i_svc_id)
{
 ...
 *  Note:
 ******************************************************************************/
uns32 snmpsubagt_canned_str_dereg(NCS_SERVICE_ID i_svc_id)
{
	uns32 status = NCSCC_RC_FAILURE;
	NCS_DTSV_REG_CANNED_STR canned_str;
