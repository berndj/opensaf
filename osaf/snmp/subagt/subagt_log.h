...
* Logging Routines 
******************************************************************/
EXTERN_C uns32 snmpsubagt_dla_initialize(NCS_SERVICE_ID i_svc_id);

EXTERN_C uns32 snmpsubagt_dla_finalize(NCS_SERVICE_ID i_svc_id);

EXTERN_C void snmpsubagt_log_headline(uns8);

EXTERN_C void snmpsubagt_log_mem(uns8);

EXTERN_C void snmpsubagt_log_errors(uns8, uns32, uns32, uns32);

EXTERN_C void snmpsubagt_log_error_strs(uns8, char *, uns32, uns32);

EXTERN_C void snmpsubagt_log_func_entry(uns8);

EXTERN_C void snmpsubagt_log_data_dump(uns8, uns32);

EXTERN_C void snmpsubagt_log_state(uns8, uns32, uns32);

EXTERN_C void snmpsubagt_log_memdump(uns8 id, NCSFL_MEM mem);

EXTERN_C void snmpsubagt_log_intf_init_state(uns8);

EXTERN_C void snmpsubagt_log_table_id(uns8, uns32);

EXTERN_C LEAPDLL_API uns32 snmpsubagt_dbg_sink(uns32, char *, uns32);

EXTERN_C uns32 snmpsubagt_canned_str_reg(NCS_SERVICE_ID i_svc_id);

EXTERN_C uns32 snmpsubagt_canned_str_dereg(NCS_SERVICE_ID i_svc_id);

/* routines used in generating the logging in generated code */
void snmpsubagt_gen_str_log(char *);

void snmpsubagt_gen_err_log(char *, uns32);

void snmpsubagt_gen_oid_log(NCSFL_MEM);
