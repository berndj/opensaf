...
EXTERN_C uns32 cla_hdl_cbk_param_add(struct cla_cb_tag *, CLA_HDL_REC *, AVSV_CLM_CBK_INFO *);
...
EXTERN_C void cla_hdl_rec_del(struct cla_cb_tag *, CLA_HDL_DB *, CLA_HDL_REC *);

EXTERN_C CLA_HDL_REC *cla_hdl_rec_add(struct cla_cb_tag *, CLA_HDL_DB *, const SaClmCallbacksT *);

EXTERN_C uns32 cla_hdl_cbk_dispatch(struct cla_cb_tag **, CLA_HDL_REC **, SaDispatchFlagsT);
