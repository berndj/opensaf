...
EXTERN_C AVD_COMP_CSI_REL *avd_compcsi_struc_crt(AVD_CL_CB *cb, struct avd_su_si_rel_tag *susi);
...
EXTERN_C uns32 saamfcsitableentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);
/* This function is one of the get processing
...
EXTERN_C uns32 saamfcsitableentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL test_flag);
...
EXTERN_C uns32 saamfcsinamevaluetableentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);
/* This function is one of the get processing
...
EXTERN_C AVD_CS_TYPE_PARAM *avd_cs_type_param_struc_crt(AVD_CL_CB *cb, AVD_CS_TYPE_PARAM_INDX indx);

EXTERN_C AVD_CS_TYPE_PARAM *avd_cs_type_param_struc_find(AVD_CL_CB *cb, AVD_CS_TYPE_PARAM_INDX indx);

EXTERN_C AVD_CS_TYPE_PARAM *avd_cs_type_param_struc_find_next(AVD_CL_CB *cb, AVD_CS_TYPE_PARAM_INDX indx);

EXTERN_C uns32 avd_cs_type_param_struc_del(AVD_CL_CB *cb, AVD_CS_TYPE_PARAM *type_param);

EXTERN_C uns32 avd_cs_type_param_find_match(AVD_CL_CB *cb, SaNameT csi_type, SaNameT param_name);

EXTERN_C uns32 saamfcstypeparamentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);

EXTERN_C uns32 saamfcstypeparamentry_extract(NCSMIB_PARAM_VAL *param,
					     NCSMIB_VAR_INFO *var_info, NCSCONTEXT data, NCSCONTEXT buffer);

EXTERN_C uns32 saamfcstypeparamentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL test_flag);
