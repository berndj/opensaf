...
#define SA_NTF_FILTER_HANDLE_NULL       ((SaNtfNotificationFilterHandleT) NULL)
	...
	typedef void (*SaNtfNotificationCallbackT) (SaNtfSubscriptionIdT subscriptionId,
						    const SaNtfNotificationsT *notification);

	typedef void (*SaNtfNotificationDiscardedCallbackT) (SaNtfSubscriptionIdT subscriptionId,
							     SaNtfNotificationTypeT notificationType,
							     SaUint32T numberDiscarded,
							     const SaNtfIdentifierT *discardedNotificationIdentifiers);

	typedef void (*SaNtfStaticSuppressionFilterSetCallbackT) (SaNtfHandleT ntfHandle,
	...
	typedef struct {
		...
		SaNtfNotificationDiscardedCallbackT saNtfNotificationDiscardedCallback;
		 SaNtfStaticSuppressionFilterSetCallbackT saNtfStaticSuppressionFilterSetCallback;
	} SaNtfCallbacksT_2;

	extern SaAisErrorT
	 saNtfInitialize_2(SaNtfHandleT *ntfHandle, const SaNtfCallbacksT_2 * ntfCallbacks, SaVersionT *version);

	extern SaAisErrorT
	 saNtfSelectionObjectGet(SaNtfHandleT ntfHandle, SaSelectionObjectT *selectionObject);

	extern SaAisErrorT
	 saNtfDispatch(SaNtfHandleT ntfHandle, SaDispatchFlagsT dispatchFlags);
	...
	extern SaAisErrorT
	 saNtfStateChangeNotificationAllocate(SaNtfHandleT ntfHandle,
					      ...
					      SaUint16T lengthAdditionalText,
					      SaUint16T numAdditionalInfo,
					      SaUint16T numStateChanges, SaInt16T variableDataSize);
	...
	extern SaAisErrorT
	 SaNtfVariableDataSizeGet(SaNtfNotificationHandleT notificationHandle, SaUint16T *variableDataSpaceAvailable);

	extern SaAisErrorT
	 saNtfLocalizedMessageGet(SaNtfNotificationHandleT notificationHandle, SaStringT *message);

	extern SaAisErrorT
	 saNtfLocalizedMessageFree_2(SaNtfHandleT ntfHandle, SaStringT message);

	extern SaAisErrorT saNtfPtrValGet(SaNtfNotificationHandleT notificationHandle,
	...
	extern SaAisErrorT
	 saNtfStateChangeNotificationFilterAllocate_2(SaNtfHandleT ntfHandle,
	...
	extern SaAisErrorT
	 saNtfNotificationUnsubscribe_2(SaNtfHandleT ntfHandle, SaNtfSubscriptionIdT subscriptionId);

	extern SaAisErrorT
	 saNtfNotificationReadInitialize_2(const SaNtfSearchCriteriaT *searchCriteria,
...
/*  3.13.1  saNtfInitialize()  */
	SaAisErrorT
	 saNtfInitialize(SaNtfHandleT *ntfHandle, const SaNtfCallbacksT *ntfCallbacks, SaVersionT *version);
...
/*  3.15.4.1	saNtfNotificationReadInitialize()  */
	SaAisErrorT saNtfNotificationReadInitialize(SaNtfSearchCriteriaT searchCriteria,
						    const SaNtfNotificationTypeFilterHandlesT
						    *notificationFilterHandles, SaNtfReadHandleT *readHandle);
