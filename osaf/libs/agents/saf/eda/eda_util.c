...
******************************************************************************/
int32 
eda_find_mark_channel_to_ulink(EDA_CLIENT_HDL_REC *eda_hdl_rec, 
                               const SaNameT      *channelName)
{
   EDA_CHANNEL_HDL_REC *chan_hdl_rec;
   int32 chan_count_marked = 0;

   for (chan_hdl_rec = eda_hdl_rec->chan_list; 
        chan_hdl_rec != NULL; 
...
******************************************************************************/
NCS_BOOL
eda_validate_eda_client_hdl(EDA_CB *eda_cb, EDA_CLIENT_HDL_REC *find_hdl_rec)
{
   EDA_CLIENT_HDL_REC *hdl_rec;

   for (hdl_rec = eda_cb->eda_init_rec_list; 
        hdl_rec != NULL; 
...
******************************************************************************/
EDA_SUBSC_REC *
eda_find_subsc_by_subsc_id(EDA_CHANNEL_HDL_REC *chan_hdl_anc, uns32 sub_id)
{
   EDA_SUBSC_REC *subsc_rec;

   for (subsc_rec = chan_hdl_anc->subsc_list; 
        subsc_rec != NULL; 
...
******************************************************************************/
EDA_CLIENT_HDL_REC *
eda_find_hdl_rec_by_regid(EDA_CB *eda_cb, uns32 reg_id)
{
   EDA_CLIENT_HDL_REC *eda_hdl_rec;

   for (eda_hdl_rec = eda_cb->eda_init_rec_list; 
        eda_hdl_rec != NULL; 
