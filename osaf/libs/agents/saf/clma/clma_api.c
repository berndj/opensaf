				...
				SaClmClusterNodeT_4 clusterNode_4)
{
        ...
        (void)memcpy(clusterNode->nodeName.value,
                     clusterNode_4.nodeName.value,
        ...
        if(buf_4->notification != NULL &&
           (buf_4->numberOfItems >= msg_rsp->info.api_resp_info.param.track.notify_info->numberOfItems)) {
                ...
                ** This memory will be freed by the application */
                ...
                buf_4->viewNumber = msg_rsp->info.api_resp_info.param.track.notify_info->viewNumber;
                buf_4->notification =
                       (SaClmClusterNotificationT_4 *)malloc(sizeof(SaClmClusterNotificationT) *
                                                             buf_4->numberOfItems);
                memset(buf_4->notification, 0,
                       sizeof(SaClmClusterNotificationT_4) * buf_4->numberOfItems);
                memcpy(buf_4->notification, msg_rsp->info.api_resp_info.param.track.notify_info->notification,
					...
					SaClmClusterNotificationBufferT_4 *buf_4)
{
	...
	buf->notification[i].clusterNode.nodeAddress.family = buf_4->notification[i].clusterNode.nodeAddress.family;
	buf->notification[i].clusterNode.nodeAddress.length = buf_4->notification[i].clusterNode.nodeAddress.length;
	...
	buf->notification[i].clusterNode.initialViewNumber = buf_4->notification[i].clusterNode.initialViewNumber;
	}
}
...
/****************************************************************************
  ...
  Notes         : None.
******************************************************************************/
SaAisErrorT saClmClusterNotificationFree_4(SaClmHandleT clmHandle,
...
SaAisErrorT saClmResponse_4(SaClmHandleT clmHandle,
