	...
	case MDS_CALLBACK_RECEIVE:
		{
			...
			if (NCSCC_RC_SUCCESS != rc)
				m_AVA_LOG_MDS(AVSV_LOG_MDS_RCV_CBK, AVSV_LOG_MDS_FAILURE, NCSFL_SEV_CRITICAL);
			else
				m_AVA_LOG_MDS(AVSV_LOG_MDS_RCV_CBK, AVSV_LOG_MDS_SUCCESS, NCSFL_SEV_INFO);
		}
		break;
	...
	case MDS_CALLBACK_SVC_EVENT:
		{
			...
			if (NCSCC_RC_SUCCESS != rc)
				m_AVA_LOG_MDS(AVSV_LOG_MDS_SVEVT_CBK, AVSV_LOG_MDS_FAILURE, NCSFL_SEV_CRITICAL);
			else
				m_AVA_LOG_MDS(AVSV_LOG_MDS_SVEVT_CBK, AVSV_LOG_MDS_SUCCESS, NCSFL_SEV_INFO);
		}
		break;
	...
	case MDS_CALLBACK_ENC_FLAT:
		{
			...
			if (info->info.enc_flat.o_msg_fmt_ver < AVSV_AVND_AVA_MSG_FMT_VER_1) {
				/* log the problem */
				m_AVA_LOG_MDS(AVSV_LOG_MDS_FLAT_ENC_CBK, AVSV_LOG_MDS_FAILURE, NCSFL_SEV_CRITICAL);
			...
			if (NCSCC_RC_SUCCESS != rc)
				...
				m_AVA_LOG_MDS(AVSV_LOG_MDS_FLAT_ENC_CBK, AVSV_LOG_MDS_SUCCESS, NCSFL_SEV_INFO);
		}
		break;
	...
	case MDS_CALLBACK_DEC_FLAT:
		{
			if (!m_NCS_MSG_FORMAT_IS_VALID(info->info.dec_flat.i_msg_fmt_ver,
				...
				/* log the problem */
				m_AVA_LOG_MDS(AVSV_LOG_MDS_FLAT_DEC_CBK, AVSV_LOG_MDS_FAILURE, NCSFL_SEV_CRITICAL);
			...
			if (NCSCC_RC_SUCCESS != rc)
				...
				m_AVA_LOG_MDS(AVSV_LOG_MDS_FLAT_DEC_CBK, AVSV_LOG_MDS_SUCCESS, NCSFL_SEV_INFO);
		}
		break;
	...
	case MDS_CALLBACK_DEC:
		{
			if (!m_NCS_MSG_FORMAT_IS_VALID(info->info.dec.i_msg_fmt_ver,
						       ...
						       AVA_AVND_SUBPART_VER_MAX, ava_avnd_msg_fmt_map_table)) {
				/* log the problem */
				m_AVA_LOG_MDS(AVSV_LOG_MDS_DEC_CBK, AVSV_LOG_MDS_FAILURE, NCSFL_SEV_CRITICAL);
			...
			if (NCSCC_RC_SUCCESS != rc)
				...
				m_AVA_LOG_MDS(AVSV_LOG_MDS_DEC_CBK, AVSV_LOG_MDS_SUCCESS, NCSFL_SEV_INFO);
		}
		break;
	case MDS_CALLBACK_ENC:
		{
			...
			if (info->info.enc.o_msg_fmt_ver < AVSV_AVND_AVA_MSG_FMT_VER_1) {
				/* log the problem */
				m_AVA_LOG_MDS(AVSV_LOG_MDS_ENC_CBK, AVSV_LOG_MDS_FAILURE, NCSFL_SEV_CRITICAL);
			...
			if (NCSCC_RC_SUCCESS != rc)
				...
				m_AVA_LOG_MDS(AVSV_LOG_MDS_ENC_CBK, AVSV_LOG_MDS_SUCCESS, NCSFL_SEV_INFO);
		}
