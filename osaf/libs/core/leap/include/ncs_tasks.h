...
NCS_MAB  
        ...
        OAC   Object Access Client (entry into MAB services)
              Function entry:  oac_do_events()

        MAC   MIB Access Client    (subsystems bind to these)
              Function entry:  mac_do_events()

        MAS   MIB Access Server    (singular, central 'location' repository)
              Function entry:  mas_do_events()
...
#define NCS_MAB_OAC_PRIORITY  NCS_TASK_PRIORITY_6
#endif

#ifndef NCS_MAB_OAC_TASKNAME
#define NCS_MAB_OAC_TASKNAME  "MAB_OAC"
#endif
...
#define NCS_MAB_MAC_PRIORITY  NCS_TASK_PRIORITY_6
#endif

#ifndef NCS_MAB_MAC_TASKNAME
#define NCS_MAB_MAC_TASKNAME  "MAB_MAC"
#endif
...
#define NCS_MAB_MAS_PRIORITY  NCS_TASK_PRIORITY_6
#endif

#ifndef NCS_MAB_MAS_TASKNAME
#define NCS_MAB_MAS_TASKNAME  "MAB_MAS"
#endif
...
#define NCS_MAB_PSR_PRIORITY  NCS_TASK_PRIORITY_6
#endif

#ifndef NCS_MAB_PSR_TASKNAME
