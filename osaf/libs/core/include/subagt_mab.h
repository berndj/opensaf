...
#define NCS_SNMPSUBAGT_MAC_TIMEOUT  500	/* 5 seconds */
	...
	EXTERN_C NCSMIB_PARAM_VAL rsp_param_val;

	 EXTERN_C uns32 g_subagt_mac_hdl;

	 EXTERN_C U64 g_counter64;
...
#define     m_SUBAGT_MAC_HDL_GET    g_subagt_mac_hdl
	...
	EXTERN_C uns32
	 snmpsubagt_mab_oid_compose(oid *io_oid,
				    ...
				    oid *i_base_oid, uns32 i_base_oid_len, NCSMIB_NEXT_RSP *i_next_rsp);

	EXTERN_C unsigned char *snmpsubagt_mab_mibarg_resp_process(NCSMIB_PARAM_VAL *i_rsp_param_val,
