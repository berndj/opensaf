 ...
 *
 ****************************************************************************/
	typedef uns32 (*NCSMIB_VALIDATE_OBJ) (struct ncsmib_var_info * obj_info, NCSMIB_PARAM_VAL *param);
 ...
 *
 ****************************************************************************/
	typedef uns32 (*NCSMIB_GET_FUNC) (NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);
