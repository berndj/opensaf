...
const NCSFL_STR mbcsv_hdln_set[] = 
  {
    ...
    { MBCSV_HDLN_MBCSV_DESTROY_SUCCESS,     "MBCSV is about to destroy itself. MBCSV services will not be available now."},
 ...
 *****************************************************************************/
uns32
mbcsv_log_str_lib_req(NCS_LIB_REQ_INFO *req_info)
{
