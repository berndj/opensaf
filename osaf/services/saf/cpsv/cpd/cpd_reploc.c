...
static uns32 cpd_get_ckpt_and_node_name(const uns32 *i_inst_ids, uns32 i_inst_len, SaNameT *ckpt_name,
					SaNameT *node_name);
 ...
 *
 *****************************************************************************/
uns32 sackptnodereplicalocentry_extract(NCSMIB_PARAM_VAL *param, NCSMIB_VAR_INFO *var_info, NCSCONTEXT data,
					NCSCONTEXT buffer)
{
	uns32 rc = NCSCC_RC_SUCCESS;
	CPD_CKPT_REPLOC_INFO *rep_info = NULL;
