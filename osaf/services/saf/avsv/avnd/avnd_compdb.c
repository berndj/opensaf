...
AVND_COMP *avnd_compdb_rec_add(AVND_CB *cb, AVND_COMP_PARAM *info, uns32 *rc)
{
	...
	*rc = ncs_patricia_tree_add(&cb->compdb, &comp->tree_node);
	...
	m_AVND_LOG_COMP_DB(AVND_LOG_COMP_DB_REC_ADD, AVND_LOG_COMP_DB_SUCCESS, &info->name_net, 0, NCSFL_SEV_INFO);
	return comp;
 ...
 err:
	...
	m_AVND_LOG_COMP_DB(AVND_LOG_COMP_DB_REC_ADD, AVND_LOG_COMP_DB_FAILURE, &info->name_net, 0, NCSFL_SEV_CRITICAL);
	return 0;
}
...
uns32 avnd_compdb_rec_del(AVND_CB *cb, SaNameT *name_net)
{
	...
	m_AVND_LOG_COMP_DB(AVND_LOG_COMP_DB_REC_DEL, AVND_LOG_COMP_DB_SUCCESS, name_net, 0, NCSFL_SEV_INFO);
 ...
 err:
	m_AVND_LOG_COMP_DB(AVND_LOG_COMP_DB_REC_DEL, AVND_LOG_COMP_DB_FAILURE, name_net, 0, NCSFL_SEV_CRITICAL);
	return rc;
}
...
/****************************************************************************
  ...
  Notes         : None
******************************************************************************/
AVND_COMP_CSI_REC *avnd_compdb_csi_rec_get(AVND_CB *cb, SaNameT *comp_name_net, SaNameT *csi_name_net)
{
	...
	if (comp)
		csi_rec = m_AVND_COMPDB_REC_CSI_GET(*comp, *csi_name_net);
...
/****************************************************************************
  ...
  Notes         : None
******************************************************************************/
AVND_COMP_CSI_REC *avnd_compdb_csi_rec_get_next(AVND_CB *cb, SaNameT *comp_name_net, SaNameT *csi_name_net)
{
 ...
 * 
 **************************************************************************/
uns32 ncsscomptableentry_extract(NCSMIB_PARAM_VAL *param, NCSMIB_VAR_INFO *var_info, NCSCONTEXT data, NCSCONTEXT buffer)
{
 ...
 * 
 **************************************************************************/
uns32 ncsscomptableentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL test_flag)
{
 ...
 * 
 **************************************************************************/
uns32 saamfscompcsitableentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data)
{
	AVND_CB *avnd_cb = (AVND_CB *)cb;
	...
	if (csi_rel == AVND_COMP_CSI_REC_NULL)
		return NCSCC_RC_NO_INSTANCE;
 ...
 * 
 **************************************************************************/
uns32 saamfscompcsitableentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL test_flag)
{
	/* This table has only read-only objects */
	return NCSCC_RC_INV_VAL;
}
