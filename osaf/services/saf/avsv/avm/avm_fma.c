...
/* Function prototypes */
extern void avm_rcv_fma_node_reset_cb(SaInvocationT inv, SaHpiEntityPathT ent_path);
 ...
 * Notes         : None.
 ******************************************************************************/
uns32 avm_fma_initialize(AVM_CB_T *cb)
{
 ...
 * Notes         : None.
 ******************************************************************************/
void avm_rcv_fma_node_reset_cb(SaInvocationT inv, SaHpiEntityPathT ent_path)
{
...
void avm_rcv_fma_switchover_req_cb(SaInvocationT inv)
{
	...
	if (avm_cb->adm_switch == TRUE) {
		...
		if (NCSCC_RC_SUCCESS != (rc = avm_notify_rde_set_role(avm_cb, SA_AMF_HA_QUIESCED))) {
			m_NCS_DBG_PRINTF
 ...
 ******************************************************************************/
uns32 avm_notify_fm_hb_evt(AVM_CB_T *cb, SaNameT node_name, AVM_ROLE_FSM_EVT_TYPE_T evt_type)
{
	SaAisErrorT rc_ais = SA_AIS_OK;
 ...
 ******************************************************************************/
uns32 avm_notify_fm_node_reset(AVM_CB_T *avm_cb, SaHpiEntityPathT *ent_path)
{
	SaAisErrorT rc_ais;
