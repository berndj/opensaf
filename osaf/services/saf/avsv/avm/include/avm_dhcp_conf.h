...
extern uns32 extract_slot_shelf_subslot(uns8 *node_name, struct slot_info *slot);
...
extern void avm_role_change_check_pld_upgd_prg(AVM_CB_T *avm_cb);

extern uns32
avm_dhcp_file_validation(AVM_CB_T *cb, AVM_ENT_INFO_T *ent_info, NCSMIB_PARAM_VAL param_val, AVM_PER_LABEL_CONF *label,
			 AVM_LABEL_NUM label_no);

extern uns32
avm_send_dynamic_data(AVM_CB_T *cb, AVM_ENT_INFO_T *ent_info, NCSMIB_PARAM_ID param_id, NCSMIB_FMAT_ID fmt_id,
		      AVM_PSSV_PUSH *avm_pss);
