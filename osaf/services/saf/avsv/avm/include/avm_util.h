...
EXTERN_C uns32
avm_get_hpi_hs_state(AVM_ENT_INFO_T *, uns32 *);
...
extern uns32 
avm_active(AVM_CB_T*, AVM_ENT_INFO_T*);
...
extern uns32
avm_notify_rde_nd_hrt_bt_lost(AVM_CB_T *, uns32);

extern uns32
avm_notify_rde_nd_hrt_bt_restore(AVM_CB_T *, uns32);

extern uns32
avm_notify_rde_set_role(AVM_CB_T *cb, SaAmfHAStateT role);
...
extern uns32 
avm_ssu_dhconf(AVM_CB_T *avm_cb, AVM_ENT_INFO_T *ent_info,
                            void *fsm_evt, uns8 dhcp_restart);

extern uns32
avm_ssu_dhconf_set(AVM_CB_T *avm_cb, AVM_ENT_DHCP_CONF  *dhcp_conf, 
                   AVM_PER_LABEL_CONF *dhcp_label, uns8 dhcp_restart);

extern uns32
avm_ssu_dhcp_tmr_reconfig (AVM_CB_T *avm_cb, AVM_EVT_T  *hpi_evt);

extern  uns32 avm_send_boot_upgd_trap(AVM_CB_T *avm_cb,
                                      AVM_ENT_INFO_T *ent_info, uns32 trap_id);
...
extern uns32 avm_entity_inactive_hisv_ret_error_trap(AVM_CB_T *avm_cb, 
                                                     AVM_ENT_INFO_T *ent_info);
...
extern uns32
avm_push_admin_mib_set_to_psr(AVM_CB_T *cb, AVM_ENT_INFO_T  *ent_info, 
                              AVM_ADM_OP_T adm_state);
...
extern void 
avm_conv_phy_info_to_ent_path(NCS_CHASSIS_ID chassis_id, NCS_PHY_SLOT_ID phy_slot_id, NCS_SUB_SLOT_ID subslot_id, SaHpiEntityPathT *ep);
