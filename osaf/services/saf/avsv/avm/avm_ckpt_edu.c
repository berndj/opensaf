...
static uns32
avm_edp_entity_path(EDU_HDL *hdl,
		    EDU_TKN *edu_tkn,
		    NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err);
...
avm_edp_ent_info_list(EDU_HDL *hdl,
		      ...
		      NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err);
static uns32
avm_edp_entity_path_str(EDU_HDL *hdl,
			EDU_TKN *edu_tkn,
			NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err);
static uns32
avm_edp_entity_path(EDU_HDL *hdl,
...
static uns32
avm_edp_ent_dhconf_name_type(EDU_HDL *hdl,
			     EDU_TKN *edu_tkn,
			     NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err);

static uns32
avm_edp_ent_per_label_conf(EDU_HDL *hdl,
			   EDU_TKN *edu_tkn,
			   NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err);

static uns32
avm_edp_ent_per_label_status(EDU_HDL *hdl,
			     EDU_TKN *edu_tkn,
			     NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err);
				 ...
				 uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_msg_valid_info_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
...
extern uns32
avm_edp_ckpt_msg_ent(EDU_HDL *hdl,
		     EDU_TKN *edu_tkn,
		     NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
		     ...
		     NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, ncs_edp_sensor_event_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
	return rc;
}
...
extern uns32
avm_edp_ckpt_msg_evt_id(EDU_HDL *hdl,
			EDU_TKN *edu_tkn,
			NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
 ...
 ************************************************************************/
extern uns32
avm_edp_ckpt_msg_async_updt_cnt(EDU_HDL *hdl,
				EDU_TKN *edu_tkn,
				NCSCONTEXT ptr,
				uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_async_updt_cnt_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
		      ...
		      NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_edp_ent_desc_name_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
	return rc;
}
			   ...
			   NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_edp_ent_valid_location_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
	return rc;
}
			     ...
			     NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_edp_valid_location_range_rules, struct_ptr, ptr_data_len, buf_env,
				 op, o_err);
	return rc;
}
		      ...
		      NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_edp_ent_info_list_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
	return rc;
}
			...
			NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_entity_path_str_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
	return rc;
}
		    ...
		    NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_entity_path_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
	return rc;
}
...
extern uns32
avm_edp_ckpt_msg_dhcp_conf(EDU_HDL *hdl,
			   EDU_TKN *edu_tkn,
			   NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uns32 rc = NCSCC_RC_SUCCESS;
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_msg_dhcp_conf_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
...
extern uns32
avm_edp_ckpt_msg_dhcp_state(EDU_HDL *hdl,
			    EDU_TKN *edu_tkn,
			    NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uns32 rc = NCSCC_RC_SUCCESS;
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_msg_dhcp_state_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
 ...
 ************************************************************************/
extern uns32
avm_edp_ckpt_msg_dummy(EDU_HDL *hdl,
		       EDU_TKN *edu_tkn,
		       NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
...
extern uns32
avm_edp_ckpt_msg_upgd_state(EDU_HDL *hdl,
			    EDU_TKN *edu_tkn,
			    NCSCONTEXT ptr, uns32 *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	uns32 rc = NCSCC_RC_SUCCESS;
	...
	rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avm_ckpt_msg_upgd_state_rules, struct_ptr, ptr_data_len, buf_env, op,
				 o_err);
