...
static uns32 avm_mbcsv_process_enc_cb(AVM_CB_T *cb, NCS_MBCSV_CB_ARG *arg);

static uns32 avm_mbcsv_process_dec_cb(AVM_CB_T *cb, NCS_MBCSV_CB_ARG *arg);

static uns32 avm_mbcsv_process_peer_info_cb(AVM_CB_T *cb, NCS_MBCSV_CB_ARG *arg);
static uns32 avm_mbcsv_process_notify(AVM_CB_T *cb, NCS_MBCSV_CB_ARG *arg);
static uns32 avm_mbcsv_process_en_notify_cb(AVM_CB_T *cb, NCS_MBCSV_CB_ARG *arg);
 ...
 ***********************************************************************
 *****/
uns32 avm_set_ckpt_role(AVM_CB_T *cb, uns32 role)
{
	NCS_MBCSV_ARG mbcsv_arg;
...
*
*****************************************************************************/
uns32 avm_mbc_dispatch(AVM_CB_T *cb, uns32 flag)
{
	NCS_MBCSV_ARG mbcsv_arg;
	uns32 rc = NCSCC_RC_SUCCESS;
	...
	case NCS_MBCSV_MSG_ASYNC_UPDATE:
		{
			...
			m_AVM_LOG_CKPT_EVT(AVM_MBCSV_MSG_ASYNC_DEC, status + AVM_MBCSV_RES_BASE,
					   arg->info.decode.i_reo_type, NCSFL_SEV_INFO);
		}
		break;
	...
	case NCS_MBCSV_MSG_COLD_SYNC_RESP_COMPLETE:
		{
			...
			m_AVM_LOG_CKPT_EVT(AVM_MBCSV_MSG_COLD_DEC, status + AVM_MBCSV_RES_BASE,
	...
	case NCS_MBCSV_MSG_WARM_SYNC_RESP_COMPLETE:
		{
			...
			m_AVM_LOG_CKPT_EVT(AVM_MBCSV_MSG_WARM_SYNC_RESP, AVM_MBCSV_FAILURE, arg->info.decode.i_reo_type,
					   NCSFL_SEV_INFO);
	...
	case NCS_MBCSV_MSG_DATA_RESP_COMPLETE:
		{
			...
			if (NCSCC_RC_SUCCESS != status) {
				m_AVM_LOG_CKPT_EVT(AVM_MBCSV_MSG_DATA_RESP, AVM_MBCSV_FAILURE,
						   arg->info.decode.i_reo_type, NCSFL_SEV_ERROR);
	...
	case NCS_MBCSV_MSG_ASYNC_UPDATE:
		{
			...
			m_AVM_LOG_CKPT_EVT(AVM_MBCSV_MSG_ASYNC_ENC, status + AVM_MBCSV_RES_BASE,
					   arg->info.encode.io_reo_type, NCSFL_SEV_INFO);
	...
	case NCS_MBCSV_MSG_COLD_SYNC_RESP:
		{
			...
			m_AVM_LOG_CKPT_EVT(AVM_MBCSV_MSG_COLD_ENC, status + AVM_MBCSV_RES_BASE,
					   arg->info.encode.io_reo_type, NCSFL_SEV_INFO);
		}
		break;
