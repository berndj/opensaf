			     ...
			     NCSCONTEXT ptr, uint32_t *ptr_data_len, EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avnd_ckpt_msg_comp_rules[] = {
		...
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_COMP *)0)->clc_info.cmds[AVND_COMP_CLC_CMD_TYPE_INSTANTIATE - 1].len, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
		...
		{EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
		 ...
		 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_COMP *)0)->clc_info.cmds[AVND_COMP_CLC_CMD_TYPE_TERMINATE - 1].len, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
		...
		{EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
		 (long)&((AVND_COMP *)0)->quies_complete_cbk_timeout, 0, nullptr},
		{EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
		...
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_COMP *)0)->clc_info.clc_reg_tmr.is_active, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_COMP *)0)->clc_info.clc_reg_tmr.type, 0, nullptr},
				...
				EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avnd_ckpt_msg_csi_rules[] = {
		...
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_COMP_CSI_REC *)0)->curr_assign_state, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
				       ...
				       EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avnd_ckpt_msg_async_updt_cnt_rules[] = {
		 ...
		 */
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_ASYNC_UPDT_CNT *)0)->hlth_config_updt, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		...
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_ASYNC_UPDT_CNT *)0)->comp_hlth_rec_updt, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
		 (long)&((AVND_ASYNC_UPDT_CNT *)0)->comp_cbk_rec_updt, 0, nullptr},
