	...
	EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avsv_ckpt_msg_cluster_rules[] = {
		{EDU_START, avsv_edp_ckpt_msg_cluster, 0, 0, 0, sizeof(AVD_CLUSTER), 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_CLUSTER *)0)->saAmfClusterAdminState, 0, nullptr},
	...
	EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avsv_ckpt_msg_node_rules[] = {
		{EDU_START, avsv_edp_ckpt_msg_node, 0, 0, 0, sizeof(AVD_AVND), 0, nullptr},

		/* Fill here AVD AVND config data structure encoding rules */
		{EDU_EXEC, m_NCS_EDP_SACLMNODEIDT, 0, 0, 0, (long)&((AVD_AVND *)0)->node_info.nodeId, 0, nullptr},
		{EDU_EXEC, ncs_edp_saclmnodeaddresst, 0, 0, 0, (long)&((AVD_AVND *)0)->node_info.nodeAddress, 0, nullptr},
		{EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((AVD_AVND *)0)->name, 0, nullptr},
		{EDU_EXEC, ncs_edp_int, 0, 0, 0, (long)&((AVD_AVND *)0)->node_info.member, 0, nullptr},
		{EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, (long)&((AVD_AVND *)0)->node_info.bootTimestamp, 0, nullptr},
		{EDU_EXEC, m_NCS_EDP_SAUINT64T, 0, 0, 0, (long)&((AVD_AVND *)0)->node_info.initialViewNumber, 0, nullptr},
		{EDU_EXEC, ncs_edp_mds_dest, 0, 0, 0, (long)&((AVD_AVND *)0)->adest, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_AVND *)0)->saAmfNodeAdminState, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_AVND *)0)->saAmfNodeOperState, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_AVND *)0)->node_state, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_AVND *)0)->type, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_AVND *)0)->rcv_msg_id, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_AVND *)0)->snd_msg_id, 0, nullptr},
		{EDU_END, 0, 0, 0, 0, 0, 0, nullptr},
	};
				     ...
				     EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avsv_ckpt_msg_comp_cs_type_rules[] = {
		{EDU_START, avsv_edp_ckpt_msg_comp_cs_type, 0, 0, 0, sizeof(AVD_COMPCS_TYPE), 0, nullptr}	,

		{EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((AVD_COMPCS_TYPE *)0)->name, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_COMPCS_TYPE *)0)->saAmfCompNumCurrActiveCSIs, 0, nullptr},
		{EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (long)&((AVD_COMPCS_TYPE *)0)->saAmfCompNumCurrStandbyCSIs, 0, nullptr},
				  ...
				  EDU_BUF_ENV *buf_env, EDP_OP_TYPE op, EDU_ERR *o_err)
{
	...
	EDU_INST_SET avsv_ckpt_msg_si_trans_rules[] = {
		...
		{EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((AVSV_SI_TRANS_CKPT_MSG *)0)->sg_name, 0, nullptr},
		{EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((AVSV_SI_TRANS_CKPT_MSG *)0)->si_name, 0, nullptr},
		{EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((AVSV_SI_TRANS_CKPT_MSG *)0)->min_su_name, 0, nullptr},
		{EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, (long)&((AVSV_SI_TRANS_CKPT_MSG *)0)->max_su_name, 0, nullptr},
