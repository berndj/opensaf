...
const NCSFL_STR eds_hdln_set[] = {
	...
	{EDS_PID_FILE_OPEN_FOR_WRITE_FAILED, "EDS " PKGPIDDIR "eds.pid FILE OPEN FOR WRITE FAILED"},
	{EDS_PID_FILE_WRITE_FAILED, "EDS " PKGPIDDIR "eds.pid FILE WRITE FAILED"},
	...
	{EDS_PID_FILE_WRITE_SUCCESS, "EDS " PKGPIDDIR "eds.pid file write success"},
	...
	{EDS_AMF_COMP_FILE_OPEN_FOR_READ_FAIL,
	 "EDS AMF " PKGSYSCONFDIR "ncs_eds_comp_name file open for read failed"},
	{EDS_AMF_COMP_FILE_READ_FAIL, "EDS AMF " PKGSYSCONFDIR "ncs_eds_comp_name file read failed"},
