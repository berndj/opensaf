...
const NCSFL_STR eds_hdln_set[] = 
{
   ...
   { EDS_MAB_REGISTER_SUCCESS,                    "EDS MAB register success"       },
   ...
   { EDS_AMF_COMP_FILE_OPEN_FOR_READ_FAIL,        "EDS AMF " OSAF_SYSCONFDIR "ncs_eds_comp_name file open for read failed" },
   { EDS_AMF_COMP_FILE_READ_FAIL,                 "EDS AMF " OSAF_SYSCONFDIR "ncs_eds_comp_name file read failed"},
