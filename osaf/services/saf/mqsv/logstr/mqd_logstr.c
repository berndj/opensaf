...
const NCSFL_STR mqd_hdln_set[] = {
	...
	{MQD_MIB_QGROUP_MEMBERS_TBL_ROW_OWNED_SUCCESS,
	 "MQD - Reg Rowowned for Queue Group Members Entry table Success"},
	...
	{MQD_MIB_GRPMEMBRSENTRYTBL_UNREG_WITH_MAB_SUCCESS,
	 "MQD - Dereg with MAB for Group Members Entry table Success"},
	...
	{MQD_MIB_GRPMEMBERSENTRYTBL_REG_WITH_MIBLIB_FAILED,
	 "MQD - Reg with MIBLIB for Group Members Entry table Success"},
	...
	{MQD_DEREG_HDLR_MIB_EVT_SEND_SUCCESS,
	 "MQD - Queue Deleted from the Group and MIB event send to MQND to update the Number of Queues in the Group"},
	{MQD_DEREG_HDLR_MIB_EVT_SEND_FAILED,
	 "MQD - Queue Deleted from the Group and MIB event sendt to MQND to update the Number of Queues in the Group Failure"},
