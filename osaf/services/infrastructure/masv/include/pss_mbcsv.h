...
EXTERN_C uns32 pss_ckpt_dec_warmsync_resp(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *io_uba, NCS_BOOL *is_in_sync);
...
EXTERN_C uns32 pss_send_ckpt_data(struct pss_pwe_cb_tag *pwe_cb,
				  uns32 action, uns32 reo_hdl, uns32 reo_type, uns32 send_type);

EXTERN_C uns32 pss_ckpt_enc_tbl_bind(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba, PSS_CKPT_TBL_BIND_MSG *bind,
				     uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_enc_tbl_unbind(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba, PSS_CKPT_TBL_UNBIND_MSG *unbind,
				       uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_enc_oaa_down(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba, PSS_CKPT_OAA_DOWN_MSG *oaa_down,
				     uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_enc_plbck_ssn_info(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba,
					   PSS_CKPT_PLBCK_SSN_INFO_MSG * plbck_ssninfo, uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_enc_bam_conf_done(NCS_UBAID *uba, PSS_CKPT_BAM_CONF_DONE_MSG *bam_conf_done);
EXTERN_C uns32 pss_ckpt_dec_tbl_bind(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba, PSS_CKPT_TBL_BIND_MSG *bind,
				     uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_dec_tbl_unbind(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba, PSS_CKPT_TBL_UNBIND_MSG *unbind,
				       uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_dec_oaa_down(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba, PSS_CKPT_OAA_DOWN_MSG *oaa_down,
				     uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_ckpt_dec_plbck_ssn_info(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *uba,
					   PSS_CKPT_PLBCK_SSN_INFO_MSG * plbck_ssninfo, uns16 peer_mbcsv_version);
...
EXTERN_C uns32 pss_re_direct_sync(struct pss_pwe_cb_tag *pwe_cb, NCSCONTEXT msg, PSS_CKPT_DATA_TYPE ckpt_type,
...
EXTERN_C uns32 pss_enc_pwe_data_for_sync_with_standby(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *io_uba,
						      NCS_BOOL enc_lib_conf, uns16 peer_mbcsv_version);
EXTERN_C uns32 pss_dec_pwe_data_for_sync_with_standby(struct pss_pwe_cb_tag *pwe_cb, NCS_UBAID *io_uba,
						      NCS_BOOL dec_lib_conf, uns16 peer_mbcsv_version);
