...
EXTERN_C uns32 pss_handle_oaa_down_event(PSS_PWE_CB *pwe_cb, MDS_DEST *fr_card);
...
EXTERN_C uns32 pss_process_tbl_pss_profiles(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C uns32 pss_process_sclr_trigger(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C uns32 pss_process_tbl_cmd(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C uns32 ncspssvprofiletableentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);
...
EXTERN_C uns32 ncspssvprofiletableentry_set(NCSCONTEXT cb,
					    NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL test_flag);
...
EXTERN_C uns32 ncspssvscalars_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL test_flag);
EXTERN_C uns32 ncspssvscalars_extract(NCSMIB_PARAM_VAL *param,
				      NCSMIB_VAR_INFO *var_info, NCSCONTEXT data, NCSCONTEXT buffer);
EXTERN_C uns32 ncspssvscalars_get(NCSCONTEXT inst, NCSMIB_ARG *arg, NCSCONTEXT *data);
...
EXTERN_C uns32 pss_process_set_plbck_option_for_spcn(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C uns32 pss_update_entry_in_spcn_conf_file(PSS_CB *inst, PSS_SPCN_LIST *entry);
EXTERN_C uns32 pss_process_display_mib_entries(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C uns32 pss_process_display_profile_entries(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C void pss_process_reload_pssvlibconf(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C void pss_process_reload_pssvspcnlist(PSS_CB *inst, NCSMIB_ARG *arg);
EXTERN_C uns32 pss_process_trigger_op(PSS_CB *inst, PSR_TRIGGER_VALUES val);
...
EXTERN_C PSS_SPCN_LIST *pss_findadd_entry_frm_spcnlist(PSS_CB *inst, char *p_pcn, NCS_BOOL add);
EXTERN_C void pss_reset_boolean_in_spcn_entry(PSS_PWE_CB *pwe_cb, PSS_SPCN_LIST *spcn_entry);
...
EXTERN_C PSS_OAA_ENTRY *pss_findadd_entry_in_oaa_tree(PSS_PWE_CB *pss_cb, MDS_DEST *mds_dest, NCS_BOOL add);
...
EXTERN_C char *pss_get_pcn_from_mdsdest(PSS_PWE_CB *pwe_cb, MDS_DEST *mdest, uns32 tbl_id);

EXTERN_C void pss_index_tree_destroy(NCS_PATRICIA_TREE *pTree);
EXTERN_C uns32 pss_table_tree_destroy(NCS_PATRICIA_TREE *pTree, NCS_BOOL retain_tree);
...
EXTERN_C NCS_PATRICIA_NODE *pss_find_inst_node(PSS_PWE_CB *pwe_cb,
					       ...
					       uns32 num_inst_ids, uns32 *inst_ids, NCS_BOOL create);
EXTERN_C PSS_OAA_CLT_ID *pss_add_tbl_in_oaa_node(PSS_PWE_CB *pwe_cb, PSS_OAA_ENTRY *node, PSS_TBL_REC *trec);
EXTERN_C PSS_OAA_CLT_ID *pss_find_tbl_in_oaa_node(PSS_PWE_CB *pwe_cb, PSS_OAA_ENTRY *node, uns32 tbl_id);
...
*****************************************************************************/
EXTERN_C MABPSR_API uns32 pss_pwe_cb_init(uns32 pss_cb_handle, PSS_PWE_CB *pwe_cb, PW_ENV_ID envid);

EXTERN_C MABPSR_API uns32 pss_pwe_cb_destroy(PSS_PWE_CB *pwe_cb);
...
EXTERN_C void pss_send_eop_status_to_oaa(MAB_MSG *mm, uns32 status, uns32 mib_key, uns32 wbreq_hdl, NCS_BOOL send_all);
...
EXTERN_C void pss_mib_data_init(PSS_MIB_TBL_DATA *mib_data, uns16 pwe, char *svc_name);
EXTERN_C uns32 pss_delete_inst_node_from_tree(NCS_PATRICIA_TREE *pTree, NCS_PATRICIA_NODE *pNode);
EXTERN_C uns32 pss_del_data_for_oac(PSS_CB *inst, MDS_DEST *mds_dest, PW_ENV_ID env);
...
EXTERN_C uns32 pss_validate_set_mib_obj(PSS_MIB_TBL_INFO *tbl_obj, NCSMIB_PARAM_VAL *param);
EXTERN_C uns32 pss_validate_param_val(NCSMIB_VAR_INFO *var_info, NCSMIB_PARAM_VAL *param);
EXTERN_C uns32 pss_validate_index(PSS_MIB_TBL_INFO *tbl_obj, NCSMIB_IDX *idx);

/*****************************************************************************
 Data manipulation routines 
*****************************************************************************/

EXTERN_C NCS_BOOL pss_data_available_for_table(PSS_PWE_CB *pwe_cb, char *p_pcn, PSS_TBL_REC *trec);
EXTERN_C uns32 pss_apply_changes_to_node(PSS_MIB_TBL_INFO *tbl_info, PSS_MIB_TBL_DATA *pData, NCSMIB_PARAM_VAL *param);
...
EXTERN_C uns32 pss_get_inst_ids_from_data(PSS_MIB_TBL_INFO *tbl_info, uns32 *pinst_ids, uns8 *buffer);
EXTERN_C uns32 pss_apply_inst_ids_to_node(PSS_MIB_TBL_INFO *tbl_info,
					  PSS_MIB_TBL_DATA *tbl_data, uns32 num_inst_ids, uns32 *inst_ids);
EXTERN_C uns32 pss_set_key_from_inst_ids(PSS_MIB_TBL_INFO *tbl_info, uns8 *key, uns32 num_inst_ids, uns32 *inst_ids);
EXTERN_C uns32 pss_get_key_from_data(PSS_MIB_TBL_INFO *tbl_info, uns8 *pkey, uns8 *buffer);
EXTERN_C void pss_get_profile_from_inst_ids(uns8 *profile_name, uns32 num_inst_ids, const uns32 *inst_ids);
...
EXTERN_C uns32 pss_sort_wbreq_instore_tables_with_rank(PSS_PWE_CB *pwe_cb,
						       ...
						       NCS_BOOL *snd_evt_to_bam, NCS_UBAID *uba);
...
EXTERN_C uns32 pss_sort_odreq_instore_tables_with_rank(PSS_PWE_CB *pwe_cb, PSS_ODPLAYBACK_SORT_TABLE *sortdb);
EXTERN_C uns32 pss_ondemand_playback_for_sorted_list(PSS_PWE_CB *pwe_cb,
						     PSS_ODPLAYBACK_SORT_TABLE *sortdb, uns8 *profile);
EXTERN_C uns32 pss_wb_playback_for_sorted_list(PSS_PWE_CB *pwe_cb,
					       PSS_WBPLAYBACK_SORT_TABLE *sort_db, PSS_CLIENT_ENTRY *node, char *p_pcn);
...
EXTERN_C uns32 pss_broadcast_playback_signal(struct pss_csi_node *csi_list, NCS_BOOL is_start);
EXTERN_C uns32 pss_oac_warmboot_process_tbl(PSS_PWE_CB *pwe_cb, char *p_pcn,
					    PSS_TBL_REC *tbl_rec, PSS_CLIENT_ENTRY *node,
#if (NCS_PSS_RED == 1)
...
#endif
						 NCS_BOOL is_end_of_playback);
EXTERN_C uns32 pss_on_demand_playback(PSS_CB *inst, struct pss_csi_node *csi_lsit, uns8 *profile);

EXTERN_C uns32 pss_playback_process_tbl(PSS_PWE_CB *pwe_cb, uns8 *profile,
					PSS_TBL_REC *rec, NCS_QUEUE *add_q, NCS_QUEUE *chg_q,
#if (NCS_PSS_RED == 1)
					NCS_BOOL *i_continue_session,
#endif
					NCS_BOOL last_plbck_evt);
EXTERN_C uns32 pss_playback_process_sclr_tbl(PSS_PWE_CB *pwe_cb, uns8 *profile, PSS_TBL_REC *tbl_rec,
#if (NCS_PSS_RED == 1)
					     NCS_BOOL *i_continue_session,
#endif
					     NCS_BOOL last_plbck_evt);
...
EXTERN_C uns32 pss_playback_process_diff_q(PSS_CB *inst, NCS_QUEUE *diff_q, NCS_BOOL is_add, uns16 pwe);
EXTERN_C void pss_destroy_queue(NCS_QUEUE *diff_q);
EXTERN_C uns32 pss_add_to_diff_q(NCS_QUEUE *diff_q, uns32 tbl, char *p_pcn, uns8 *data, uns32 len);
...
EXTERN_C uns32 pss_send_remrow_request(PSS_PWE_CB *pwe_cb, USRBUF *ub, uns32 tbl, NCSMIB_IDX *first_idx);
EXTERN_C uns32 pss_send_remove_request(PSS_PWE_CB *pwe_cb, uns32 tbl, NCSMIB_IDX *idx, NCSMIB_PARAM_ID status_param_id);
EXTERN_C void pss_destroy_spcn_wbreq_pend_list(PSS_SPCN_WBREQ_PEND_LIST *pend_list);
EXTERN_C uns32 pss_sync_mib_req(NCSMIB_ARG *marg, NCSMIB_REQ_FNC mib_fnc, uns32 sleep_dur, NCSMEM_AID *mma);
...
EXTERN_C uns32 pss_flush_mib_entries_from_curr_profile(PSS_PWE_CB *pwe_cb,
						       PSS_SPCN_LIST *spcn_entry, PSS_CLIENT_ENTRY *clt_node);
EXTERN_C uns32 pss_read_from_store(PSS_PWE_CB *pwe_cb, uns8 *profile_name,
				   uns8 *key, char *p_pcn,
				   uns32 tbl_id, NCS_PATRICIA_NODE *pNode, NCS_BOOL *entry_found);
...
EXTERN_C uns32 pss_add_to_refresh_tbl_list(PSS_PWE_CB *pwe_cb, PSS_TBL_REC *tbl_rec);
...
EXTERN_C uns32 pss_mds_grcv(MDS_HDL pwe_hdl, MDS_CLIENT_HDL yr_svc_hdl,
			    NCSCONTEXT msg, MDS_DEST fr_card, SS_SVC_ID fr_svc, MDS_DEST to_card, SS_SVC_ID to_svc);
