...
EXTERN_C uns32 oac_ss_tbl_reg(NCSOAC_TBL_OWNED *tbl_owned, uns32 tbl_id, uns32 oac_hdl);
EXTERN_C uns32 oac_ss_tbl_unreg(NCSOAC_TBL_GONE *tbl_gone, uns32 tbl_id, uns32 oac_hdl);
EXTERN_C uns32 oac_ss_row_reg(NCSOAC_ROW_OWNED *row_owned, uns32 tbl_id, uns32 oac_hdl);
EXTERN_C uns32 oac_ss_row_unreg(NCSOAC_ROW_GONE *row_gone, uns32 tbl_id, uns32 oac_hdl);
...
EXTERN_C uns32 oac_move_row_fltr_delete(OAC_TBL *inst, NCSMIB_ARG *arg);
/*****************************************************************************
...
*oac_findadd_pcn_in_list(OAC_TBL *inst, char *pcn, NCS_BOOL is_system_client, uns32 tbl_id, NCS_BOOL add);
...
EXTERN_C uns32 oac_gen_tbl_bind(OAA_PCN_LIST *pcn_list, MAB_PSS_TBL_BIND_EVT **bind);
...
EXTERN_C uns32 oaclib_oac_destroy(NCS_LIB_REQ_INFO *req_info);
/************************************************************************
