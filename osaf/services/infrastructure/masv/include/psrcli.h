...
EXTERN_C uns32 pss_cef_set_playback_option_from_xml_config(NCSCLI_ARG_SET *, NCSCLI_CEF_DATA *);
...
EXTERN_C uns32 pss_cef_reload_pssv_lib_conf(NCSCLI_ARG_SET *arg_list, NCSCLI_CEF_DATA *cef_data);
EXTERN_C uns32 pss_cef_reload_pssv_spcn_list(NCSCLI_ARG_SET *arg_list, NCSCLI_CEF_DATA *cef_data);
EXTERN_C uns32 pss_cef_replace_current_profile(NCSCLI_ARG_SET *arg_list, NCSCLI_CEF_DATA *cef_data);
EXTERN_C uns32 pss_send_cmd_mib_req(NCSMIB_ARG *mib_arg, NCSCLI_CEF_DATA *cef_data);
