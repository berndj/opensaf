...
const NCSFL_STR pss_hdln_set[] = {
	...
	{PSS_HDLN_AMF_CSI_ATTRIB_DECODE_SUCCESS,
	 "PSS pss_amf_csi_attrib_decode(): Successfully decode the Env-Id from CSI Attributes (decode_env)"},
	...
	{PSS_HDLN_DATA_RESP_DEC_FAIL_WITH_COLD_SYNC_COMPLT_BUT_WARM_SYNC_FAIL,
	 "DATA RESP DEC FAIL WITH COLD_SYNC_COMPLETE state, BUT WARM_SYNC FAIL"},
	...
	{PSS_HDLN_STORE_REFORMATTING_FROM_1EXT_TO_HIGHER_START,
	 "PSS Started Store Reformatting from 1Ext to Higher format"},
	{PSS_HDLN_STORE_REFORMATTING_FROM_1EXT_TO_HIGHER_SUCCESS,
	 "PSS Store Reformatting from 1Ext to Higher format succesful"},
	{PSS_HDLN_STORE_REFORMATTING_FROM_HIGHER_TO_1EXT_START,
	 "PSS Started Store Reformatting from higher to 1Ext format"},
	{PSS_HDLN_STORE_REFORMATTING_FROM_HIGHER_TO_1EXT_SUCCESS,
	 "PSS Store Reformatting from higher to 1Ext format succesful"},
	...
	{PSS_HDLN_PROPERTIES_CHANGED_BUT_NOT_TABLE_VERSION,
	 "Table properties changed with out change in table version"},
	...
	{PSS_HDLN_STORE_REFORMATTING_FROM_HIGHER_TO_2_SUCCESS,
	 "PSS Store Reformatting from Higher to 2 format succesful"},
...
const NCSFL_STR pss_hdln2_set[] = {
	...
	{PSS_HDLN_MBCSV_RE_PLBCK_SSN_DETAILS_FLUSHED_EVEN_WHEN_NO_PLBCK_ACTIVE,
	 "MBCSV RE PLCBK_SSNINFO DETAILS FLUSHED EVEN WHEN NO PLBCK IN PROGRESS"},
	...
	{PSS_HDLN_ERR_AMF_SBY_TO_ACT_FAILED_LIBCONF_FILE_RELOAD,
	 "AMF STANDBY-to-ACTIVE FAIL due to LIB_CONF FILE RELOAD FAIL"},
	{PSS_HDLN_ERR_AMF_SBY_TO_ACT_FAILED_SPCNLIST_FILE_RELOAD,
	 "AMF STANDBY-to-ACTIVE FAIL due to SPCN_LIST FILE RELOAD FAIL"},
	...
	{PSS_HDLN2_MAS_MDS_NEW_ACTIVE_AS_UP_EVT,
	 "PSS received MAS MDS_NEW_ACTIVE event, which is being treated as MDS_UP"},
	...
	{PSS_HDLN2_BAM_MDS_NEW_ACTIVE_AS_UP_EVT,
	 "PSS received BAM MDS_NEW_ACTIVE event, which is being treated as MDS_UP"},
	...
	{PSS_HDLN2_SCLR_SET_OCT_OBJECT_LENGTH_MISMATCH_WITH_STREAM_SPEC_MAX_LEN,
	 "PSS SCLR SET fail, OCT object length mismatch with stream spec max length"},
	{PSS_HDLN2_SCLR_SET_OCT_OBJECT_LENGTH_MISMATCH_WITH_DISCRETE_OCT_STR_MAX_LEN,
	 "PSS SCLR SET fail, OCT object length mismatch with discrete object max length"},
	...
	{PSS_HDLN2_SET_PARAM_ID_MISMATCH_WITH_VAR_INFO_PARAM_ID,
	 "PSS SET fail, param_id mismatch with var_info param_id"},
	...
	{PSS_HDLN2_SET_KEY_FROM_INST_IDS_FMAT_INT_NOT_SUPPORTED,
	 "PSS SET-KEY-FROM-INST-IDS fail, INT fmat type not supported"},
...
NCSFL_FMAT pss_fmat_set[] = {
	...
	{PSS_LID_VAR_INFO, "TILLLLLLLLLLLLLLLL",
	 "PSS %s : %s TBL:%ld,PSSOFSET:%ld,PARMID:%ld,OFFSET:%ld,LEN:%ld,IS_INDX:%ld,ACCSS:%ld,STATUS:%ld,SETWHENDOWN:%ld,FMTID:%ld,OBJTYPE:%ld,INT_MIN:%ld,INT_MAX:%ld,OCT_MIN:%ld,OCT_MAX:%ld,IS_READONLY_PERSISTENT:%ld\n"},
	{PSS_LID_INFO, "TICL", "PSS %s : %s PCN=%s, Playback-from-BOM=%ld\n"},
	{PSS_LID_TBL_INFO, "TICLLLLLLLL",
	 "PSS %s : %s TBL=%s, TBL_ID=%ld, RNK=%ld, NUM_OBJ=%ld, NUM_INSTS=%ld, MAYKEY=%ld, MAXROW=%ld, CAP=%ld, BMAP_LEN=%ld\n"},
...
const NCSFL_STR pss_err_set[] = {
	...
	{PSS_ERR_VDEST_DESTROY_FAILED,
	 "PSS pss_amf_prepare_will(): NCSVDA_VDEST_DESTROYoperation for ncsvda_api() FAIL(error): "},
	...
	{PSS_ERR_AMF_CSI_FLAGS_ILLEGAL,
	 "PSS pss_amf_csi_set(): CSI Assignment happened with illegal flag values (flag values): "},
	{PSS_ERR_AMF_ENVID_ILLEGAL,
	 "PSS pss_amf_csi_new(): Invalid Environment id is received from the CSI Attributes (envid):"},
	{PSS_ERR_CSI_ADD_ONE_FAILED, "PSS pss_amf_csi_new(): Adding a new CSI FAIL(error, envid):"},
	{PSS_ERR_MDS_UNINSTALL_FAILED,
	 "PSS pss_amf_csi_remove_one(): MDS_UNINSTALL operation for ncsmds_api() FAIL(error, envid)"},
	...
	{PSS_ERR_MDS_PWE_QUERY_FAILED,
	 "PSS pss_amf_csi_vdest_role_change(): MDS_QUERY_PWE operation for ncsmds_api() FAIL(error): "},
	{PSS_ERR_MDS_VDEST_ROLE_CHG_FAILED,
	 "PSS pss_amf_csi_vdest_role_change(): NCSVDA_VDEST_CHG_ROLE operation for ncsvda_api() FAIL(error):"},
	...
	{PSS_ERR_COMP_NAME_FSCANF_FAILED,
	 "PSS pss_amf_sigusr1_handler(): fscanf() to read the PSS AMF component name FAIL"},
	{PSS_ERR_COMP_NAME_SETENV_FAILED,
	 "PSS pss_amf_sigusr1_handler(): setting the SA_AMF_COMPONENT_NAME environment variable FAIL"},
	...
	{PSS_ERR_TGT_SVSC_LM_CREATE_FAILED,
	 "PSS pss_ts_create(): NCS_PSSTS_LM_OP_CREATE operation for ncspssts_lm() FAIL(error): "},
	...
	{PSS_ERR_TGT_SVCS_DESTROY_FAILED,
	 "PSS pss_ts_destroy(): NCS_PSSTS_LM_OP_DESTROY operation for ncspssts_lm() FAIL(error): "},
	{PSS_ERR_SPIR_MDS_LOOKUP_CREATE_FAILED,
	 "PSS pss_pwe_cb_init(): PSS_ERR_SPIR_MDS_LOOKUP_CREATE_FAILED operation for m_MDS_SP_ABST_NAME FAIL(error, envid): "},
	{PSS_ERR_SPIR_MAA_LOOKUP_CREATE_FAILED,
	 "PSS pss_pwe_cb_init(): PSS_ERR_SPIR_MDS_LOOKUP_CREATE_FAILED operation for m_MAA_SP_ABST_NAME FAIL(error, envid): "},
	{PSS_ERR_SPIR_OAA_LOOKUP_CREATE_FAILED,
	 "PSS pss_svc_create(): PSS_ERR_SPIR_MDS_LOOKUP_CREATE_FAILED operation for m_OAA_SP_ABST_NAME FAIL(error, envid): "},
	...
	{PSS_ERR_MDS_PWE_INSTALL_FAILED,
	 "PSS pss_amf_csi_install(): MDS_INSTALL operation for ncsmds_api() FAIL(error): "},
	{PSS_ERR_MDS_SUBSCRIBE_FAILED,
	 "PSS pss_amf_csi_install(): MDS_SUBSCRIBE operation for ncsmds_api() FAIL(error): "},
	{PSS_ERR_PWE_CB_INIT_FAILED, "PSS pss_amf_csi_install(): pss_pwe_cb_init() FAIL(error, envid)"},
	{PSS_ERR_DEF_ENV_INIT_FAILED,
	 "PSS pss_svc_create(): pss_amf_csi_install() FAIL for default env and HAPS state (envid, HAPS state):"},
	{PSS_ERR_SPIR_MAA_REL_INST_FAILED,
	 "PSS pss_pwe_cb_destroy(): NCS_SPIR_REQ_REL_INST for m_MAA_SP_ABST_NAME (error, envid):"},
	{PSS_ERR_SPIR_MDS_REL_INST_FAILED,
	 "PSS pss_pwe_cb_destroy(): NCS_SPIR_REQ_REL_INST for m_MDS_SP_ABST_NAME (error, envid):"},
	...
	{PSS_ERR_CREATE_LM_API_NOT_YET_CALLED,
	 "PSS pss_amf_csi_install(): PSS_CB handle is zero (CREATE LM API did not get called)"},
	...
	{PSS_ERR_CLIENT_TABLE_TREE_DESTROY_FAILED,
	 "PSS  pss_pwe_cb_destroy(): ncs_patricia_tree_destroy() FAIL for Client table tree"},
	{PSS_ERR_AMF_CSI_ATTRIBS_COUNT_INVALID,
	 "PSS pss_amf_csi_attrib_decode(): Ivalid CSI Attribs count received (csiDescriptor.csiAttr.number)"},
	...
	{PSS_ERR_AMF_CSI_ATTRIBS_NAME_OR_ATTRIB_VAL_NULL,
	 "PSS pss_amf_csi_attrib_decode(): csiDescriptor.csiAttr.attr->attrName or csiDescriptor.csiAttr.attr->attrValue is NULL"},
	...
	{PSS_ERR_AMF_CSI_DECODED_ENV_ID_OUTOF_REACH,
	 "PSS pss_amf_csi_attrib_decode(): Decoded env is out of reach (decoded_env)"},
	...
	{PSS_ERR_AMF_CSI_ATTRIBS_NAME_INVALID,
	 "PSS pss_amf_csi_set_one(): strcmp() FAIL beacause of invalid attribute name"},
