 ...
 ****************************************************************************/
uns32 pss_bam_mds_enc(MDS_CLIENT_HDL yr_svc_hdl, NCSCONTEXT msg, SS_SVC_ID to_svc, NCS_UBAID *uba)
{
	uns8 *data;
	PSS_BAM_MSG *pm = NULL;
 ...
 ****************************************************************************/
uns32 pss_bam_mds_dec(MDS_CLIENT_HDL yr_svc_hdl, NCSCONTEXT *msg, SS_SVC_ID to_svc, NCS_UBAID *uba)
{
	uns8 *data;
	PSS_BAM_MSG *pm;
 ...
 ****************************************************************************/
uns32 pss_bam_mds_cpy(MDS_CLIENT_HDL yr_svc_hdl, NCSCONTEXT msg, SS_SVC_ID to_svc, NCSCONTEXT *cpy, NCS_BOOL last)
{
	PSS_BAM_MSG *pm;
