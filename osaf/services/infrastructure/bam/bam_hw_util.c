...
SaHpiEntityTypeT get_entity_type_from_text(char *str)
{
...
*****************************************************************************/
void ent_path_from_type_location(BAM_ENT_DEPLOY_DESC *ent, char *ent_path)
{
	char tmpStr[6];
...
void bam_clear_and_destroy_deploy_tree(void)
{
	...
	do {
		ent = (BAM_ENT_DEPLOY_DESC *)
		    ncs_patricia_tree_getnext(&bam_cb->deploy_ent_anchor, (uns8 *)ent_name);
