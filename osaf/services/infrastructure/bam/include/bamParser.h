...
XERCES_CPP_NAMESPACE_USE EXTERN_C DOMDocument * gl_dom_doc;

EXTERN_C DOMNode *get_dom_node_by_name(char *, char *);

EXTERN_C SaAisErrorT saAmfConfigParseAllObjs(DOMNode *, BAM_PARSE_SUB_TREE);
...
EXTERN_C SaAisErrorT saAmfParseSGInstance(DOMNode *);

EXTERN_C SaAisErrorT saAmfParseCSIPrototype(char *, char *);

EXTERN_C uns32 parse_process_config(DOMNode *);

EXTERN_C SaAisErrorT ncs_bam_parse_libproto_list(DOMNode *, char *, char *);

EXTERN_C SaAisErrorT ncs_bam_parse_lib_desc_list(DOMNode *, char *, char *);

EXTERN_C SaAisErrorT ncs_bam_parse_lib_instance(DOMNode *);

EXTERN_C SaAisErrorT ncs_bam_parse_ext_lib_proto(DOMNode *);

EXTERN_C SaAisErrorT parse_hw_deploy_config(DOMNode *);

EXTERN_C uns32 parse_and_build_hw_validation(char *);

EXTERN_C uns32 bam_parse_hardware_config(void);

EXTERN_C uns32 ncs_bam_map_csi_comp_add(char *, char *, uns32);

EXTERN_C uns32 ncs_bam_csi_comp_find(char *);

EXTERN_C uns32 ncs_bam_csi_name_db_add(char *, char *);
/*
