...
EXTERN_C uns32 ncsdtsvscalars_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL flag);
EXTERN_C uns32 ncsdtsvscalars_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);

EXTERN_C uns32
ncsdtsvscalars_next(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data, uns32 *next_inst_id, uns32 *next_inst_len);
EXTERN_C uns32
...
EXTERN_C uns32 ncsdtsvscalars_rmvrow(NCSCONTEXT cb, NCSMIB_IDX *idx);
EXTERN_C uns32
ncsdtsvscalars_extract(NCSMIB_PARAM_VAL *param_val, NCSMIB_VAR_INFO *var_info, NCSCONTEXT data, NCSCONTEXT buffer);

/* Defines for node related mib functions */
EXTERN_C uns32 ncsdtsvnodelogpolicyentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL flag);
EXTERN_C uns32 ncsdtsvnodelogpolicyentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);
...
ncsdtsvnodelogpolicyentry_setrow(NCSCONTEXT cb, NCSMIB_ARG *args,
				 NCSMIB_SETROW_PARAM_VAL *params, struct ncsmib_obj_info *objinfo, NCS_BOOL flag);
EXTERN_C uns32 ncsdtsvnodelogpolicyentry_rmvrow(NCSCONTEXT cb, NCSMIB_IDX *idx);
EXTERN_C uns32
...
EXTERN_C uns32
ncsdtsvservicelogpolicyentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSMIB_VAR_INFO *var_info, NCS_BOOL flag);
EXTERN_C uns32 ncsdtsvservicelogpolicyentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, NCSCONTEXT *data);
...
ncsdtsvservicelogpolicyentry_setrow(NCSCONTEXT cb, NCSMIB_ARG *args,
				    NCSMIB_SETROW_PARAM_VAL *params, struct ncsmib_obj_info *objinfo, NCS_BOOL flag);
EXTERN_C uns32 ncsdtsvservicelogpolicyentry_rmvrow(NCSCONTEXT cb, NCSMIB_IDX *idx);
EXTERN_C uns32
