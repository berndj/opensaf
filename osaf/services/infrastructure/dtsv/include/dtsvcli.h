...
EXTERN_C uns32 dtsv_set_mib_int(NCSMIB_ARG *mib,
				uns32 pid, uns32 r_status, uns32 val, NCSMIB_REQ_FNC reqfnc, char *err);
...
EXTERN_C uns32 dtsv_set_mib_int_val(NCSMIB_ARG *mib, uns32 pid, uns32 val, NCSMIB_REQ_FNC reqfnc, char *err);

EXTERN_C uns32 dtsv_chk_mib_rsp(char *err, NCSMIB_ARG *arg, uns32 key);

EXTERN_C uns32 dtsv_cirbuff_setrow(NCSMIB_ARG *mib,
				   NCSMIB_REQ_FNC reqfunc,
				   uns32 node_id, uns32 svc_id, uns32 operation, uns8 device, char *err);

EXTERN_C uns32 dtsv_get_mib_int(NCSMIB_ARG *mib, uns32 pid, uns8 *val, NCSMIB_REQ_FNC reqfnc, char *err);

EXTERN_C uns32 dtsv_get_mib_oct(NCSMIB_ARG *mib,
				uns32 pid, NCSCONTEXT val, uns32 *len, NCSMIB_REQ_FNC reqfnc, char *err);

EXTERN_C uns32 dtsv_send_cmd_mib_req(NCSMIB_ARG *mib, NCSCLI_CEF_DATA *cef_data, char *err);
