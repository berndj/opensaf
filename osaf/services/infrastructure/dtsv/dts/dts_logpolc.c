	...
	while (attribute) {
		...
		if (!strcmp(attribute->attrName, "osafDtsvServiceLogDevice")) {
			...
			if ((value < 100) || (value > 10000)) {
				LOG_ER("Invalid osafDtsvServiceLogFileSize : %lu , exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvServiceFileLogCompFormat :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 10) || (value > 1000)) {
				LOG_ER("Invalid osafDtsvServiceCircularBuffSize :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvServiceCirBuffCompFormat :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvServiceLoggingState :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 1) || (value > 255)) {
				LOG_ER("Invalid osafDtsvServiceSeverityBitMap :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
...
unsigned int dts_node_log_policy_set(DTS_CB *inst, char *objName, void *attrib_info, enum CcbUtilOperationType UtilOp)
{
	...
	while (attribute) {
		...
		if (!strcmp(attribute->attrName, "osafDtsvNodeMessageLogging")) {
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvNodeMessageLogging :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 100) || (value > 100000)) {
				LOG_ER("Invalid osafDtsvNodeLogFileSize :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvNodeFileLogCompFormat :%lu exiting",value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 10) || (value > 10000)) {
				LOG_ER("Invalid osafDtsvNodeCircularBuffSize :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvNodeCirBuffCompFormat :%lu exiting", value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 0) || (value > 1)) {
				LOG_ER("Invalid osafDtsvNodeLoggingState :%lu exiting",value);
				exit(EXIT_FAILURE);
			}
			...
			if ((value < 1) || (value > 255)) {
				LOG_ER("Invalid osafDtsvNodeSeverityBitMap :%lu exiting",value);
				exit(EXIT_FAILURE);
			}
