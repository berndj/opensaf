...
extern uns32 dtm_internode_process_rcv_up_msg(uns8 *buffer, uns16 len, NODE_ID node_id);
extern uns32 dtm_internode_process_rcv_down_msg(uns8 *buffer, uns16 len, NODE_ID node_id);
extern uns32 dtm_node_down(NODE_ID node_id, char *node_name, SYSF_MBX mbx);
extern uns32 dtm_internode_process_rcv_data_msg(uns8 *buffer, uns32 dst_pid, uns16 len);
