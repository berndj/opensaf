...
public class ErrorReportingImpl implements ErrorReporting {
     ...
     */
    ErrorReportingImpl( AmfHandle amfLibraryHandle ) {
        this.amfLibraryHandle = amfLibraryHandle;
    }

	public native void clearComponentError(String componentName, long ntfIdentifier)
	...
	public native void reportComponentError(String erroneousComponent,
			long detectionTime, RecommendedRecovery recommendedRecovery,
			long ntfIdentifier) throws AisLibraryException,
