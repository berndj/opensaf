...
// CLASS ais.amf.ComponentRegistry
jboolean JNU_ComponentRegistry_initIDs_OK(
    JNIEnv* jniEnv );
    ...
    JNIEnv* jniEnv )
{
    ...
    // get IDs
    return JNU_ComponentRegistry_initIDs_FromClass_OK( jniEnv, ClassComponentRegistry );
 ...
 *************************************************************************/
JNIEXPORT jstring JNICALL Java_org_opensaf_ais_amf_ComponentRegistryImpl_invokeSaAmfComponentNameGet(
    JNIEnv* jniEnv,
    jobject thisComponentRegistry )
{
    ...
    _TRACE2( "NATIVE: Executing Java_org_opensaf_ais_amf_ComponentRegistryImpl_invokeSaAmfComponentNameGet(...)\n" );
    ...
    _saStatus = saAmfComponentNameGet( _saAmfHandle,
                                       &_saComponentName );
    ...
    U_printSaName(  "NATIVE: Java_org_opensaf_ais_amf_ComponentRegistryImpl_invokeSaAmfComponentNameGet(...) returning normally with Component name: ",
                    &_saComponentName );
 ...
 * Signature: ()V
 *************************************************************************/
JNIEXPORT void JNICALL Java_org_opensaf_ais_amf_ComponentRegistryImpl_registerComponent(
    JNIEnv* jniEnv,
    jobject thisComponentRegistry )
{
    // VARIABLES
    ...
    assert( thisComponentRegistry != NULL );
    _TRACE2( "NATIVE: Executing Java_org_opensaf_ais_amf_ComponentRegistryImpl_registerComponent(...)\n" );
    ...
    _TRACE2( "NATIVE: Java_org_opensaf_ais_amf_ComponentRegistryImpl_registerComponent(...) returning normally\n" );
 ...
 *  Signature: ()V
 *************************************************************************/
JNIEXPORT void JNICALL Java_org_opensaf_ais_amf_ComponentRegistryImpl_unregisterComponent(
    JNIEnv* jniEnv,
    jobject thisComponentRegistry )
{
    // VARIABLES
    ...
    assert( thisComponentRegistry != NULL );
    _TRACE2( "NATIVE: Executing Java_org_opensaf_ais_amf_ComponentRegistryImpl_unregisterComponent(...)\n" );
    ...
    _TRACE2( "NATIVE: Java_org_opensaf_ais_amf_ComponentRegistryImpl_unregisterComponent(...) returning normally\n" );
