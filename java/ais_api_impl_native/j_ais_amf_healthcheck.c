...
// CLASS ais.amf.Healthcheck
jboolean JNU_Healthcheck_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_Healthcheck_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    ...
    jclass classHealthcheck )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_Healthcheck_initIDs_FromClass_OK(...)\n" );
    ...
    _TRACE2( "NATIVE: JNU_Healthcheck_initIDs_FromClass_OK(...) returning normally\n" );
 ...
 *************************************************************************/
JNIEXPORT void JNICALL Java_org_opensaf_ais_amf_HealthcheckImpl_startHealthcheck(
    JNIEnv* jniEnv,
    jobject thisHealthcheck,
    jstring componentName,
    jbyteArray healthcheckKey,
    jobject invocationType,
    jobject recommendedRecovery )
{
    ...
    _TRACE2( "NATIVE: Executing Java_org_opensaf_ais_amf_HealthcheckImpl_startHealthcheck(...)\n" );
    ...
    _TRACE2( "NATIVE: Java_org_opensaf_ais_amf_HealthcheckImpl_startHealthcheck(...) returning normally\n" );
    ...
    jbyteArray healthcheckKey )
{
    ...
    assert( thisHealthcheck != NULL );
    _TRACE2( "NATIVE: Executing Java_org_opensaf_ais_amf_HealthcheckImpl_stopHealthcheck(...)\n" );
    ...
    _TRACE2( "NATIVE: Java_org_opensaf_ais_amf_HealthcheckImpl_stopHealthcheck(...) returning normally\n" );
 ...
 *************************************************************************/
JNIEXPORT void JNICALL Java_org_opensaf_ais_amf_HealthcheckImpl_confirmHealthcheck(
    JNIEnv* jniEnv,
    jobject thisHealthcheck,
    jstring componentName,
    jbyteArray healthcheckKey,
    jint healthcheckResult )
{
    // VARIABLES
    SaAmfHandleT _saAmfHandle;
    SaNameT _saComponentName;
    ...
    assert( thisHealthcheck != NULL );
    _TRACE2( "NATIVE: Executing Java_org_opensaf_ais_amf_HealthcheckImpl_confirmHealthcheck(...)\n" );
    ...
    _TRACE2( "NATIVE: saAmfHealthcheckConfirm(...) has returned with %d...\n", _saStatus );
    ...
    _TRACE2( "NATIVE: Java_org_opensaf_ais_amf_HealthcheckImpl_confirmHealthcheck(...) returning normally\n" );
...
jboolean JNU_HealthcheckInvocation_initIDs_OK( JNIEnv* jniEnv )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_HealthcheckInvocation_initIDs_OK(...)\n" );
    ...
    jclass enumHealthcheckInvocation )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_HealthcheckInvocation_initIDs_FromClass_OK(...)\n" );
    ...
    _TRACE2( "NATIVE: JNU_HealthcheckInvocation_initIDs_FromClass_OK(...) returning normally\n" );
