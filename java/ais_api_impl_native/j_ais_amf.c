...
// CLASS ais.amf.CsiDescriptor
jboolean JNU_CsiDescriptor_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_CsiDescriptor_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    jclass classCsiDescriptor );
jobject JNU_CsiDescriptor_create(
    JNIEnv* jniEnv,
    const SaAmfCSIDescriptorT* saCsiDescriptorPtr,
    SaAmfHAStateT saHaState );
static jboolean JNU_CsiDescriptor_set(
    JNIEnv* jniEnv,
...
// CLASS ais.amf.CsiActiveDescriptor
jboolean JNU_CsiActiveDescriptor_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_CsiActiveDescriptor_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
...
// ENUM ais.amf.CsiActiveDescriptor$TransitionDescriptor
jboolean JNU_TransitionDescriptor_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_TransitionDescriptor_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    jclass enumTransitionDescriptor );
static jobject JNU_TransitionDescriptor_getEnum(
    JNIEnv* jniEnv,
    SaAmfCSITransitionDescriptorT saTransitionDescriptor );

// CLASS ais.amf.CsiStandbyDescriptor
jboolean JNU_CsiStandbyDescriptor_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_CsiStandbyDescriptor_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
...
jboolean JNU_HaState_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_HaState_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    jclass enumHaState );
jobject JNU_HaState_getEnum(
    JNIEnv* jniEnv,
    SaAmfHAStateT saHaState );

// ENUM ais.amf.CsiDescriptor$CsiFlags
jboolean JNU_CsiFlags_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_CsiFlags_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    jclass enumCsiFlags );
static jobject JNU_CsiFlags_getEnum(
    JNIEnv* jniEnv,
    SaAmfCSIFlagsT saCsiFlags );

// CLASS ais.amf.CsiAttribute
jboolean JNU_CsiAttribute_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_CsiAttribute_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    jclass classCsiAttribute );
static jobject JNU_CsiAttribute_create(
    JNIEnv* jniEnv,
    const SaAmfCSIAttributeT* saCsiAttributePtr );
static jboolean JNU_CsiAttribute_set(
    JNIEnv* jniEnv,
    jobject sCsiAttribute,
    const SaAmfCSIAttributeT* saCsiAttributePtr );

// ENUM ais.amf.RecommendedRecovery
jboolean JNU_RecommendedRecovery_initIDs_OK(
    JNIEnv* jniEnv );
static jboolean JNU_RecommendedRecovery_initIDs_FromClass_OK(
    JNIEnv* jniEnv,
    ...
    SaAmfHealthcheckKeyT* saHealthcheckKeyPtr )
{
    ...
    U_printSaName("NATIVE CALLBACK: \tParameter saCompNamePtr: ", saCompNamePtr);
    // TODO healthcheck key printing

    // get context
    _status = JNU_GetEnvForCallback( cachedJVM,
                                    &_jniEnv );
    if( _status != JNI_OK ){
        // TODO error handling
    ...
    _healthcheckKeyArray = ( jbyteArray )
                           (*_jniEnv)->NewByteArray( _jniEnv,
                                                    _hKeyLen );
    if( _healthcheckKeyArray == NULL ){
        _TRACE2( "NATIVE CALLBACK ERROR: _healthcheckKeyArray is NULL\n" );
    ...
    SaAmfCSIDescriptorT saCsiDescriptor )
{
    ...
    _TRACE2( "NATIVE CALLBACK: \tParameter saInvocation: %lu\n", (unsigned long) saInvocation );
    U_printSaName( "NATIVE CALLBACK: \tParameter saCompNamePtr: ", saCompNamePtr );
    U_printSaAmfHAState( "NATIVE CALLBACK: \tParameter saHaState: ", saHaState );
    U_printSaAmfCSIDescriptor( "NATIVE CALLBACK: \tParameter saCsiDescriptor: ", saHaState, &saCsiDescriptor );
    ...
    // HA state
    _haState = JNU_HaState_getEnum( _jniEnv,
                                    saHaState );
    if( _haState == NULL ){
        // TODO error handling
    ...
    SaAmfCSIFlagsT saCsiFlags )
{
    ...
    _TRACE2( "NATIVE CALLBACK: \tParameter saInvocation: %lu\n", (unsigned long) saInvocation );
    U_printSaName( "NATIVE CALLBACK: \tParameter saCompNamePtr: ", saCompNamePtr );
    U_printSaName( "NATIVE CALLBACK: \tParameter saCsiNamePtr: ", saCsiNamePtr );
    U_printSaAmfCSIFlags( "NATIVE CALLBACK: \tParameter saCsiFlags: ", saCsiFlags );
    ...
    // CSI name
    _csiNameString = JNU_newStringFromSaNameT( _jniEnv,
                                                saCsiNamePtr );
    ...
    // CSI flags
    _csiFlags = JNU_CsiFlags_getEnum( _jniEnv,
                                      saCsiFlags );
    if( _csiFlags == NULL ){
        // TODO error handling
    ...
    const SaNameT* saCompNamePtr )
{
    ...
    _TRACE2( "NATIVE CALLBACK: Executing SaAmfComponentTerminateCallback(...)\n" );
    _TRACE2( "NATIVE CALLBACK: \tParameter saInvocation: %lu\n", (unsigned long) saInvocation );
    U_printSaName( "NATIVE CALLBACK: \tParameter saCompNamePtr: ", saCompNamePtr );
    ...
    const SaNameT *saProxiedCompNamePtr )
{
    ...
    _TRACE2( "NATIVE CALLBACK: Executing SaAmfProxiedComponentInstantiateCallback(...)\n" );
    _TRACE2( "NATIVE CALLBACK: \tParameter saInvocation: %lu\n", (unsigned long) saInvocation );
    U_printSaName( "NATIVE CALLBACK: \tParameter saProxiedCompNamePtr: ", saProxiedCompNamePtr );
    ...
    const SaNameT *saProxiedCompNamePtr )
{
    ...
    _TRACE2( "NATIVE CALLBACK: Executing SaAmfProxiedComponentCleanupCallback(...)\n" );
    _TRACE2( "NATIVE CALLBACK: \tParameter saInvocation: %lu\n", (unsigned long) saInvocation );
    U_printSaName( "NATIVE CALLBACK: \tParameter saProxiedCompNamePtr: ", saProxiedCompNamePtr );
    ...
    SaAisErrorT saError )
{
    ...
    _TRACE2( "NATIVE CALLBACK: Executing SaAmfProtectionGroupTrackCallback(...)\n" );
    U_printSaName( "NATIVE CALLBACK: \tParameter saCsiNamePtr: ", saCsiNamePtr );
    ...
    if (saError != SA_AIS_OK) {
        _TRACE2( "WARNING NATIVE CALLBACK ERROR IN SERVICE LIBRARY: See SaAmfProtectionGroupTrackCallbackT error=%d For more info.\n", saError );
        _TRACE2( "WARNING NATIVE CALLBACK ERROR IN SERVICE LIBRARY: These errors are not handled in the native implementation yet.\n" );
    }
    ...
    */
    ...
    (*_jniEnv)->CallStaticVoidMethod( _jniEnv,
                                      ...
                                      (jint) saError );
    _TRACE2( "NATIVE CALLBACK: Return SaAmfProtectionGroupTrackCallback(...)\n" );
}
    ...
    JNIEnv* jniEnv )
{
    ...
    // get IDs
    return JNU_CsiDescriptor_initIDs_FromClass_OK( jniEnv, ClassCsiDescriptor );
}
    ...
    jclass classCsiDescriptor )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_CsiDescriptor_initIDs_FromClass_OK(...)\n" );
    ...
    if( CID_CsiDescriptor_constructor == NULL ){
        ...
        _TRACE2( "NATIVE ERROR: CID_CsiDescriptor_constructor is NULL\n" );
    ...
    _TRACE2( "NATIVE: JNU_CsiDescriptor_initIDs_FromClass_OK(...) returning normally\n" );
    ...
    SaAmfHAStateT saHaState )
{
    ...
    // csiFlags
    _csiFlags = JNU_CsiFlags_getEnum( jniEnv,
                                      saCsiDescriptorPtr->csiFlags );
    if( _csiFlags == NULL ){
        // TODO error handling
    ...
    switch( saHaState ){
        ...
        case SA_AMF_HA_STANDBY:
            _csiStandbyDescriptor = JNU_CsiStandbyDescriptor_create(
                                    jniEnv,
                                    &(saCsiDescriptorPtr->csiStateDescriptor.standbyDescriptor) );
            if( _csiStandbyDescriptor == NULL ){

                _TRACE2( "NATIVE ERROR: _csiStandbyDescriptor is NULL\n" );
    ...
    if( saCsiDescriptorPtr->csiFlags == SA_AMF_CSI_ADD_ONE ){
        ...
        _arraySCsiAttribute = (*jniEnv)->NewObjectArray( jniEnv,
                                                         saCsiDescriptorPtr->csiAttr.number,
                                                         ClassCsiAttribute,
                                                         NULL );
        ...
        for( _idx = 0; _idx < saCsiDescriptorPtr->csiAttr.number; _idx++ ){
            _sCsiAttribute = JNU_CsiAttribute_create(
                                            jniEnv,
                                            &(saCsiDescriptorPtr->csiAttr.attr[_idx]) );
            if( _sCsiAttribute == NULL ){

                _TRACE2( "NATIVE ERROR: _sCsiAttribute[%d] is NULL\n", _idx );
    ...
    JNIEnv* jniEnv )
{
    ...
    // get IDs
    return JNU_CsiActiveDescriptor_initIDs_FromClass_OK( jniEnv, ClassCsiActiveDescriptor );
}
    ...
    jclass classCsiActiveDescriptor )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_CsiActiveDescriptor_initIDs_FromClass_OK(...)\n" );
    ...
    if( CID_CsiActiveDescriptor_constructor == NULL ){
        ...
        _TRACE2( "NATIVE ERROR: CID_CsiActiveDescriptor_constructor is NULL\n" );
    ...
    _TRACE2( "NATIVE: JNU_CsiActiveDescriptor_initIDs_FromClass_OK(...) returning normally\n" );
    ...
    const SaAmfCSIActiveDescriptorT* saCsiActiveDescriptorPtr )
{
    ...
    _TRACE2( "NATIVE: JNU_CsiActiveDescriptor_create(...) returning normally\n" );
    ...
    const SaAmfCSIActiveDescriptorT* saCsiActiveDescriptorPtr )
{
    ...
    _transitionDescriptor = JNU_TransitionDescriptor_getEnum( jniEnv,
                                      saCsiActiveDescriptorPtr->transitionDescriptor );
    ...
    _activeComponentNameString = JNU_newStringFromSaNameT( jniEnv,
                                               &(saCsiActiveDescriptorPtr->activeCompName) );
    ...
    _TRACE2( "NATIVE: JNU_CsiActiveDescriptor_set(...) returning normally\n" );
    ...
    jclass enumTransitionDescriptor )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_TransitionDescriptor_initIDs_FromClass_OK(...)\n" );
    ...
    _TRACE2( "NATIVE: JNU_TransitionDescriptor_initIDs_FromClass_OK(...) returning normally\n" );
    ...
    SaAmfCSITransitionDescriptorT saTransitionDescriptor )
{
    ...
    _TRACE2( "NATIVE: JNU_TransitionDescriptor_getEnum(...) returning normally\n" );
    ...
    JNIEnv* jniEnv )
{
    ...
    // get IDs
    return JNU_CsiStandbyDescriptor_initIDs_FromClass_OK( jniEnv, ClassCsiStandbyDescriptor );
}
    ...
    jclass classCsiStandbyDescriptor )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_CsiStandbyDescriptor_initIDs_FromClass_OK(...)\n" );
    ...
    if( CID_CsiStandbyDescriptor_constructor == NULL ){
        ...
        _TRACE2( "NATIVE ERROR: CID_CsiStandbyDescriptor_constructor is NULL\n" );
    ...
    _TRACE2( "NATIVE: JNU_CsiStandbyDescriptor_initIDs_FromClass_OK(...) returning normally\n" );
    ...
    const SaAmfCSIStandbyDescriptorT* saCsiStandbyDescriptorPtr )
{
    ...
    if( JNU_CsiStandbyDescriptor_set( jniEnv,
                                ...
                                saCsiStandbyDescriptorPtr ) != JNI_TRUE ){
        // TODO error handling
        return NULL; // exception thrown already...
    }


    _TRACE2( "NATIVE: JNU_CsiStandbyDescriptor_create(...) returning normally\n" );
    ...
    const SaAmfCSIStandbyDescriptorT* saCsiStandbyDescriptorPtr )
{
    ...
    // active Component name
    _activeComponentNameString = JNU_newStringFromSaNameT( jniEnv,
                                               &(saCsiStandbyDescriptorPtr->activeCompName) );
    if( _activeComponentNameString == NULL ){
        // TODO error handling
        return JNI_FALSE; // OutOfMemoryError thrown already...
    }
    ...
    _TRACE2( "NATIVE: JNU_CsiStandbyDescriptor_set(...) returning normally\n" );
...
jboolean JNU_HaState_initIDs_OK( JNIEnv* jniEnv )
{
    ...
    // get IDs
    return JNU_HaState_initIDs_FromClass_OK( jniEnv,
                                             EnumHaState );
    ...
    jclass enumHaState )
{
    ...
    _TRACE2( "NATIVE: JNU_HaState_initIDs_FromClass_OK(...) returning normally\n" );
...
jboolean JNU_CsiFlags_initIDs_OK( JNIEnv* jniEnv )
{
    ...
    // get IDs
    return JNU_CsiFlags_initIDs_FromClass_OK( jniEnv,
                                              EnumCsiFlags );
    ...
    jclass enumCsiFlags )
{
    ...
    _TRACE2( "NATIVE: JNU_CsiFlags_initIDs_FromClass_OK(...) returning normally\n" );
    ...
    jclass classCsiAttribute )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_CsiAttribute_initIDs_FromClass_OK(...)\n" );
    ...
    _TRACE2( "NATIVE: JNU_CsiAttribute_initIDs_FromClass_OK(...) returning normally\n" );
    ...
    const SaAmfCSIAttributeT* saCsiAttributePtr )
{
    ...
    _nameString = (*jniEnv)->NewStringUTF( jniEnv,
                                           (char *)saCsiAttributePtr->attrName );
    if( _nameString == NULL ){
        // TODO error handling
        return JNI_FALSE; // OutOfMemoryError thrown already...
    }
    ...
    _valueString = (*jniEnv)->NewStringUTF( jniEnv,
                                           (char *)saCsiAttributePtr->attrValue );
    ...
    jclass enumRecommendedRecovery )
{
    ...
    _TRACE2( "NATIVE: Executing JNU_RecommendedRecovery_initIDs_FromClass_OK(...)\n" );
    ...
    _TRACE2( "NATIVE: JNU_RecommendedRecovery_initIDs_FromClass_OK(...) returning normally\n" );
