...
*****************************************************************************/                                                                             
void
ncs_mbcsv_start_timer( PEER_INST *peer, uns8 timer_type)
{
   NCS_MBCSV_TMR *tmr;
...
*****************************************************************************/                                                                            
void
ncs_mbcsv_stop_timer( PEER_INST *peer, uns32 timer_type)
{
   NCS_MBCSV_TMR *tmr;
...
*****************************************************************************/                                                                            
void
ncs_mbcsv_stop_all_timers(PEER_INST *peer)
{
...
void                                                                           
ncs_mbcsv_tmr_expiry (void *uarg)
{
   NCS_MBCSV_TMR   *tmr;                                                              
   PEER_INST       *peer;                                                              
   uns8        type;
...
*****************************************************************************/
void
ncs_mbcsv_send_cold_sync_tmr( PEER_INST *peer, MBCSV_EVT *evt)
{
   uns32 rc;
...
*****************************************************************************/
void
ncs_mbcsv_send_warm_sync_tmr( PEER_INST *peer, MBCSV_EVT *evt)
{
   uns32 rc;
...
*****************************************************************************/
void
ncs_mbcsv_send_data_req_tmr( PEER_INST *peer, MBCSV_EVT *evt)
{
   uns32 rc;
   /* Tell the redundant entity about the timer expiration */
   /* It can do smart things - if it cares */
...
*****************************************************************************/
void
ncs_mbcsv_transmit_tmr( PEER_INST *peer, MBCSV_EVT *evt)
{
