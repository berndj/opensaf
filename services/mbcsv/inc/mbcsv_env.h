...
EXTERN_C uns32 mbcsv_send_notify_msg(uns32 msg_dest,
                            CKPT_INST *ckpt_inst, MBCSV_REG *mbc_inst, NCSCONTEXT i_msg);
EXTERN_C uns32 mbcsv_send_data_req(NCS_UBAID *uba, 
                    CKPT_INST *ckpt_inst, MBCSV_REG *mbc_inst);
EXTERN_C uns32 mbcsv_send_client_msg(PEER_INST *peer, uns8 evt, uns32 action);
EXTERN_C uns32 ncs_mbcsv_encode_message(PEER_INST *peer, MBCSV_EVT *evt_msg,
                               uns8 *event, NCS_UBAID *uba);
