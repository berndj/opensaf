...
static uns32 avd_entire_data_update(AVD_CL_CB *cb, 
                                    NCS_MBCSV_CB_ENC *enc,
                                    NCS_BOOL   c_sync);

/* Declaration of static cold sync encode functions */
static uns32  avsv_encode_cold_sync_rsp_avd_cb_config(AVD_CL_CB *cb,
                                                      NCS_MBCSV_CB_ENC *enc, 
                                                      uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_avnd_config(AVD_CL_CB *cb,
                                                        NCS_MBCSV_CB_ENC *enc,
                                                        uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_sg_config(AVD_CL_CB *cb,
                                                      NCS_MBCSV_CB_ENC *enc,
                                                      uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_su_config(AVD_CL_CB *cb, 
                                                      NCS_MBCSV_CB_ENC *enc, 
                                                      uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_si_config(AVD_CL_CB *cb,
                                                      NCS_MBCSV_CB_ENC *enc,
                                                      uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_sg_su_oper_list(AVD_CL_CB *cb,
                                                            NCS_MBCSV_CB_ENC *enc,
                                                            uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_sg_admin_si(AVD_CL_CB *cb,
                                                        NCS_MBCSV_CB_ENC *enc,
                                                        uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_comp_config(AVD_CL_CB *cb, 
                                                        NCS_MBCSV_CB_ENC *enc, 
                                                        uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_csi_config(AVD_CL_CB *cb,
                                                       NCS_MBCSV_CB_ENC *enc,
                                                       uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_su_si_rel(AVD_CL_CB *cb,
                                                      NCS_MBCSV_CB_ENC *enc, 
                                                      uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_hlt_config(AVD_CL_CB *cb, 
                                                       NCS_MBCSV_CB_ENC *enc,
                                                       uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_async_updt_cnt(AVD_CL_CB *cb, 
                                                       NCS_MBCSV_CB_ENC *enc, 
                                                       uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_sus_per_si_rank_config(AVD_CL_CB *cb,
                                                       NCS_MBCSV_CB_ENC *enc, 
                                                       uns32 *num_of_obj);
static uns32  avsv_encode_cold_sync_rsp_avd_comp_cs_type_config(AVD_CL_CB *cb,
                                                       NCS_MBCSV_CB_ENC *enc, 
                                                       uns32 *num_of_obj);
...
static uns32  avsv_encode_su_oper_list(AVD_CL_CB *cb, AVD_SG *sg,
                          NCS_MBCSV_CB_ENC *enc);
static uns32  avsv_encode_cold_sync_rsp_avd_si_dep_config(AVD_CL_CB *cb,
                                                      NCS_MBCSV_CB_ENC *enc,
                                                      uns32 *num_of_obj);
/*
 ...
 */
const AVSV_ENCODE_CKPT_DATA_FUNC_PTR 
          avsv_enc_ckpt_data_func_list[AVSV_CKPT_MSG_MAX] = 
{
 ...
 */
const AVSV_ENCODE_COLD_SYNC_RSP_DATA_FUNC_PTR 
          avsv_enc_cold_sync_rsp_data_func_list[] = 
{
...
static uns32  avsv_encode_ckpt_avd_avnd_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_sg_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_su_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32 avsv_encode_ckpt_avd_si_dep_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si_dep, &enc->io_uba, 
                EDP_OP_TYPE_ENC,(AVD_SI_SI_DEP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si_dep, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI_SI_DEP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_si_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_SI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_sg_admin_si(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_RMV:
       ...
       */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI*)((AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)))->admin_si, &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_comp_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_csi_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_UPDATE:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_csi, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_CSI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_csi, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_CSI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 1, 1);
      break;
...
static uns32  avsv_encode_ckpt_avd_hlt_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_ADD:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avd_hlt, &enc->io_uba, 
                EDP_OP_TYPE_ENC, (AVD_HLT*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avd_hlt, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_HLT*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 3, 1, 2, 3);
      break;
...
static uns32  avsv_encode_ckpt_avnd_node_up_info(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 6,1,2,4,5,6,7);
...
static uns32  avsv_encode_ckpt_avnd_su_admin_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 8);
...
static uns32  avsv_encode_ckpt_avnd_oper_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 9);
...
static uns32  avsv_encode_ckpt_avnd_node_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 11);
...
static uns32  avsv_encode_ckpt_avnd_rcv_msg_id(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 15);
...
static uns32  avsv_encode_ckpt_avnd_snd_msg_id(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 16);
...
static uns32  avsv_encode_ckpt_avnd_avm_oper_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_avnd_config, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_AVND*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 17);
...
static uns32  avsv_encode_ckpt_sg_admin_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 10);
...
static uns32  avsv_encode_ckpt_sg_adjust_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 11);
...
static uns32  avsv_encode_ckpt_sg_su_assigned_num(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 18);
...
static uns32  avsv_encode_ckpt_sg_su_spare_num(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 19);
...
static uns32  avsv_encode_ckpt_sg_su_uninst_num(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 20);
...
static uns32  avsv_encode_ckpt_sg_fsm_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sg, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SG*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 21);
...
static uns32  avsv_encode_ckpt_su_si_curr_active(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 6);
...
static uns32  avsv_encode_ckpt_su_si_curr_stby(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 7);
...
static uns32  avsv_encode_ckpt_su_admin_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 9);
...
static uns32  avsv_encode_ckpt_su_term_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 10);
...
static uns32  avsv_encode_ckpt_su_switch(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 11);
...
static uns32  avsv_encode_ckpt_su_oper_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 12);
...
static uns32  avsv_encode_ckpt_su_pres_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 13);
...
static uns32  avsv_encode_ckpt_su_rediness_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 15);
...
static uns32  avsv_encode_ckpt_su_act_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 17);
...
static uns32  avsv_encode_ckpt_su_preinstan(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SU*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 18);
...
static uns32  avsv_encode_ckpt_si_su_curr_active(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 4);
...
static uns32  avsv_encode_ckpt_si_su_curr_stby(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 5);
...
static uns32  avsv_encode_ckpt_si_switch(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 8);
...
static uns32  avsv_encode_ckpt_si_admin_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_si, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SI*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 9);
...
static uns32  avsv_encode_ckpt_comp_proxy_comp_name_net(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 23);
...
static uns32  avsv_encode_ckpt_comp_curr_num_csi_actv(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 32);
...
static uns32  avsv_encode_ckpt_comp_curr_num_csi_stby(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 33);
...
static uns32  avsv_encode_ckpt_comp_oper_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 34);
...
static uns32  avsv_encode_ckpt_comp_pres_state(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 35);
...
static uns32  avsv_encode_ckpt_comp_restart_count(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 36);
                          ...
                          NCS_MBCSV_CB_ENC *enc)
{
   ...
   {
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_su, &enc->io_uba, 
                EDP_OP_TYPE_ENC, oper_list_ptr->su, &ederror, enc->i_peer_version, 1,1);
...
static uns32  avsv_encode_ckpt_avd_sus_per_si_rank_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_ADD:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sus_per_si_rank, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SUS_PER_SI_RANK *)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), 
   ...
   case NCS_MBCSV_ACT_RMV:
      ...
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_sus_per_si_rank, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_SUS_PER_SI_RANK *)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 2);
      break;
...
static uns32  avsv_encode_ckpt_avd_comp_cs_type_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_ADD:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp_cs_type, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP_CS_TYPE *)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_comp_cs_type, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_COMP_CS_TYPE *)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 2);
      break;
...
static uns32  avsv_encode_ckpt_avd_cs_type_param_config(AVD_CL_CB *cb, NCS_MBCSV_CB_ENC *enc)
{
   ...
   case NCS_MBCSV_ACT_ADD:
      ...
      status = m_NCS_EDU_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_cs_type_param, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_CS_TYPE_PARAM*)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version);
      break;

   case NCS_MBCSV_ACT_RMV:
      /* Send only key information */
      status = m_NCS_EDU_SEL_VER_EXEC(&cb->edu_hdl, avsv_edp_ckpt_msg_cs_type_param, &enc->io_uba,
                EDP_OP_TYPE_ENC, (AVD_CS_TYPE_PARAM *)(NCS_INT64_TO_PTR_CAST(enc->io_reo_hdl)), &ederror, enc->i_peer_version, 2, 1, 2);
      break;
