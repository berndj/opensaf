                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_cb_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->init_state, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->cluster_init_time, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SAUINT64T, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->cluster_view_number, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->rcv_hb_intvl, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->snd_hb_intvl, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->amf_init_intvl, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_CL_CB*)0)->nodes_exit_cnt, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_hlt_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (uns32)&((AVD_HLT*)0)->key_name.comp_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (uns32)&((AVD_HLT *)0)->key_name.key_len_net, 4, NULL},
        {EDU_EXEC, ncs_edp_saamfhealthcheckkeyt, 0, 0, 0,
            (uns32)&((AVD_HLT*)0)->key_name.name, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_HLT*)0)->period, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_HLT*)0)->max_duration, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_HLT*)0)->row_status, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_avnd_rules[ ] = {
        ...
        {EDU_EXEC, m_NCS_EDP_SACLMNODEIDT, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_info.nodeId, 0, NULL},
        {EDU_EXEC, ncs_edp_saclmnodeaddresst, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_info.nodeAddress, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_info.nodeName, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_info.member, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_info.bootTimestamp, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SAUINT64T, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_info.initialViewNumber, 0, NULL},
        {EDU_EXEC, ncs_edp_mds_dest, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->adest, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->su_admin_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->oper_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->row_status, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->node_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->type, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->su_failover_prob, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->su_failover_max, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->rcv_msg_id, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->snd_msg_id, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_AVND*)0)->avm_oper_state, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_sg_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_redundancy_model, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_failback, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->pref_num_active_su, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->pre_num_standby_su, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->pref_num_insvc_su, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->pref_num_assigned_su, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_max_active, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_max_standby, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->admin_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->adjust_state, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->sg_ncs_spec, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->row_status, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->comp_restart_prob, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->comp_restart_max, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_restart_prob, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_restart_max, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_assigned_num, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_spare_num, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->su_uninst_num, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SG*)0)->sg_fsm_state, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_su_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->rank, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->num_of_comp, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->si_max_active, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->si_max_standby, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->si_curr_active, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->si_curr_standby, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->is_su_failover, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->admin_state, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->term_state, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->su_switch, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->oper_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->pres_state, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->sg_name, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->readiness_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->row_status, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->su_act_state, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SU*)0)->su_preinstan, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_si_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->rank, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->su_config_per_si, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->su_curr_active, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->su_curr_standby, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->max_num_csi, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->num_csi, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->si_switch, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->admin_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->row_status, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, 
            (uns32)&((AVD_SI*)0)->sg_name, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_comp_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.name_net, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SAAMFCOMPONENTCAPABILITYMODELT, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.cap, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.category, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.init_len, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.init_info, AVSV_MISC_STR_MAX_SIZE, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.init_time, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.term_len, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.term_info, AVSV_MISC_STR_MAX_SIZE, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.term_time, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.clean_len, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.clean_info, AVSV_MISC_STR_MAX_SIZE, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.clean_time, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.amstart_len, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.amstart_info, AVSV_MISC_STR_MAX_SIZE, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.amstart_time, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.amstop_len, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.amstop_info, AVSV_MISC_STR_MAX_SIZE, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.amstop_time, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.inst_level, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SAAMFRECOMMENDEDRECOVERYT, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.def_recvr, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.max_num_inst, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.comp_restart, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->proxy_comp_name_net, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->inst_retry_delay, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->nodefail_cleanfail, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->max_num_inst_delay, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.max_num_amstart, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.max_num_amstop, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->row_status, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->max_num_csi_actv, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->max_num_csi_stdby, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->curr_num_csi_actv, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->curr_num_csi_stdby, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->oper_state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->pres_state, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->restart_cnt, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((AVD_COMP*)0)->comp_info.am_enable, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
            (uns32)&((AVD_COMP*)0)->comp_info.terminate_callback_timeout, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
            (uns32)&((AVD_COMP*)0)->comp_info.csi_set_callback_timeout, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
            (uns32)&((AVD_COMP*)0)->comp_info.quiescing_complete_timeout, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
            (uns32)&((AVD_COMP*)0)->comp_info.csi_rmv_callback_timeout, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
            (uns32)&((AVD_COMP*)0)->comp_info.proxied_inst_callback_timeout, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SATIMET, 0, 0, 0,
            (uns32)&((AVD_COMP*)0)->comp_info.proxied_clean_callback_timeout, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_csi_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVD_CSI*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0, 
            (uns32)&((AVD_CSI*)0)->csi_type, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_CSI*)0)->rank, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVD_CSI*)0)->row_status, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVD_CSI*)0)->num_active_params, 0, NULL},
        {EDU_EXEC, avsv_edp_ckpt_msg_csi_param_list, EDQ_POINTER, 0, 0, 
            (uns32)&((AVD_CSI*)0)->list_param, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_csi_param_rules[ ] = {
         ...
         */
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
            (uns32)&((AVD_CSI_PARAM*)0)->param.name, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
            (uns32)&((AVD_CSI_PARAM*)0)->param.value, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVD_CSI_PARAM*)0)->row_status, 0, NULL},

        {EDU_TEST_LL_PTR, avsv_edp_ckpt_msg_csi_param_list, 0, 0, 0, 
            (uns32)&((AVD_CSI_PARAM*)0)->param_next, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_su_si_rel_rules[ ] = {
         ...
         */
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVSV_SU_SI_REL_CKPT_MSG*)0)->su_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (uns32)&((AVSV_SU_SI_REL_CKPT_MSG*)0)->si_name_net, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SAAMFHASTATET, 0, 0, 0, 
            (uns32)&((AVSV_SU_SI_REL_CKPT_MSG*)0)->state, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0, 
            (uns32)&((AVSV_SU_SI_REL_CKPT_MSG*)0)->fsm, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_async_updt_cnt_rules[ ] = {
         ...
         */
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->cb_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->avnd_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->sg_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->su_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->si_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->sg_su_oprlist_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->sg_admin_si_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->su_si_rel_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->comp_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->csi_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->csi_parm_list_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->hlt_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->sus_per_si_rank_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->comp_cs_type_sup_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVSV_ASYNC_UPDT_CNT*)0)->cs_type_param_updt, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_sus_per_si_rank_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (uns32)&((AVD_SUS_PER_SI_RANK*)0)->indx.si_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVD_SUS_PER_SI_RANK*)0)->indx.su_rank_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
            (uns32)&((AVD_SUS_PER_SI_RANK*)0)->su_name, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVD_SUS_PER_SI_RANK*)0)->row_status, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_comp_cs_type_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (uns32)&((AVD_COMP_CS_TYPE*)0)->indx.comp_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (uns32)&((AVD_COMP_CS_TYPE *)0)->indx.csi_type_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVD_COMP_CS_TYPE*)0)->row_status, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_ckpt_msg_cs_type_param_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (uns32)&((AVD_CS_TYPE_PARAM*)0)->indx.type_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (uns32)&((AVD_CS_TYPE_PARAM *)0)->indx.param_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVD_CS_TYPE_PARAM*)0)->row_status, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
