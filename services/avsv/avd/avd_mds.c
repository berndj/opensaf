   ...
   case MDS_CALLBACK_COPY:
      {
         ...
         {
            info->info.cpy.o_msg_fmt_ver = avd_bam_msg_fmt_map_table[info->info.cpy.i_rem_svc_pvt_ver - 1];
         ...
         {
            info->info.cpy.o_msg_fmt_ver = avd_avm_msg_fmt_map_table[info->info.cpy.i_rem_svc_pvt_ver - 1];
         ...
         {
            info->info.cpy.o_msg_fmt_ver = avd_avnd_msg_fmt_map_table[info->info.cpy.i_rem_svc_pvt_ver - 1];
