                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_hlt_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (long)&((AVND_HC*)0)->key.comp_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (long)&((AVND_HC *)0)->key.key_len_net, 4, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avnd_ckpt_msg_hlt_rules, struct_ptr, 
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_su_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_SU*)0)->name_net, 0, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avnd_ckpt_msg_su_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_su_si_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_SU_SI_REC*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_SU_SI_REC*)0)->su_name_net, 0, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avnd_ckpt_msg_su_si_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_comp_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP*)0)->proxy_comp_name_net, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avnd_ckpt_msg_comp_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_csi_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP_CSI_REC*)0)->name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (long)&((AVND_COMP_CSI_REC*)0)->rank, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP_CSI_REC*)0)->act_comp_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP_CSI_REC*)0)->comp_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP_CSI_REC*)0)->si_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0, 
            (long)&((AVND_COMP_CSI_REC*)0)->su_name_net, 0, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avnd_ckpt_msg_csi_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_siq_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (long)&((AVND_SU_SI_PARAM*)0)->su_name_net, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (long)&((AVND_SU_SI_PARAM*)0)->si_name_net, 0, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, avnd_ckpt_msg_siq_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_comp_hc_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (long)&((AVND_COMP_HC_REC*)0)->comp_name_net, 0, NULL},
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avnd_ckpt_msg_comp_cbk_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_sanamet_net, 0, 0, 0,
            (long)&((AVND_COMP_CBK*)0)->comp_name_net, 0, NULL},
