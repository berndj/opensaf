...
EXTERN_C uns32 avd_snd_hlt_msg(struct  cl_cb_tag *cb,
                               struct avd_avnd_tag *avnd,
                               struct avd_hlt_tag *hlt_chk,
                               NCS_BOOL fail_over,
                               NCS_BOOL is_ext);
...
EXTERN_C uns32 avd_snd_pg_resp_msg(struct cl_cb_tag *, struct avd_avnd_tag *, struct avd_csi_tag *, AVSV_N2D_PG_TRACK_ACT_MSG_INFO *);
EXTERN_C uns32 avd_snd_pg_upd_msg(struct cl_cb_tag *, struct avd_avnd_tag *, 
                                  struct avd_comp_csi_rel_tag *,
...
EXTERN_C uns32 avd_snd_comp_validation_resp(struct cl_cb_tag *cb, struct avd_avnd_tag *avnd, struct avd_cmp_tag *comp_ptr, AVD_DND_MSG *n2d_msg);
