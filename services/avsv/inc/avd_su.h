...
EXTERN_C uns32 saamfsutableentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, 
                                  NCSCONTEXT* data);
EXTERN_C uns32 saamfsutableentry_extract(NCSMIB_PARAM_VAL* param, 
                              NCSMIB_VAR_INFO* var_info, NCSCONTEXT data,
                              NCSCONTEXT buffer);
EXTERN_C uns32 saamfsutableentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, 
...
EXTERN_C uns32 ncssutableentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg, 
                                  NCSCONTEXT* data);
EXTERN_C uns32 ncssutableentry_extract(NCSMIB_PARAM_VAL* param, 
                              NCSMIB_VAR_INFO* var_info, NCSCONTEXT data,
                              NCSCONTEXT buffer);
EXTERN_C uns32 ncssutableentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg, 
                         NCSMIB_VAR_INFO* var_info, NCS_BOOL test_flag);
...
EXTERN_C AVD_SG_SU_RANK * avd_sg_su_rank_struc_find(AVD_CL_CB *cb,
                                        AVD_SG_SU_RANK_INDX indx);

EXTERN_C AVD_SG_SU_RANK * avd_sg_su_rank_struc_find_next(AVD_CL_CB *cb,
                                             AVD_SG_SU_RANK_INDX indx);

EXTERN_C uns32 avd_sg_su_rank_del_row(AVD_CL_CB *cb, AVD_SU *su);


EXTERN_C uns32 saamfsgsurankentry_get(NCSCONTEXT cb, NCSMIB_ARG *arg,
                                     NCSCONTEXT* data);
EXTERN_C uns32 saamfsgsurankentry_extract(NCSMIB_PARAM_VAL* param,
                                     NCSMIB_VAR_INFO* var_info, NCSCONTEXT data,
                                     NCSCONTEXT buffer);
EXTERN_C uns32 saamfsgsurankentry_set(NCSCONTEXT cb, NCSMIB_ARG *arg,
                                     NCSMIB_VAR_INFO* var_info, NCS_BOOL test_flag);
