...
EXTERN_C uns32 avsv_set_ckpt_role(struct  cl_cb_tag *cb,
                         uns32    role);
EXTERN_C uns32 avsv_mbcsv_dispatch(struct  cl_cb_tag *cb,
                          uns32      flag);
...
EXTERN_C uns32 avsv_mbcsv_obj_set(struct  cl_cb_tag *cb,
                         uns32  obj, uns32 val);
