                               ...
                               )
{
   ...
   EDU_INST_SET avm_ckpt_msg_valid_info_rules[] = {
      ...
      {EDU_EXEC, avm_edp_ent_desc_name, 0, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->desc_name), 0 , NULL }, 

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->entity_type),      0, NULL  },

      {EDU_EXEC, avm_edp_inv_data, 0, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->inv_data), 0 , NULL }, 

      {EDU_EXEC, ncs_edp_int, 0, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->is_node),      0, NULL  },

      {EDU_EXEC, ncs_edp_int, 0, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->is_fru),      0, NULL  },

      {EDU_EXEC, avm_edp_ent_valid_location, EDQ_ARRAY, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->location),  MAX_POSSIBLE_PARENTS, NULL  },

      {EDU_EXEC, ncs_edp_uns32,   0, 0, 0,
         (uns32)&((AVM_VALID_INFO_NULL)->parent_cnt), 0, NULL },
                    ...
                    )
{
   ...
   EDU_MSG_VERSION base_ver = AVM_MBCSV_SUB_PART_VERSION; 
   ...
   EDU_INST_SET avm_ckpt_msg_ent_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_int, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->entity_type), 0 , NULL }, 

      {EDU_EXEC, avm_edp_entity_path, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->entity_path), 0, NULL  },

      {EDU_EXEC, avm_edp_entity_path_str, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->ep_str),  0, NULL},

      {EDU_EXEC, ncs_edp_int, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->is_node),     0, NULL  },

      {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->node_name),   0, NULL  },

      {EDU_EXEC, ncs_edp_uns32,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->act_policy),     0, NULL },

      {EDU_EXEC, avm_edp_ent_info_list, EDQ_POINTER, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->dependents),   0, NULL  },

      {EDU_EXEC, avm_edp_entity_path_str, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->dep_ep_str),  0, NULL},

      {EDU_EXEC, ncs_edp_int,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->depends_on_valid), 0, NULL },

      {EDU_EXEC, ncs_edp_int,  0,  0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->current_state), 0, NULL },

      {EDU_EXEC, ncs_edp_int,  0,  0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->previous_state), 0, NULL },

      {EDU_EXEC, ncs_edp_int,  0,  0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->previous_diff_state), 0, NULL }, 

      {EDU_EXEC, ncs_edp_uns32,  0,  0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->sensor_assert), 0, NULL },

      {EDU_EXEC, ncs_edp_uns32,  0,  0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->sensor_count),  0, NULL },

      {EDU_EXEC, avm_edp_sensor_event, EDQ_ARRAY, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->sensors), AVM_MAX_SENSOR_COUNT, NULL },

      {EDU_EXEC, avm_edp_ent_desc_name,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->desc_name),     0, NULL },

      {EDU_EXEC, avm_edp_ent_desc_name,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->parent_desc_name),     0, NULL },

      {EDU_EXEC, ncs_edp_uns32,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->adm_shutdown),     0, NULL },

      {EDU_EXEC, ncs_edp_uns32,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->adm_lock),     0, NULL },

      {EDU_EXEC, ncs_edp_uns32,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->adm_req),     0, NULL },

      {EDU_EXEC, ncs_edp_uns32,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->row_status),    0, NULL },

      {EDU_EXEC, avm_edp_ckpt_msg_dhcp_conf,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->dhcp_serv_conf),    0, NULL },

      {EDU_EXEC, avm_edp_ckpt_msg_dhcp_state,   0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->dhcp_serv_conf),    0, NULL },

      {EDU_EXEC, ncs_edp_int, 0, 0, 0,
         (uns32)&((AVM_ENT_INFO_NULL)->is_fru),     0, NULL  },

      {EDU_VER_GE, NULL,   0, 0, 2, 0, 0, (NCSCONTEXT)&base_ver},
                          ...
                          )    
{
   ...
   EDU_INST_SET hpi_text_buff_rules[] = {
         ...
         {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((SaHpiTextBufferT*)0)->DataType, 0 , NULL},
         {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((SaHpiTextBufferT*)0)->Language, 0 , NULL},
         {EDU_EXEC, ncs_edp_uns8,  0, 0, 0,
            (uns32)&((SaHpiTextBufferT*)0)->DataLength, 0, NULL},
         {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (uns32)&((SaHpiTextBufferT*)0)->Data, SAHPI_MAX_TEXT_BUFFER_LENGTH, NULL},
         {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
   };
                    ...
                    )    
{
   ...
   EDU_INST_SET ncs_edp_sensor_event_rules[] = {
       ...
       sizeof(AVM_SENSOR_EVENT_T), 0, NULL},
         {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVM_SENSOR_EVENT_T*)0)->SensorNum, 0 , NULL},
         {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVM_SENSOR_EVENT_T*)0)->SensorType, 0 , NULL},
         {EDU_EXEC, ncs_edp_int,  0, 0, 0,
            (uns32)&((AVM_SENSOR_EVENT_T*)0)->EventCategory, 0, NULL},
         {EDU_EXEC, ncs_edp_int, 0, 0, 0,
            (uns32)&((AVM_SENSOR_EVENT_T*)0)->sensor_assert, 0, NULL},
         {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
   };
                       ...
                       )
{
   ...
   EDU_INST_SET avm_ckpt_msg_evt_id_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_EVT_ID_T*)0)->evt_id, 0 , NULL }, 
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_EVT_ID_T*)0)->src, 0, NULL  },
              ...
              )
{
   ...
   EDU_INST_SET avm_ckpt_entity_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_int, 0, 0, 0,
         (uns32)&((SaHpiEntityT*)0)->EntityType, 0 , NULL }, 
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
#ifdef HPI_A
         (uns32)&((SaHpiEntityT*)0)->EntityInstance, 0, NULL  },
#else
         (uns32)&((SaHpiEntityT*)0)->EntityLocation, 0, NULL  },
#endif
                               ...
                               )
{
   ...
   uns16 base_ver = AVM_MBCSV_SUB_PART_VERSION; 
   ...
   EDU_INST_SET avm_ckpt_async_updt_cnt_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_updt, 0 , NULL }, 

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_sensor_updt, 0, NULL  },

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
           (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_dep_updt, 0, NULL},

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
           (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_adm_op_updt, 0, NULL},

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->evt_id_updt, 0, NULL  },

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_cfg_updt, 0 , NULL }, 

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_dhconf_updt, 0, NULL  },

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_dhstate_updt, 0, NULL  },

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->hlt_status_updt, 0, NULL  },

      {EDU_VER_GE, NULL,   0, 0, 2, 0, 0,(NCSCONTEXT)&base_ver},

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ASYNC_CNT_T*)0)->ent_upgd_state_updt, 0, NULL  },
                ...
                )    
{
   ...
   EDU_INST_SET avm_edp_inv_data_rules[] = {
         ...
         {EDU_EXEC, avm_edp_inv_data_text_buff, 0, 0, 0,
            (uns32)&((AVM_INV_DATA_T*)0)->product_name, 0 , NULL},

         {EDU_EXEC, avm_edp_inv_data_text_buff, 0, 0, 0,
            (uns32)&((AVM_INV_DATA_T*)0)->product_version, 0 , NULL},
                    ...
                    )    
{
   ...
   EDU_INST_SET avm_edp_ent_desc_name_rules[] = {
         ...
         {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVM_ENT_DESC_NAME_T*)0)->length, 0 , NULL},

         {EDU_EXEC,ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (uns32)&((AVM_ENT_DESC_NAME_T*)0)->name, NCS_MAX_INDEX_LEN, NULL},
                          ...
                          )    
{
   ...
   EDU_INST_SET avm_edp_ent_valid_location_rules[] = {
         ...
         {EDU_EXEC, avm_edp_ent_desc_name, 0, 0, 0,
            (uns32)&((AVM_ENT_VALID_LOCATION_T*)0)->parent, 0 , NULL},

         {EDU_EXEC, avm_edp_valid_location_range, EDQ_ARRAY, 0, 0,
            (uns32)&((AVM_ENT_VALID_LOCATION_T*)0)->range, AVM_MAX_LOCATION_RANGE, NULL},

         {EDU_EXEC,ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVM_ENT_VALID_LOCATION_T*)0)->count, 0 , NULL},
                            ...
                            )    
{
   ...
   EDU_INST_SET avm_edp_valid_location_range_rules[] = {
         ...
         {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVM_VALID_LOC_RANGE_T*)0)->min, 0 , NULL},

         {EDU_EXEC,ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVM_VALID_LOC_RANGE_T*)0)->max, 0, NULL},
                     ...
                     )    
{
   ...
   EDU_INST_SET avm_edp_ent_info_list_rules[] = {
         ...
         {EDU_EXEC, avm_edp_entity_path_str, EDQ_POINTER, 0, 0,
            (uns32)&((AVM_ENT_INFO_LIST_T*)0)->ep_str, 0 , NULL},

         {EDU_TEST_LL_PTR, avm_edp_ent_info_list, 0, 0, 0,
            (uns32)&((AVM_ENT_INFO_LIST_T*)0)->next, 0, NULL},
                       ...
                       )
{
   ...
   EDU_INST_SET avm_ckpt_entity_path_str_rules[] = {
       ...
       {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((AVM_ENT_PATH_STR_T*)0)->length, 0, NULL},

       {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (uns32)&((AVM_ENT_PATH_STR_T*)0)->name, AVM_MAX_INDEX_LEN, NULL },
                   ...
                   )
{
   ...
   EDU_INST_SET avm_ckpt_entity_path_rules[] = {
       ...
       {EDU_EXEC, avm_edp_entity, EDQ_ARRAY, 0, 0,
            (uns32)&((SaHpiEntityPathT*)0)->Entry, SAHPI_MAX_ENTITY_PATH, NULL },
                    ...
                    )
{
   ...
   EDU_INST_SET avm_ckpt_msg_dhcp_conf_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->mac_address), (AVM_MAX_MAC_ENTRIES * AVM_MAC_DATA_LEN), NULL  },

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->net_boot),     0, NULL  },

      {EDU_EXEC, ncs_edp_uns8,   EDQ_ARRAY, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->tftp_serve_ip),     4, NULL },

      {EDU_EXEC, avm_edp_ent_dhconf_name_type, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->pref_label),   0, NULL  },

      {EDU_EXEC, avm_edp_ent_per_label_conf, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->label1),   0, NULL  },

      {EDU_EXEC, avm_edp_ent_per_label_conf, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->label2),   0, NULL  },
...
#else
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->def_label_num),     0, NULL  },
#endif /* 0 */

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->default_chg),   0, NULL  },

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->upgd_prgs),   0, NULL  },
...
#else
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->cur_act_label_num),     0, NULL  },
#endif /* 0 */
                   ...
                   )
{
   ...
   EDU_INST_SET avm_ckpt_entity_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
         (uns32)&((AVM_DHCP_CONF_NAME_TYPE*)0)->name, AVM_NAME_STR_LENGTH , NULL }, 

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_DHCP_CONF_NAME_TYPE*)0)->length, 0, NULL  },
                   ...
                   )
{
   ...
   EDU_INST_SET avm_ckpt_entity_rules[] = {
      ...
      {EDU_EXEC, avm_edp_ent_dhconf_name_type, 0, 0, 0,
         (uns32)&((AVM_PER_LABEL_CONF*)0)->name, 0 , NULL }, 

      {EDU_EXEC, avm_edp_ent_dhconf_name_type, 0, 0, 0,
         (uns32)&((AVM_PER_LABEL_CONF*)0)->file_name, 0 , NULL }, 

      {EDU_EXEC, avm_edp_ent_dhconf_name_type, 0, 0, 0,
         (uns32)&((AVM_PER_LABEL_CONF*)0)->sw_version, 0 , NULL }, 

      {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
         (uns32)&((AVM_PER_LABEL_CONF*)0)->install_time, AVM_TIME_STR_LEN , NULL }, 

      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_PER_LABEL_CONF*)0)->conf_chg, 0 , NULL }, 
                   ...
                   )
{
   ...
   EDU_INST_SET avm_ckpt_entity_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_PER_LABEL_CONF*)0)->status, 0 , NULL }, 
                               ...
                               )
{
   ...
   EDU_INST_SET avm_ckpt_hlt_status_rules[] = {
      ...
      {EDU_EXEC, ncs_edp_uns32,   EDQ_ARRAY, 0, 0,
         (uns32)((AVM_CB_T *)0)->hlt_status,     4, NULL },
                    ...
                    )
{
   ...
   EDU_INST_SET avm_ckpt_msg_upgd_state_rules[] = {
      ...
      {EDU_START, avm_edp_ckpt_msg_upgd_state, 0, 0, 0,
           sizeof(AVM_ENT_DHCP_CONF), 0, NULL},
      {EDU_EXEC, avm_edp_ent_dhconf_name_type, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->ipmc_helper_node), 0, NULL},
      {EDU_EXEC, avm_edp_entity_path_str, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->ipmc_helper_ent_path), 0, NULL},
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->upgrade_type), 0, NULL},
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->ipmb_addr), 0, NULL},
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->ipmc_upgd_state), 0, NULL},
      {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->pld_bld_ipmc_status), 0, NULL},
      {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->pld_rtm_ipmc_status), 0, NULL},
      {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
         (uns32)&((AVM_ENT_DHCP_CONF_NULL)->bios_upgd_state), 0, NULL},
      {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
   };
