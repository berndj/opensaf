   ...
   switch(arg->req.info.set_req.i_param_val.i_param_id)
   {
      ...
      case ncsAvmEntNetBoot_ID:
      {
         ...
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntNetBoot_ID played back to: %d ",ent_info->ep_str.name,
                                                                                            ent_info->dhcp_serv_conf.net_boot);
...

      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            {
               snprintf(logbuf,sizeof(logbuf)-1, "AVM-SSU: Payload blade %s : ncsAvmEntDHCPConfPrefLabel_ID playback failed.. not matching to any label",
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfPrefLabel_ID played back to: %s ",ent_info->ep_str.name,
            ...
            {
               snprintf(logbuf,sizeof(logbuf)-1, "AVM-SSU: Payload blade %s : pss_curr_label:%s not matching to any label",
         ...
         if (ent_info->dhcp_serv_conf.default_chg == TRUE)
         {
            ckpt_dhstate = TRUE;
            ckpt_dhconf = TRUE;
            snprintf(logbuf,sizeof(logbuf)-1, "AVM-SSU: Payload blade %s : ncsAvmEntDHCPConfPrefLabel SET to: %s",
      ...
      case ncsAvmEntDHCPConfLabel1Name_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel1Name playedback to: %s ",
         ...
         ckpt_dhconf = TRUE;
         snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel1Name SET to %s",
                               ent_info->ep_str.name,ent_info->dhcp_serv_conf.label1.name.name);
         m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
      ...
      case ncsAvmEntDHCPConfFileNameLabel1_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfFileNameLabel1 played back to: %s ",
         ...
         m_AVM_SET_NAME(ent_info->dhcp_serv_conf.label1.file_name,
            arg->req.info.set_req.i_param_val);
         ckpt_dhconf = TRUE;
         snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfFileNameLabel1 SET to %s",
                              ent_info->ep_str.name,ent_info->dhcp_serv_conf.label1.file_name.name);
         m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
      ...
      case ncsAvmEntDHCPConfLabel2Name_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel2Name played back to: %s ",
...
/* Should be reversed */
         ...
         m_AVM_SET_NAME(ent_info->dhcp_serv_conf.label2.name,
            arg->req.info.set_req.i_param_val);
         ckpt_dhconf = TRUE;
         snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel2Name SET to %s",
                              ent_info->ep_str.name,ent_info->dhcp_serv_conf.label2.name.name);
         m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
      ...
      case ncsAvmEntDHCPConfFileNameLabel2_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfFileNameLabel2 played back to: %s ",
...
/* Should be reversed */
         ...
         m_AVM_SET_NAME(ent_info->dhcp_serv_conf.label2.file_name,
            arg->req.info.set_req.i_param_val);
         ckpt_dhconf = TRUE;
         snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfFileNameLabel2 SET to %s",
                              ent_info->ep_str.name,ent_info->dhcp_serv_conf.label2.file_name.name);
         m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
      ...
      case ncsAvmEntDHCPConfLabel1Status_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel1Status_ID played back to: %d ",ent_info->ep_str.name,
      ...
      case ncsAvmEntDHCPConfLabel2Status_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
            ...
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel2Status_ID played back to: %d ",ent_info->ep_str.name,
      ...
      case ncsAvmEntDHCPConfLabel1SwVersion_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
           ...
           snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel1SwVersion_ID played back to: %s ",ent_info->ep_str.name,
      ...
      case ncsAvmEntDHCPConfLabel2SwVersion_ID:
      {
         if ( arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME )
         {
           ...
           snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntDHCPConfLabel2SwVersion_ID played back to: %s ",ent_info->ep_str.name,
        ...
        else
        {
         ...
         if ((ent_info->ep_str.length == helper_ep.length)
             ...
             (!memcmp(ent_info->ep_str.name,
                            ...
                            helper_ep.length)))         
         {
            snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s : Helper blade same as target payload blade. IPMC upgrade failed",ent_info->ep_str.name);
            m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);
            return NCSCC_RC_INV_VAL;
         }
         ...
         if (!(arg->i_policy & NCSMIB_POLICY_PSS_BELIEVE_ME))
         {
            ...
            {
               /* log the error */
               snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s : Helper blade not present. IPMC upgrade failed",ent_info->ep_str.name);
               m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);
               return NCSCC_RC_INV_VAL;
            }
         }
         ...
         snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: ncsAvmEntHelperPayload_ID SET to %s",
      ...
      case ncsAvmEntAdminOper_ID:
      {
         ...
         if (AVM_DHCP_COMMIT == arg->req.info.set_req.i_param_val.info.i_int)
         {
            if (SSU_COMMIT_PENDING == ent_info->dhcp_serv_conf.label1.status)
            {
               ...
               ckpt_dhstate = TRUE;
               snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: %s's state SSU_COMMITTED",ent_info->ep_str.name,ent_info->dhcp_serv_conf.label1.name.name);
               m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE); 
            ...
            else if (SSU_COMMIT_PENDING == ent_info->dhcp_serv_conf.label2.status)
            {
               ...
               ent_info->dhcp_serv_conf.default_chg = FALSE;
               ckpt_dhstate = TRUE;
               snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: %s's state SSU_COMMITTED",ent_info->ep_str.name,ent_info->dhcp_serv_conf.label2.name.name);
               m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE); 
            ...
            {
               snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: Can't COMMIT the LABEL, it is not in COMMIT_PENDING State",ent_info->ep_str.name);
               m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);
               goto failure;
            }
         ...
         else if(AVM_DHCP_UPGRADE == arg->req.info.set_req.i_param_val.info.i_int)
         {
            if ((ent_info->dhcp_serv_conf.ipmc_upgd_state != 0) || (ent_info->dhcp_serv_conf.upgd_prgs == TRUE))
            {
                ...
                snprintf(logbuf,sizeof(logbuf)-1, "AVM-SSU: Payload %s: Upgrade is already in progress. Upgrade not allowed", ent_info->ep_str.name);
                m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
                goto failure;
            }
            if (ent_info->dhcp_serv_conf.curr_act_label == NULL)
            {
               snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: No current active label. Upgrade not allowed",ent_info->ep_str.name);
               m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
               goto failure;
            }
            ...
            if( (IPMC == ent_info->dhcp_serv_conf.upgrade_type) )
            {
               ...
               {
                  snprintf(logbuf,sizeof(logbuf)-1, "AVM-SSU: Payload %s: IPMC upgrade trigger failed", ent_info->ep_str.name);
                  m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);
            ...
            else if(INTEG == ent_info->dhcp_serv_conf.upgrade_type)  
            {
               ...
               if ((ent_info->dhcp_serv_conf.pref_label.length ==
                   ...
                   (!memcmp(ent_info->dhcp_serv_conf.pref_label.name,
                                  ...
                                  ent_info->dhcp_serv_conf.pref_label.length)))
               {
                  snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: Preferred label is the current active label. No Upgrade",ent_info->ep_str.name);
                  m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_NOTICE);
               }
                                       ...
                                       ent_info->dhcp_serv_conf.pref_label.length)))
               {
                  ...
                  if (rc == NCSCC_RC_FAILURE)
                  {
                     snprintf(logbuf,sizeof(logbuf)-1, "AVM-SSU: Payload %s: INTEG upgrade trigger failed", ent_info->ep_str.name);
                     m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);
               ...
               {
                  snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: Not a valid Preferred label.",ent_info->ep_str.name);
                  m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);
                  goto failure;
               }
            }  
            ...
            {
               snprintf(logbuf,sizeof(logbuf)-1,"AVM-SSU: Payload blade %s: Invalid Operation",ent_info->ep_str.name);
               m_AVM_LOG_DEBUG(logbuf,NCSFL_SEV_ERROR);  
               goto failure;
            }
         }
