...
extern uns32
avm_decode_ckpt_dhcp_conf_update(AVM_ENT_DHCP_CONF *dhcp_conf, 
                                 AVM_ENT_DHCP_CONF *temp_conf);

extern uns32
avm_decode_ckpt_dhcp_state_update(AVM_ENT_DHCP_CONF *dhcp_conf, 
                                 AVM_ENT_DHCP_CONF *temp_conf);

extern uns32
avm_decode_ckpt_upgd_state_update(AVM_ENT_DHCP_CONF *dhcp_conf, 
                                 AVM_ENT_DHCP_CONF *temp_conf);
