...
typedef uns32 (*AVM_ENCODE_COLD_SYNC_RSP_DATA_FUNC_PTR)(AVM_CB_T *cb,
                          NCS_MBCSV_CB_ENC *enc);


typedef uns32 (*AVM_DECODE_COLD_SYNC_RSP_DATA_FUNC_PTR)(AVM_CB_T *cb,
                          NCS_MBCSV_CB_DEC *enc);
...
extern uns32  avm_send_ckpt_data(
              AVM_CB_T *cb,
              uns32      action,
