                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET avsv_edp_cbq_info_rules[ ] = {
        ...
        {EDU_EXEC, m_NCS_EDP_SAAMFCSITRANSITIONDESCRIPTORT, 0, 0, 0,
            (long)&((AVSV_AMF_CBK_INFO*)0)->param.csi_set.csi_desc.csiStateDescriptor.activeDescriptor.transitionDescriptor, 0, NULL},
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, EDU_EXIT,
            (long)&((AVSV_AMF_CBK_INFO*)0)->param.csi_set.csi_desc.csiStateDescriptor.activeDescriptor.activeCompName, 0, NULL},
        
        {EDU_EXEC, ncs_edp_sanamet, 0, 0, 0,
            (long)&((AVSV_AMF_CBK_INFO*)0)->param.csi_set.csi_desc.csiStateDescriptor.standbyDescriptor.activeCompName, 0, NULL},
        {EDU_EXEC, m_NCS_EDP_SAUINT32T, 0, 0, EDU_EXIT,
            (long)&((AVSV_AMF_CBK_INFO*)0)->param.csi_set.csi_desc.csiStateDescriptor.standbyDescriptor.standbyRank, 0, NULL},
