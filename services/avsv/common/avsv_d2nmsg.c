...
void avsv_free_d2n_node_up_msg_info(AVSV_DND_MSG *node_up_msg)
{
   ...
   while(node_up_msg->msg_info.d2n_clm_node_up.list_of_nodes != NULL)
   {
      ...
      node_up_msg->msg_info.d2n_clm_node_up.list_of_nodes = 
         node->next;
...
void avsv_free_d2n_clm_node_fover_info(AVSV_DND_MSG *node_up_msg)
{
   ...
   while(node_up_msg->msg_info.d2n_clm_node_fover.list_of_nodes != NULL)
   {
      ...
      node_up_msg->msg_info.d2n_clm_node_fover.list_of_nodes = 
         node->next;
      m_MMGR_FREE_AVSV_DND_MSG_INFO(node);
   }
...
void avsv_dnd_msg_free (AVSV_DND_MSG *msg)
{
   ...
   if ((msg->msg_type <= AVSV_D2N_PG_TRACK_ACT_RSP_MSG) &&
      (msg->msg_type >= AVSV_D2N_CLM_NODE_UP_MSG))
   {
...
uns32 avsv_dnd_msg_copy (AVSV_DND_MSG *dmsg, AVSV_DND_MSG *smsg)
{
   ...
   if ((smsg->msg_type <= AVSV_D2N_PG_TRACK_ACT_RSP_MSG) &&
      (smsg->msg_type >= AVSV_D2N_CLM_NODE_UP_MSG))
   {
