...
..............................................................................
  ...
  This file contains the MDS routines for FM.
...
* Notes         : None.
*****************************************************************************/
static uns32 fm_mds_svc_evt(FM_CB *cb,
...
* Return Values :                         
*                                                                           
* Notes         : Pass bcast_scope as 0, for unicast sending 
***************************************************************************/
uns32 
fm_mds_async_send(FM_CB *fm_cb,NCSCONTEXT msg,
                         NCSMDS_SVC_ID svc_id,
...
***************************************************************************/
static uns32 
fm_encode(MDS_CALLBACK_ENC_INFO *enc_info)
{
...
***************************************************************************/
static uns32 
fm_decode(MDS_CALLBACK_DEC_INFO *dec_info)
{
...
***************************************************************************/
static uns32
fm_fm_mds_enc(MDS_CALLBACK_ENC_INFO *enc_info)
{
    GFM_GFM_MSG *msg;
    NCS_UBAID   *uba;
    uns8        *data;
...
***************************************************************************/
static uns32 
fm_fm_mds_dec(MDS_CALLBACK_DEC_INFO *dec_info)
{
