...
EXTERN_C void dta_mds_evt(MDS_CALLBACK_SVC_EVENT_INFO svc_info,
...
EXTERN_C uns32 dta_fill_reg_msg(DTSV_MSG  *msg, SS_SVC_ID svc_id, const uns16 version, const char *svc_name, uns8 operation);
