                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_dts_log_ckpt_data_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (uns32)&((DTS_LOG_CKPT_DATA*)0)->file_name, 250, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_LOG_CKPT_DATA*)0)->key.node, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_LOG_CKPT_DATA*)0)->key.ss_svc_id, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((DTS_LOG_CKPT_DATA*)0)->new_file, 0, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_dts_log_ckpt_data_rules, struct_ptr,ptr_data_len, buf_env, op, o_err);
    return rc;
}
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_dts_ll_file_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_uns8, EDQ_ARRAY, 0, 0,
            (uns32)&((DTS_LL_FILE*)0)->file_name, 250, NULL},  
        {EDU_TEST_LL_PTR, dtsv_edp_ckpt_msg_dts_ll_file_config, 0, 0, 0,
            (uns32)&((DTS_LL_FILE*)0)->next, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_dts_ll_file_rules, struct_ptr,ptr_data_len, buf_env, op, o_err);
    return rc;
}
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_dts_file_list_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_FILE_LIST*)0)->num_of_files, 0, NULL},
        {EDU_EXEC, dtsv_edp_ckpt_msg_dts_ll_file_config, EDQ_POINTER, 0, 0,
            (uns32)&((DTS_FILE_LIST*)0)->head, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_dts_file_list_rules, struct_ptr,ptr_data_len, buf_env, op, o_err);
    return rc;  
}
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_dts_svc_reg_tbl_rules[ ] = {
       {EDU_START, dtsv_edp_ckpt_msg_dts_svc_reg_tbl_config, 0, 0, 0, 
        ...
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((DTS_SVC_REG_TBL*)0)->per_node_logging, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((DTS_SVC_REG_TBL*)0)->row_status, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->my_key.node, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->my_key.ss_svc_id, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0, 
            (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.log_dev, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,       
            (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.log_file_size, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.file_log_fmt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.cir_buff_size, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.buff_log_fmt, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.enable, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
           (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.category_bit_map, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
           (uns32)&((DTS_SVC_REG_TBL*)0)->svc_policy.severity_bit_map, 0, NULL},
        ...
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,       
            (uns32)&((DTS_SVC_REG_TBL*)0)->device.file_open, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->device.cur_file_size, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->device.new_file, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->device.last_rec_id, 0, NULL}, 
        /* Smik - Omitting circular buffer */
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->device.file_log_fmt_change, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->device.buff_log_fmt_change, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((DTS_SVC_REG_TBL*)0)->row_exist, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_dts_svc_reg_tbl_rules, struct_ptr,ptr_data_len, buf_env, op, o_err);
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_dta_dest_list_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_mds_dest, 0, 0, 0, 
            (uns32)&((DTA_DEST_LIST*)0)->dta_addr, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((DTA_DEST_LIST*)0)->dta_up, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0, 
            (uns32)&((DTA_DEST_LIST*)0)->updt_req, 0, NULL},
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_dta_dest_list_rules, struct_ptr,ptr_data_len, buf_env, op, o_err); 
    /* Smik - implementation ends here */
    return rc;
}
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_global_policy_rules[ ] = {
        ...
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((GLOBAL_POLICY*)0)->global_logging, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->g_policy.log_dev, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->g_policy.log_file_size, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->g_policy.file_log_fmt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->g_policy.cir_buff_size, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->g_policy.buff_log_fmt, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->g_policy.enable, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
           (uns32)&((GLOBAL_POLICY*)0)->g_policy.category_bit_map, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
           (uns32)&((GLOBAL_POLICY*)0)->g_policy.severity_bit_map, 0, NULL},
        ...
        /* Smik - Omitting encoding for FILE* for recreating later */
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->device.file_open, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->device.cur_file_size, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->device.new_file, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
            (uns32)&((GLOBAL_POLICY*)0)->device.last_rec_id, 0, NULL},
        /* Smik - Omitting circular buffer */
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
           (uns32)&((GLOBAL_POLICY*)0)->device.file_log_fmt_change, 0, NULL},
        {EDU_EXEC, ncs_edp_uns8, 0, 0, 0,
           (uns32)&((GLOBAL_POLICY*)0)->device.buff_log_fmt_change, 0, NULL}, 
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((GLOBAL_POLICY*)0)->dflt_logging, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((GLOBAL_POLICY*)0)->g_num_log_files, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((GLOBAL_POLICY*)0)->g_enable_seq, 0, NULL},
        {EDU_EXEC, ncs_edp_ncs_bool, 0, 0, 0, 
            (uns32)&((GLOBAL_POLICY*)0)->g_close_files, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_global_policy_rules, struct_ptr, ptr_data_len, buf_env, op, o_err); 
    /* Smik - implementation ends here */
    return rc;
}
                           ...
                           EDU_ERR *o_err)
{
    ...
    EDU_INST_SET dtsv_ckpt_msg_async_updt_cnt_rules[ ] = {
         ...
         */
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((DTSV_ASYNC_UPDT_CNT*)0)->dts_svc_reg_tbl_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((DTSV_ASYNC_UPDT_CNT*)0)->dta_dest_list_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, 
            (uns32)&((DTSV_ASYNC_UPDT_CNT*)0)->global_policy_updt, 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0,
            (uns32)&((DTSV_ASYNC_UPDT_CNT*)0)->dts_log_updt, 0, NULL},
        {EDU_END, 0, 0, 0, 0, 0, 0, NULL},
    };
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, dtsv_ckpt_msg_async_updt_cnt_rules, struct_ptr, ptr_data_len, buf_env, op, o_err); 
    /* Smik - implementation ends here */
    return rc;
}
