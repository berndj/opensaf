...
/* prototypes */
EXTERN_C GLND_AGENT_INFO *glnd_agent_node_find(GLND_CB *glnd_cb,
                                               MDS_DEST agent_mds_dest);
EXTERN_C GLND_AGENT_INFO *glnd_agent_node_add(GLND_CB    *glnd_cb, 
                                              MDS_DEST   agent_mds_dest,
                                              uns32      process_id);
EXTERN_C void glnd_agent_node_del(GLND_CB  *glnd_cb,
...
EXTERN_C GLND_RESOURCE_REQ_LIST *glnd_resource_req_node_add(GLND_CB *glnd_cb,
                                                   ...
                                                   SaLckResourceIdT   lcl_resource_id);
EXTERN_C GLND_RESOURCE_REQ_LIST *glnd_resource_req_node_find(GLND_CB       *glnd_cb,
                                                             SaNameT       resource_name);
