...
/*prototypes */
EXTERN_C GLND_CLIENT_INFO *glnd_client_node_find(GLND_CB       *glnd_cb, 
...
EXTERN_C GLND_CLIENT_INFO *glnd_client_node_add(GLND_CB    *glnd_cb, 
                                                MDS_DEST   agent_mds_dest,
                                                SaLckHandleT   app_handle_id);

EXTERN_C uns32  glnd_client_node_del(GLND_CB          *glnd_cb, 
                                     GLND_CLIENT_INFO *client_info);

EXTERN_C uns32  glnd_client_node_resource_add(GLND_CLIENT_INFO *client_info,
...
EXTERN_C GLND_CLIENT_LIST_RESOURCE_LOCK_REQ  *
