                        ...
                        EDU_ERR *o_err)
{
   ...
   EDU_INST_SET    glsv_glnd_evt_rules[ ] = {
    ...
    rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, glsv_glnd_evt_rules, struct_ptr, ptr_data_len, 
        buf_env, op, o_err);
    return rc;
}
                       ...
                       EDU_ERR *o_err)
{
   ...
   EDU_INST_SET    glsv_gld_evt_rules[ ] = {
    ...
    rc = m_NCS_EDU_RUN_RULES(edu_hdl, edu_tkn, glsv_gld_evt_rules, struct_ptr, ptr_data_len, 
        buf_env, op, o_err);
    return rc;
}
