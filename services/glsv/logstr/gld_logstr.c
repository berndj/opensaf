...
const NCSFL_STR gld_svc_prvdr_set[] = 
{
   ...
   { GLD_MIBLIB_REGISTER_FAIL,                    "GLD MIBLIB REGISTER FAIL"        },
   { GLD_MIBLIB_REGISTER_SUCCESS,                 "GLD MIBLIB REGISTER SUCCESS"     },
   { GLD_MASV_REGISTER_SUCCESS,                   "GLD MASV REGISTER SUCCESS"       },
   { GLD_MASV_REGISTER_FAIL,                      "GLD MASV REGISTER FAIL"          },
   { 0,0 }
};
