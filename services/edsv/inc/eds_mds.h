...
EXTERN_C uns32 eds_dec_subscribe_msg(NCS_UBAID *uba, uns32 msg_hdl, uns8 ckpt_flag);

EXTERN_C uns32 eds_dec_publish_msg(NCS_UBAID *uba, uns32 msg_hdl, uns8 ckpt_flag);
