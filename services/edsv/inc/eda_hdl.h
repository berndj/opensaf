...
EXTERN_C uns32 eda_channel_hdl_rec_del (EDA_CHANNEL_HDL_REC **, 
                                        EDA_CHANNEL_HDL_REC *);
EXTERN_C uns32
eda_del_subsc_rec (EDA_SUBSC_REC **list_head, EDA_SUBSC_REC *rm_node);
EXTERN_C uns32 eda_event_hdl_rec_del (EDA_EVENT_HDL_REC **, 
                                      EDA_EVENT_HDL_REC *);
...
EXTERN_C NCS_BOOL
eda_validate_eda_client_hdl(EDA_CB *eda_cb, 
                            EDA_CLIENT_HDL_REC *find_hdl_rec);

EXTERN_C EDA_SUBSC_REC *
eda_find_subsc_by_subsc_id(EDA_CHANNEL_HDL_REC *, uns32 sub_id);

EXTERN_C EDA_CLIENT_HDL_REC *
eda_find_hdl_rec_by_regid(EDA_CB *eda_cb, uns32 reg_id);

EXTERN_C EDA_CHANNEL_HDL_REC *
