...
EXTERN_C EDS_WORKLIST *
eds_get_worklist_entry (EDS_WORKLIST *, uns32);

EXTERN_C EDA_REG_REC *
eds_get_reglist_entry (EDS_CB *, uns32);

EXTERN_C uns32
eds_add_reglist_entry (EDS_CB *, MDS_DEST, uns32);

EXTERN_C uns32
eds_remove_reglist_entry (EDS_CB *, uns32, NCS_BOOL);

EXTERN_C uns32
eds_remove_regid_by_mds_dest(EDS_CB *, MDS_DEST);

EXTERN_C NCS_BOOL
eds_eda_entry_valid(EDS_CB *, MDS_DEST);

EXTERN_C uns32 
eds_remove_eda_down_rec(EDS_CB *, MDS_DEST);

EXTERN_C uns32
eds_channel_open(EDS_CB *, uns32, uns32, uns16, uns8 *, MDS_DEST, uns32 *, uns32 *,SaTimeT );

EXTERN_C uns32
eds_copen_patricia_init(EDS_WORKLIST *);

EXTERN_C uns32
eds_channel_close(EDS_CB *, uns32, uns32, uns32, NCS_BOOL);

EXTERN_C uns32
eds_channel_unlink(EDS_CB *, uns32, uns8 *);

EXTERN_C uns32
eds_add_subscription(EDS_CB *, uns32, SUBSC_REC *);

EXTERN_C uns32
eds_remove_subscription(EDS_CB *, uns32, uns32, uns32, uns32);

EXTERN_C uns32
eds_remove_worklist_entry(EDS_CB *cb, uns32 chan_id);

EXTERN_C NCS_BOOL
eds_pattern_match(SaEvtEventPatternArrayT *, SaEvtEventFilterArrayT  *);

EXTERN_C uns32
eds_store_retained_event(EDS_CB *, 
                         EDS_WORKLIST *,
                         CHAN_OPEN_REC *,
...
EXTERN_C uns32
eds_clear_retained_event(EDS_CB *, uns32, uns32, uns32, NCS_BOOL);

EXTERN_C void
eds_remove_retained_events(EDS_RETAINED_EVT_REC **,EDS_RETAINED_EVT_REC **);

EXTERN_C void
eds_dump_event_patterns(SaEvtEventPatternArrayT *);

EXTERN_C void
eds_dump_pattern_filter(SaEvtEventPatternArrayT *, SaEvtEventFilterArrayT *);

EXTERN_C void
eds_dump_reglist(void);

EXTERN_C void
eds_dump_worklist(void);


EXTERN_C uns32 eds_start_tmr (EDS_CB         *cb,
                              EDS_TMR        *tmr, 
                              EDS_TMR_TYPE   type, 
                              SaTimeT        period, 
                              uns32          uarg);
