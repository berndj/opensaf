...
#if 0
   HCD_SE_FWPROG_SYSINIT_SUCCESS,
   HCD_SE_FWPROG_OPSYS_BOOT_PROG,
   HCD_SE_FWPROG_SYS_BOOT_PROG,
   HCD_SE_FWPROG_HPM_INIT_SUCCESS,
   HCD_SE_FWPROG_HLFM_INIT_SUCCESS,
   HCD_SE_FWPROG_SW_INIT_SUCCESS,
   HCD_SE_FWPROG_LHC_DMN_INIT_SUCCESS,
   HCD_SE_FWPROG_LHCD_RSP_INIT_SUCCESS,
   HCD_SE_FWPROG_NW_SCRIPT_INIT_SUCCESS,
   HCD_SE_FWPROG_DRBD_DEV_INIT_SUCCESS,
   HCD_SE_FWPROG_DRBD_MNT_INIT_SUCCESS,
   HCD_SE_FWPROG_TIPC_INIT_SUCCESS,
   HCD_SE_FWPROG_DTSV_INIT_SUCCESS,
   HCD_SE_FWPROG_MASV_INIT_SUCCESS,
   HCD_SE_FWPROG_PSSV_INIT_SUCCESS
#endif /* 0 */
} HCD_FWPROG_FLEX;
