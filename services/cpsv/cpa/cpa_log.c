...
/*****************************************************************************
  ...
  PROCEDURE NAME:    cpa_log_tmr

  DESCRIPTION:       Timer logging info

*****************************************************************************/
void cpa_log_tmr(uns8 hdln_id, uns8 sev)
{
    ncs_logmsg(NCS_SERVICE_ID_CPA, CPA_LID_HDLN, CPA_FC_HDLN, 
               NCSFL_LC_HEADLINE, sev, NCSFL_TYPE_TI, 
               hdln_id);
...
/*****************************************************************************
  ...
  PROCEDURE NAME:    cpa_log_lockfail

  DESCRIPTION:       API logging info

*****************************************************************************/
void cpa_log_lockfail(uns8 api_id, uns8 sev)
{
    ncs_logmsg(NCS_SERVICE_ID_CPA, CPA_LID_API, CPA_FC_API, 
...
/*****************************************************************************
  ...
  PROCEDURE NAME:    cpa_log_evt

  DESCRIPTION:       Event logging info

*****************************************************************************/
void cpa_log_evt(uns8 evt_id, uns32 node)
{
    ncs_logmsg(NCS_SERVICE_ID_CPA, CPA_LID_EVT, CPA_FC_EVT, 
...
/*****************************************************************************
  ...
  PROCEDURE NAME:    cpa_log_sys_call

  DESCRIPTION:       System call logging info

*****************************************************************************/
void cpa_log_sys_call(uns8 id, uns32 node)
{
    ncs_logmsg(NCS_SERVICE_ID_CPA, CPA_LID_SYS_CALL, CPA_FC_SYS_CALL, 
