...
const NCSFL_STR cpd_hdln_set[] = {
   ...
   {CPD_MASV_REGISTER_FAIL, "CPD - MASV Register Failed"},
   ...
   {CPD_MIBLIB_REGISTER_FAIL, "CPD - Miblib Register Failed"},
   ...
   {CPD_MIBLIB_PROCESS_REQ_FAILED,"CPD - MIBLIB PROCESS REQUEST FAILED"},
   {CPD_REGISTER_WITH_MAB_FAILED,"CPD - REGISTER WITH MAB FAILED"},
   {CPD_UNREGISTER_WITH_MAB_FAILED,"CPD - UNREGISTER WITH MAB FAILED"},
