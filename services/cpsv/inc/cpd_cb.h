...
void cpd_free_ckpt_node(CPD_CB *gld_cb,
                       CPD_CKPT_INFO_NODE *ckpt_info);
...
EXTERN_C uns32 cpd_ckpt_node_add(NCS_PATRICIA_TREE *ckpt_tree,  
                          CPD_CKPT_INFO_NODE *ckpt_node);
...
EXTERN_C void cpd_ckpt_reploc_getnext(NCS_PATRICIA_TREE *ckpt_reploc_tree,
                           CPD_REP_KEY_INFO *key_info,
                           CPD_CKPT_REPLOC_INFO **ckpt_reploc_node);
EXTERN_C uns32 cpd_ckpt_reploc_node_add(NCS_PATRICIA_TREE *ckpt_reploc_tree,
                          CPD_CKPT_REPLOC_INFO *ckpt_reploc_node);
...
EXTERN_C uns32 cpd_ckpt_map_node_add(NCS_PATRICIA_TREE *ckpt_map_tree,  
                          CPD_CKPT_MAP_INFO *ckpt_map_node);
EXTERN_C uns32 cpd_ckpt_map_node_delete(CPD_CB *cb, 
                          CPD_CKPT_MAP_INFO *ckpt_map_node);
...
EXTERN_C uns32 cpd_cpnd_info_node_add(NCS_PATRICIA_TREE *cpnd_tree,  
                          CPD_CPND_INFO_NODE *cpnd_info_node);
EXTERN_C uns32 cpd_cpnd_info_node_delete(CPD_CB *cb, 
                          CPD_CPND_INFO_NODE *cpnd_info_node);
...
EXTERN_C void cpd_ckpt_ref_info_add(CPD_CPND_INFO_NODE *node_info, 
         CPD_CKPT_REF_INFO *cref_info);
         
EXTERN_C void cpd_ckpt_ref_info_del(CPD_CPND_INFO_NODE *node_info, 
         CPD_CKPT_REF_INFO *cref_info);
EXTERN_C void cpd_node_ref_info_add(CPD_CKPT_INFO_NODE *ckpt_node, 
               CPD_NODE_REF_INFO *nref_info);
EXTERN_C void cpd_node_ref_info_del(CPD_CKPT_INFO_NODE *ckpt_node, 
         CPD_NODE_REF_INFO *nref_info);
