...
EXTERN_C uns32 cpa_client_node_get(NCS_PATRICIA_TREE *client_tree, 
                                   SaCkptHandleT *cl_hdl,
                                   CPA_CLIENT_NODE **cl_node);
EXTERN_C uns32 cpa_client_node_add(NCS_PATRICIA_TREE *client_tree, 
                                   CPA_CLIENT_NODE *cl_node);
...
EXTERN_C void cpa_lcl_ckpt_node_getnext(CPA_CB *cb,SaCkptCheckpointHandleT *lc_hdl,
                                        CPA_LOCAL_CKPT_NODE **lc_node);
EXTERN_C uns32 cpa_lcl_ckpt_node_add(NCS_PATRICIA_TREE *lcl_ckpt_tree,  
                          CPA_LOCAL_CKPT_NODE *lc_node);
...
EXTERN_C uns32 cpa_gbl_ckpt_node_find_add(NCS_PATRICIA_TREE *gbl_ckpt_tree, 
                                 ...
                                 NCS_BOOL *add_flag);
EXTERN_C uns32 cpa_gbl_ckpt_node_add(NCS_PATRICIA_TREE *gbl_ckpt_tree,  
                          CPA_GLOBAL_CKPT_NODE *gc_node);
...
EXTERN_C uns32 cpa_sect_iter_node_add(NCS_PATRICIA_TREE *sect_iter_tree,  
                          CPA_SECT_ITER_NODE *sect_iter_node);
...
EXTERN_C void cpa_sect_iter_node_getnext(NCS_PATRICIA_TREE *sect_iter_tree,SaCkptSectionIterationHandleT *sect_iter_hdl,CPA_SECT_ITER_NODE **sect_iter_node);
#endif
