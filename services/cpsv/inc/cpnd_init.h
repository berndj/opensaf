...
uns32 cpnd_proc_fill_sec_desc(CPND_CKPT_SECTION_INFO *pTmpSecPtr, \
...
uns32 cpnd_mds_msg_sync_ack_send(CPND_CB *cb, uns32 to_svc, \
                          MDS_DEST  to_dest, CPSV_EVT   *evt,uns32  timeout);
