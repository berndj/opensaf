...
typedef struct imma_admin_owner_node
{
    ...
    //IMMA_TMR                   async_req_tmr;/*Timer used for async requests */
...
EXTERN_C uns32 imma_client_node_get(NCS_PATRICIA_TREE *client_tree, 
    SaImmHandleT *cl_hdl,
    IMMA_CLIENT_NODE **cl_node);
EXTERN_C uns32 imma_client_node_add(NCS_PATRICIA_TREE *client_tree, 
    IMMA_CLIENT_NODE *cl_node);
...
EXTERN_C void imma_admin_owner_node_getnext(IMMA_CB *cb,
    SaImmAdminOwnerHandleT *adm_hdl,
    IMMA_ADMIN_OWNER_NODE **adm_node);
EXTERN_C uns32 imma_admin_owner_node_add(NCS_PATRICIA_TREE *admin_owner_tree,  
    IMMA_ADMIN_OWNER_NODE *adm_node);
EXTERN_C uns32 imma_admin_owner_node_delete(IMMA_CB *cb, 
    IMMA_ADMIN_OWNER_NODE *adm_node);
...
EXTERN_C uns32 imma_ccb_node_get(NCS_PATRICIA_TREE *ccb_tree, 
    SaImmCcbHandleT *ccb_hdl,
    IMMA_CCB_NODE **ccb_node);
EXTERN_C void imma_ccb_node_getnext(IMMA_CB *cb,
    SaImmCcbHandleT *ccb_hdl,
    IMMA_CCB_NODE **ccb_node);
EXTERN_C uns32 imma_ccb_node_add(NCS_PATRICIA_TREE *ccb_tree,  
    IMMA_CCB_NODE *ccb_node);
...
EXTERN_C void imma_search_node_getnext(IMMA_CB *cb,
    SaImmSearchHandleT *search_hdl,
    IMMA_SEARCH_NODE **search_node);
EXTERN_C uns32 imma_search_node_add(NCS_PATRICIA_TREE *search_tree,  
    IMMA_SEARCH_NODE *search_node);
EXTERN_C uns32 imma_search_node_delete(IMMA_CB *cb, 
    IMMA_SEARCH_NODE *search_node);
