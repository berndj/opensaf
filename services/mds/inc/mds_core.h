...
extern uns32 mds_vdest_tbl_add (MDS_VDEST_ID vdest_id, NCS_VDEST_TYPE policy,
...
extern uns32 mds_svc_tbl_get_svc_hdl(MDS_PWE_HDL pwe_hdl, MDS_SVC_ID svc_id,
                                        MDS_SVC_HDL *svc_hdl);
extern uns32 mds_svc_tbl_get_first_subscription (MDS_SVC_HDL svc_hdl,
                                MDS_SUBSCRIPTION_INFO **first_subscription);

extern uns32 mds_svc_tbl_getnext_on_vdest (MDS_VDEST_ID vdest_id, MDS_SVC_HDL current_svc_hdl,
...
extern uns32 mds_subtn_tbl_get (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
...
extern uns32 mds_block_snd_req_tbl_add (MDS_SVC_HDL svc_hdl, MDS_SYNC_TXN_ID txn_id,
...
extern uns32 mds_block_snd_req_tbl_get(MDS_SVC_HDL svc_hdl, MDS_SYNC_TXN_ID txn_id,
                                           MDS_MCM_SYNC_SEND_QUEUE *result);
...
extern uns32 mds_subtn_res_tbl_del (MDS_SVC_HDL svc_hdl, MDS_SVC_ID svc_id,
                                    MDS_VDEST_ID vdest_id,MDS_DEST adest,
                                     ...
                                     MDS_SVC_PVT_SUB_PART_VER svc_sub_part_ver,
                                     MDS_SVC_ARCHWORD_TYPE    archword_type);
extern uns32 mds_subtn_res_tbl_query (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
...
extern uns32 mds_subtn_res_tbl_change_active (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
                                    ...
                                    MDS_SVC_PVT_SUB_PART_VER svc_sub_part_ver,
                                    MDS_SVC_ARCHWORD_TYPE    archword_type );
extern uns32 mds_subtn_res_tbl_remove_active (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
                                    MDS_VDEST_ID vdest_id);
...
extern uns32 mds_subtn_res_tbl_get_by_adest (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
                                MDS_VDEST_ID vdest_id, MDS_DEST adest, V_DEST_RL *o_role,
                                MDS_SUBSCRIPTION_RESULTS_INFO **result);/* Use for send */

extern uns32 mds_subtn_res_tbl_getnext_by_adest (MDS_DEST adest, MDS_SUBSCRIPTION_RESULTS_KEY *key, MDS_SUBSCRIPTION_RESULTS_INFO **ret_result);
                                /* used while deleting results when ADEST goes down */

extern uns32 mds_subtn_res_tbl_getnext_active (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
                                        MDS_SUBSCRIPTION_RESULTS_INFO **result);/* use for bcast */

extern uns32 mds_subtn_res_tbl_getnext_any (MDS_SVC_HDL svc_hdl, MDS_SVC_ID subscr_svc_id,
