...
/*****************************************************************************
  ...
  PROCEDURE NAME:   ifnd_get_mbx

  DESCRIPTION   :   Will get the IFND/IDIM mailbox to post the event.
******************************************************************************/
static SYSF_MBX ifnd_get_mbx(IFSV_CB *cb, IFSV_EVT *msg, SS_SVC_ID fr_svc)
{
   /* Right now we are not using IFSV_EVT for extracting mbx */
   switch(fr_svc)
   {
   case NCSMDS_SVC_ID_IFD:
   case NCSMDS_SVC_ID_IFA:
...
/****************************************************************************
 * Name          : ifnd_edp_ifsv_evt
 *
 * Description   : This is the function which is used to encode decode 
 *                 IfND event structures.
 * 
 *
 * Notes         : None.
 *****************************************************************************/
uns32 ifnd_edp_ifsv_evt(EDU_HDL *edu_hdl, EDU_TKN *edu_tkn, 
                        ...
                        EDU_ERR *o_err)
{
    ...
    EDU_INST_SET    test_ifsv_evt_rules[ ] = {
        {EDU_START, ifnd_edp_ifsv_evt, 0, 0, 0, sizeof(IFSV_EVT), 0, NULL},
        {EDU_EXEC, ncs_edp_uns32, 0, 0, 0, (uns32)&((IFSV_EVT*)0)->type, 0, NULL},
        {EDU_TEST, ncs_edp_uns32, 0, 0, 0, (uns32)&((IFSV_EVT*)0)->type, 0, ifsv_ifnd_evt_test_type_fnc},
        ...
        {EDU_EXEC, ifsv_edp_spt_map_info, 0, 0, EDU_EXIT, 
            ...
            /* For IFND_EVT_INTF_AGING_TMR_EXP */
