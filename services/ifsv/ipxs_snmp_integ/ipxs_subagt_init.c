...
/*****************************************************************************
  MODULE NAME: IPXS_SUBAGT_INIT.C 
******************************************************************************/
...
/**************************************************************************
Name          :  subagt_register_ipxs_subsys
...
**************************************************************************/
uns32 subagt_register_ipxs_subsys()
{
   uns32 status = NCSCC_RC_FAILURE;

   /* Register 'ncs_ifsv_ifip_mib' module (MIB) with SNMP Agent */
   status = ncs_snmpsubagt_init_deinit_msg_post("__register_ncs_ifsv_ifip_mib_module");
...
/**************************************************************************
Name          :  subagt_unregister_ipxs_subsys
...
**************************************************************************/
uns32 subagt_unregister_ipxs_subsys()
{
   uns32 status = NCSCC_RC_FAILURE;

   /* De-register 'ncs_ifsv_ifip_mib' module (MIB) from SNMP Agent */
   status = ncs_snmpsubagt_init_deinit_msg_post("__unregister_ncs_ifsv_ifip_mib_module");
   if (status != NCSCC_RC_SUCCESS)
       return status;
