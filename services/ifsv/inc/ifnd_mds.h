...
#define IFND_SVC_PVT_SUBPART_VERSION 2

#define IFND_WRT_IFD_SUBPART_VER_AT_MIN_MSG_FMT 1
#define IFND_WRT_IFD_SUBPART_VER_AT_MAX_MSG_FMT 2 /* embedding susbslot changes */
...
#define IFND_WRT_IFA_SUBPART_VER_AT_MAX_MSG_FMT 2 /* embedding subslot changes */
...
#define IFND_WRT_DRV_SUBPART_VER_AT_MAX_MSG_FMT 2 /* embedding subslot changes */
