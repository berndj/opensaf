...
/*****************************************************************************
  MODULE NAME: NCS_IFSV_MIB_AGT_STUB.H 
******************************************************************************/
#ifndef _NCS_IFSV_MIB_H_
#define _NCS_IFSV_MIB_H_
 ...
 *
 * This header is derived from the NCS-IFSV-MIB module.
 *
 * $Id$
 */
...
extern uns32 __register_ncs_ifsv_mib_module(void);

/* Common Unregistration routine */
extern uns32 __unregister_ncs_ifsv_mib_module(void);

/* This variable is imported from subAgent module */
extern NCSMIB_PARAM_VAL rsp_param_val;

#endif /* _NCS_IFSV_MIB_H_ */
