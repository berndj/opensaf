...
..............................................................................
  ...
  $Header: /ncs/software/release/UltraLinq/MAB/MAB1.0/base/products/mab/mac/mac_mds.c 22    8/06/01 8:53a Questk $
            ...
            MDS_DEST  to_card,    SS_SVC_ID to_svc)
{
    ...
    if(inst)
    {
        m_LOG_MAB_SVC_PRVDR_MSG(NCSFL_SEV_DEBUG, MAB_SP_MAC_MDS_RCV_MSG,
...
\****************************************************************************/
static uns32 
mac_mds_evt_cb(NCSMDS_CALLBACK_INFO * cbinfo)
{
...
uns32 mac_mds_cb (NCSMDS_CALLBACK_INFO *cbinfo)
{
    ...
    default:
        m_LOG_MAB_ERROR_I(NCSFL_SEV_ERROR, MAB_MAC_ERR_MDS_CB_INVALID_OP, 
                          cbinfo->i_op);
