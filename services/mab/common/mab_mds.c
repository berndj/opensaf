...
..............................................................................
  ...
  $Header: /ncs/software/release/UltraLinq/MAB/MAB1.1/base/products/mab/common/mab_mds.c 33    9/07/01 6:09p Questk $
...
static uns32
ncs_mab_range_fltr_encode(NCS_UBAID* uba, NCSMAB_RANGE *range_fltr); 

/* to decode the range filter */ 
static uns32
ncs_mab_range_fltr_decode(NCS_UBAID* uba, NCSMAB_RANGE *range_fltr); 

/* to encode the exact filter */ 
static uns32
ncs_mab_exact_fltr_encode(NCS_UBAID* uba, NCSMAB_EXACT *exact_fltr); 

/* Decodes NCSMAB_FLTR_EXACT filter */ 
static uns32
ncs_mab_exact_fltr_decode(NCS_UBAID* uba, NCSMAB_EXACT *exact_fltr); 
...
uns32 mab_mds_snd(MDS_HDL  mds_hdl,    NCSCONTEXT  msg,
...
uns32 mab_mds_enc(MDS_CLIENT_HDL  yr_svc_hdl, NCSCONTEXT msg, 
...
uns32 mab_mds_dec(MDS_CLIENT_HDL  yr_svc_hdl, NCSCONTEXT* msg, 
                  SS_SVC_ID to_svc,     NCS_UBAID*  uba,
                  uns16 msg_fmt_ver)
  {
  uns8*    data;
 ...
 ****************************************************************************/
uns32 mab_mds_cpy(MDS_CLIENT_HDL  yr_svc_hdl, NCSCONTEXT msg, 
  ...
  *cpy = mm;
  ...
  switch(mm->op)
      ...
      if(src_mf->type == NCSMAB_FLTR_RANGE)
        {
          if(src_mf->fltr.range.i_min_idx_fltr != NULL)
            {
            dst_mf->fltr.range.i_min_idx_fltr = m_MMGR_ALLOC_MIB_INST_IDS(dst_mf->fltr.range.i_idx_len);
          ...
          if(src_mf->fltr.range.i_max_idx_fltr != NULL)
            {
            dst_mf->fltr.range.i_max_idx_fltr = m_MMGR_ALLOC_MIB_INST_IDS(dst_mf->fltr.range.i_idx_len);
    ...
    case MAB_OAC_FIR_HDLR:
      ...
      {
        return mas_mab_exact_fltr_clone(
        &((MAB_MSG*)msg)->data.data.idx_free.idx_free_data.exact_idx_free, 
...
uns32 oac_fir_msg_encode(NCSMAB_IDX_FREE* ifree, NCS_UBAID* uba)
{
    ...
    if ((ifree->fltr_type != NCSMAB_FLTR_RANGE) ||
        (ifree->fltr_type != NCSMAB_FLTR_EXACT))
        return m_MAB_DBG_SINK(NCSCC_RC_FAILURE);
