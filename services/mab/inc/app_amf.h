...
EXTERN_C uns32
ncs_app_amf_invalid_state_process(void *, PW_ENV_ID, SaAmfCSIDescriptorT);  
...
ncs_app_amf_initialize(NCS_APP_AMF_ATTRIBS *);

/* Unregistration and Finalization with AMF Library */
EXTERN_C SaAisErrorT
ncs_app_amf_finalize(NCS_APP_AMF_ATTRIBS *);

/* Function to start timer to retry the initialisation of AMF interface. */
EXTERN_C uns32 
ncs_app_amf_init_start_timer(NCS_APP_AMF_INIT_TIMER* amf_init_timer);
