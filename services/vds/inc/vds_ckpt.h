...
#define VDS_CKPT_DBINFO_CKPT_NAME_LEN  strlen(VDS_CKPT_DBINFO_CKPT_NAME)
 
/* Macro definitions for section ID */
#define VDS_CKPT_LATEST_VDEST_SECTIONID     "vds_new_vdest"
#define VDS_CKPT_LATEST_VDEST_SECTIONID_LEN strlen(VDS_CKPT_LATEST_VDEST_SECTIONID)

/* Macro definitions for section of Version */
#define VDS_CKPT_VERSION_SECTIONID     "vds_version"
#define VDS_CKPT_VERSION_SECTIONID_LEN strlen(VDS_CKPT_VERSION_SECTIONID)
