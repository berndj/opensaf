...
int sendSyncGlobals(const struct NtfGlobals* ntfGlobals,
                    NCS_UBAID *uba);
...
int sendNewSubscription(unsigned int clientId,
...
int syncLoggedConfirm(unsigned int logged,
                      NCS_UBAID *uba);
void sendSubscriptionUpdate(unsigned int clientId,
                            unsigned int subscriptionId);
void sendUnsubscribeUpdate(unsigned int clientId,
                           unsigned int subscriptionId);
