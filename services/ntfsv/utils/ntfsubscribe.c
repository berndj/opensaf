...
static void exitIfFalse(int expression) /* instead of assert */
{
    if (!expression)
    {
        exit(1);
...
static void saNtfNotificationCallback(
    SaNtfSubscriptionIdT subscriptionId,
...
/* Subscribe */
static SaAisErrorT subscribeForNotifications(
    const saNotificationFilterAllocationParamsT *notificationFilterAllocationParams,
    SaNtfSubscriptionIdT subscriptionId)
{
    ...
    errorCode = saNtfNotificationSubscribe(&notificationFilterHandles,
        subscriptionId);
