...
const NCSFL_STR mqnd_hdln_set[] = {
  ...
  { MQND_MIBLIB_TBL_REQ_SUCCESS,"MQND - Miblib request is success"},
  { MQND_MIBLIB_TBL_REQ_FAILED,"MQND - Miblib request is Failed"},
  { MQND_MIB_MSGQ_TBL_REG_WITH_MAB_SUCCESS,"MQND - MSGQ table Reg with MAB Success"},
  { MQND_MIB_MSGQ_TBL_REG_WITH_MAB_FAILED,"MQND - MSGQ table Reg with MAB failed"},
  { MQND_MIB_MSGQPR_TBL_REG_WITH_MAB_SUCCESS,"MQND - MSGQ Priority table Reg with MAB Success"},
  { MQND_MIB_MSGQPR_TBL_REG_WITH_MAB_FAILED,"MQND - MSGQ Priority table Reg with MAB Failed"},
  { MQND_MIB_MSGQ_TBL_DEREG_WITH_MAB_SUCCESS,"MQND - MSGQ table deReg with MAB Success"},
  { MQND_MIB_MSGQ_TBL_DEREG_WITH_MAB_FAILED,"MQND - MSGQ table deReg with MAB failed"},
  { MQND_MIB_MSGQPR_TBL_DEREG_WITH_MAB_SUCCESS,"MQND - MSGQ Priority table deReg with MAB Success"},
  { MQND_MIB_MSGQPR_TBL_DEREG_WITH_MAB_FAILED,"MQND - MSGQ Priority table deReg with MAB Failed"},
  { MQND_MSGQTBL_REG_WITH_MIBLIB_SUCCESS,"MQND - MSGQ Tbl Reg with Miblib Success"},
  { MQND_MSGQTBL_REG_WITH_MIBLIB_FAILED,"MQND - MSGQ Tbl Reg with Miblib Failed"},
  { MQND_MSGQPRTBL_REG_WITH_MIBLIB_SUCCESS,"MQND - MSGQ Priority Tbl Reg with Miblib Success"},
  { MQND_MSGQPRTBL_REG_WITH_MIBLIB_FAILED,"MQND - MSGQ Priority Tbl Reg with Miblib Failed"},
  { MQND_REG_WITH_MIBLIB_FAILED,"MQND - Reg with MIBLIB Failed"}, 
  { MQND_REG_WITH_MAB_FAILED,"MQND - Reg with MAB Failed"}, 
  ...
  { MQND_Q_ROW_REG_WITH_MIB_FAILED,"MQND - Queue Tbl Row Reg with MIB failed"}, 
  { MQND_QPR_TBL_ROW_REG_WITH_MIB_FAILED,"MQND - Queue Priiority Tbl Row Reg with MIB failed"}, 
  ...
  { MQND_MSGQ_TBL_EXACT_FLTR_UNREGISTER_FAILED,"MQND - Exact filter deReg with MAB Failed"},
  { MQND_MSGQ_TBL_EXACT_FLTR_UNREGISTER_SUCCESS,"MQND - Exact filter deReg with MAB Success"},
  ...
  { MQND_MIB_NODE_INSERTED_INTO_GROUP,"MQND - The queue is inserted into a group"},
  { MQND_MIB_NODE_REMOVED_FROM_GROUP,"MQND - The queue is removed from a group"},
  ...
  { MQND_Q_ATTR_COMPARE_FAILED,"MQND - Comparison between the Receive attributes and existing queue attributes Failed"},
  ...
  { MQND_QNODE_ADD_TO_DATABASE_FAILED,"MQND - During restart building, the database node is not added to the Database"},
...
NCSFL_FMAT mqnd_fmat_set[] = {
    {MQND_LID_HDLN, NCSFL_TYPE_TCLIL, "MQSv %s %14s:%5u:%s:%u\n"},
    {0, 0, 0}
};
