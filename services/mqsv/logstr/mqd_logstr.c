...
const NCSFL_STR mqd_hdln_set[] = {
   ...
   {MQD_RED_STANDBY_COLD_SYNC_RESP_DECODE_SUCCESS,"MQD - Standby: Decode call back of Cold Sync Response success"},
   ...
   {MQD_RED_STANDBY_WARM_SYNC_RESP_DECODE_SUCCESS,"MQD - Standby: Decode call back of Warm Sync Response success"},
   ...
   {MQD_MIB_TBL_REQ_SUCCESS,"MQD - Mibtable request Success"},
   {MQD_MIB_TBL_REQ_FAILED,"MQD - Mibtable request Failed"},
   {MQD_MIB_SCALAR_TBL_REG_WITH_MAB_FAILED,"MQD - Reg with MAB for Scalartable Failed"},
   {MQD_MIB_SCALAR_TBL_REG_WITH_MAB_SUCCESS,"MQD - Reg with MAB for Scalartable Success"},
   {MQD_MIB_SCALAR_TBL_ROW_OWNED_FAILED,"MQD - Reg Rowowned for ScalarEntry table Failed"},
   {MQD_MIB_SCALAR_TBL_ROW_OWNED_SUCCESS,"MQD - Reg Rowowned for ScalarEntry table Success"},
   {MQD_MIB_QGROUP_TBL_OWNED_FAILED,"MQD - Registerong table with MAB for Queue Group Entry table Failed"},
   {MQD_MIB_QGROUP_TBL_OWNED_SUCCESS,"MQD - Reg table with MAB for Queue Group Entry table Success"},
   {MQD_MIB_QGROUP_TBL_ROW_OWNED_FAILED,"MQD - Reg Rowowned for Queue GroupEntry table Failed"},
   {MQD_MIB_QGROUP_TBL_ROW_OWNED_SUCCESS,"MQD - Reg Rowowned for Queue GroupEntry table Success"},
   {MQD_MIB_QGROUP_MEMBERS_TBL_OWNED_FAILED,"MQD - Reg Tbl owned for Queue Groupmembers Entry Tbl Failed"},
   {MQD_MIB_QGROUP_MEMBERS_TBL_OWNED_SUCCESS,"MQD - Reg Tbl owned for Queue Groupmembers Entry Tbl Success"},
   {MQD_MIB_QGROUP_MEMBERS_TBL_ROW_OWNED_FAILED,"MQD - Reg Rowowned for Queue Group Members Entry table Failed"},
   {MQD_MIB_QGROUP_MEMBERS_TBL_ROW_OWNED_SUCCESS,"MQD - Reg Rowowned for Queue Group Members Entry table Success"},
   {MQD_MIB_SCALARTBL_UNREG_WITH_MAB_FAILED,"MQD - Dereg with MAB for Scalar Entry table Failure"},
   {MQD_MIB_SCALARTBL_UNREG_WITH_MAB_SUCCESS,"MQD - Dereg with MAB for Scalar Entry table Success"},
   {MQD_MIB_GRPENTRYTBL_UNREG_WITH_MAB_FAILED,"MQD - Dereg with MAB for Group Entry table Failed"},
   {MQD_MIB_GRPENTRYTBL_UNREG_WITH_MAB_SUCCESS,"MQD - Dereg with MAB for Group Entry table Success"},
   {MQD_MIB_GRPMEMBRSENTRYTBL_UNREG_WITH_MAB_FAILED,"MQD - Dereg with MAB for Group Members Entry table Failed"},
   {MQD_MIB_GRPMEMBRSENTRYTBL_UNREG_WITH_MAB_SUCCESS,"MQD - Dereg with MAB for Group Members Entry table Success"},
   {MQD_MIB_SCALARTBL_REG_WITH_MIBLIB_FAILED,"MQD - Reg with MIBLIB for Scalar Entry table Failed"},
   {MQD_MIB_SCALARTBL_REG_WITH_MIBLIB_SUCCESS,"MQD - Reg with MIBLIB for Scalar Entry table Success"},
   {MQD_MIB_GRPENTRYTBL_REG_WITH_MIBLIB_FAILED,"MQD - Reg with MIBLIB for Group Entry table Failed"},
   {MQD_MIB_GRPENTRYTBL_REG_WITH_MIBLIB_SUCCESS,"MQD - Reg with MIBLIB for Group Entry table Success"},
   {MQD_MIB_GRPMEMBERSENTRYTBL_REG_WITH_MIBLIB_FAILED,"MQD - Reg with MIBLIB for Group Members Entry table Success"},
   {MQD_MIB_GRPMEMBERSENTRYTBL_REG_WITH_MIBLIB_SUCCESS,"MQD - Reg with MIBLIB for Group Members Entry table Success"},
   ...
   {MQD_MDS_MSG_COMP_EVT_SEND_FAILED,"MQD - In CSI SET Callback the message of type COMP sending to the mailbox failed"},
   {MQD_QUISCED_VDEST_CHGROLE_FAILED,"MQD - During processing of Quisced state, VDEST Role change to Queisced Failed"},
   {MQD_QUISCED_VDEST_CHGROLE_SUCCESS,"MQD - During processing of Quisced state, VDEST Role change to Queisced Successfully"},
   ...
   {MQD_DEREG_HDLR_MIB_EVT_SEND_SUCCESS,"MQD - Queue Deleted from the Group and MIB event send to MQND to update the Number of Queues in the Group"},
   {MQD_DEREG_HDLR_MIB_EVT_SEND_FAILED,"MQD - Queue Deleted from the Group and MIB event sendt to MQND to update the Number of Queues in the Group Failure"},
   ...
   {MQD_REG_HDLR_MIB_EVT_SEND_FAILED,"MQD - When inserting a queue to group MIB event Sent to the MQND Failed"},
   {MQD_REG_HDLR_MIB_EVT_SEND_SUCCESS,"MQD - When inserting a queue to group MIB event Sent to the MQND Success"},
...
/*    {MQD_LID_HDLN, NCSFL_TYPE_TILCL, "MQSv %s : %s : %u:%s:%u\n"},*/
    {MQD_LID_HDLN, NCSFL_TYPE_TCLIL, "MQSv %s %14s:%5u:%s:%u\n"},
    {0, 0, 0}
};
