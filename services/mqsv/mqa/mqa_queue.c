...
uns32 mqa_timer_table_init(MQA_CB *mqa_cb)
{
   ...
   {
      m_LOG_MQSV_A(MQA_CB_TIMER_INIT_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,NCSCC_RC_FAILURE,__FILE__,__LINE__);
...
uns32 mqa_create_and_start_timer (MQP_ASYNC_RSP_MSG *mqa_callback,
                                  SaInvocationT invocation)
{
   ...
   {
      m_LOG_MQSV_A(MQA_CB_TMR_CREATE_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,NCSCC_RC_FAILURE,__FILE__,__LINE__);
      goto err1;
   }
   ...
   if(!node)
   {
      m_LOG_MQSV_A(MQA_TIMER_NODE_ALLOC_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,NCSCC_RC_FAILURE,__FILE__,__LINE__);
      goto err4;
   }
