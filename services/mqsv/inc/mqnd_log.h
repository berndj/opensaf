...
typedef enum mqnd_hdln_log_flex
{
   ...
   MQND_MIBLIB_TBL_REQ_SUCCESS,
   MQND_MIBLIB_TBL_REQ_FAILED,
   MQND_MIB_MSGQ_TBL_REG_WITH_MAB_SUCCESS,
   MQND_MIB_MSGQ_TBL_REG_WITH_MAB_FAILED,
   MQND_MIB_MSGQPR_TBL_REG_WITH_MAB_SUCCESS,
   MQND_MIB_MSGQPR_TBL_REG_WITH_MAB_FAILED,
   MQND_MIB_MSGQ_TBL_DEREG_WITH_MAB_SUCCESS,
   MQND_MIB_MSGQ_TBL_DEREG_WITH_MAB_FAILED,
   MQND_MIB_MSGQPR_TBL_DEREG_WITH_MAB_SUCCESS,
   MQND_MIB_MSGQPR_TBL_DEREG_WITH_MAB_FAILED,
   MQND_MSGQTBL_REG_WITH_MIBLIB_SUCCESS,
   MQND_MSGQTBL_REG_WITH_MIBLIB_FAILED,
   MQND_MSGQPRTBL_REG_WITH_MIBLIB_SUCCESS,
   MQND_MSGQPRTBL_REG_WITH_MIBLIB_FAILED,
   MQND_REG_WITH_MIBLIB_FAILED,
   MQND_REG_WITH_MAB_FAILED,
   ...
   MQND_Q_ROW_REG_WITH_MIB_FAILED,
   MQND_QPR_TBL_ROW_REG_WITH_MIB_FAILED,
   ...
   MQND_MSGQ_TBL_EXACT_FLTR_UNREGISTER_FAILED,
   MQND_MSGQ_TBL_EXACT_FLTR_UNREGISTER_SUCCESS,
   ...
   MQND_MIB_NODE_INSERTED_INTO_GROUP,
   MQND_MIB_NODE_REMOVED_FROM_GROUP,
