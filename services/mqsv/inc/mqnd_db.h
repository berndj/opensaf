...
typedef struct mqnd_queue_info 
{
   ...
   uns32                mab_rec_row_hdl;
   uns32                mab_rec_priority_row_hdl[SA_MSG_MESSAGE_LOWEST_PRIORITY+1]; 
...
EXTERN_C void mqnd_qname_node_getnext(MQND_CB *cb, 
                                      SaNameT qname, 
...
EXTERN_C void mqnd_queue_node_getnext(MQND_CB *cb, 
                                      SaMsgQueueHandleT qhdl, 
...
EXTERN_C uns32 mqnd_mq_msg_send(uns32 qhdl, 
                       MQSV_MESSAGE   *i_msg, 
                       uns32           i_len);
