...
static uns32 mqd_copy_data_to_cold_sync_structure(MQD_OBJ_INFO *obj_info,
...
void mqd_a2s_async_update(MQD_CB* pMqd,MQD_A2S_MSG_TYPE type,void *pmesg)
{
  ...
  m_NCS_OS_MEMSET(&async_msg,0, sizeof(MQD_A2S_MSG));
  async_msg.type = type;
  switch(type)
  {
...
uns32  mqd_mbcsv_finalize(MQD_CB *pMqd)
{
   ...
   {
       rc = NCSCC_RC_FAILURE;
       m_LOG_MQSV_D(MQD_RED_MBCSV_FINALIZE_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
   }
   return rc;
}
...
static uns32  mqd_mbcsv_selobj_get(MQD_CB *pMqd)
{
    ...
    {
       rc = NCSCC_RC_FAILURE;
       m_LOG_MQSV_D(MQD_RED_MBCSV_SELOBJGET_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
    }
...
at the time of amf_init where csi_set_callback will assign the state*/      
   ...
   m_LOG_MQSV_D(MQD_RED_MBCSV_CHGROLE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_NOTICE,pMqd->ha_state,__FILE__,__LINE__);
   return rc;
}
...
static uns32  mqd_mbcsv_async_update(MQD_CB *pMqd,MQD_A2S_MSG *pasync_msg)
{
  ...
  /* arg.info.send_ckpt.i_send_type= NCS_MBCSV_SND_USR_ASYNC;*/
   ...
   if(ncs_mbcsv_svc(&arg) != SA_AIS_OK)
   {
      m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,pasync_msg->type,__FILE__,__LINE__);
      rc = NCSCC_RC_FAILURE;
   }
   m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_INFO,pasync_msg->type,__FILE__,__LINE__);
   return rc;
}
...
static uns32  mqd_ckpt_encode_async_update(MQD_CB *pMqd,NCS_MBCSV_CB_ARG *arg)
{
   ...
   rc = m_NCS_EDU_EXEC(&pMqd->edu_hdl,mqsv_edp_mqd_a2s_msg,&arg->info.encode.io_uba,EDP_OP_TYPE_ENC, mqd_msg,&ederror);
   if(rc != NCSCC_RC_SUCCESS)
   {
      switch(mqd_msg->type)
      {
          case MQD_A2S_MSG_TYPE_REG:
             m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_REG_ENC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
             rc = NCSCC_RC_FAILURE;
             break;

          case MQD_A2S_MSG_TYPE_DEREG:
             m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_DEREG_ENC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
             rc = NCSCC_RC_FAILURE;
             break;
 
          case MQD_A2S_MSG_TYPE_TRACK:
             m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_TRACK_ENC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
             rc = NCSCC_RC_FAILURE;
             break;

          case MQD_A2S_MSG_TYPE_USEREVT:
             m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_USEREVT_ENC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
             rc = NCSCC_RC_FAILURE;  
             break;
          case MQD_A2S_MSG_TYPE_MQND_STATEVT:
             m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_NDSTAT_ENC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
             rc = NCSCC_RC_FAILURE;
             break;
          case MQD_A2S_MSG_TYPE_MQND_TIMER_EXPEVT:
             m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_NDTMREXP_ENC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
             rc = NCSCC_RC_FAILURE;
             break;
          default:
             break;
...
static uns32 mqd_ckpt_decode_async_update(MQD_CB *pMqd,NCS_MBCSV_CB_ARG *arg)
{
 ...
 /* To store the value of Async Update received */
   ...
   m_NCS_OS_MEMSET(mqd_msg,0,sizeof(MQD_A2S_MSG));

   rc = m_NCS_EDU_EXEC(&pMqd->edu_hdl,mqsv_edp_mqd_a2s_msg,&arg->info.decode.i_uba,EDP_OP_TYPE_DEC, &mqd_msg,&ederror);
   if(rc != NCSCC_RC_SUCCESS)
   {
      rc = NCSCC_RC_FAILURE;
      m_LOG_MQSV_D(MQD_RED_MBCSV_ASYNCUPDATE_REG_DEC_EDU_ERROR,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
      goto end;
   }
   ...
   if(rc != NCSCC_RC_SUCCESS)
   {
      ...
      {
         case MQD_A2S_MSG_TYPE_REG:
               m_LOG_MQSV_D(MQD_RED_STANDBY_REG_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               goto end;
         case MQD_A2S_MSG_TYPE_DEREG:
               m_LOG_MQSV_D(MQD_RED_STANDBY_DEREG_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               goto end;
         case MQD_A2S_MSG_TYPE_TRACK:
               m_LOG_MQSV_D(MQD_RED_STANDBY_TRACK_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               goto end;
         case MQD_A2S_MSG_TYPE_USEREVT:
               m_LOG_MQSV_D(MQD_RED_STANDBY_USEREVT_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               goto end;
         case MQD_A2S_MSG_TYPE_MQND_STATEVT:
               m_LOG_MQSV_D(MQD_RED_STANDBY_NDSTATINFO_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               goto end;
         case MQD_A2S_MSG_TYPE_MQND_TIMER_EXPEVT:
               m_LOG_MQSV_D(MQD_RED_STANDBY_NDTMREXP_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               goto end;
         default:
               goto end;
      }   
...
static uns32 mqd_mbcsv_ckpt_encode_cbk_handler(NCS_MBCSV_CB_ARG *arg)
{
  ...
  switch(arg->info.encode.io_msg_type)
  {
    ...
    case NCS_MBCSV_MSG_COLD_SYNC_RESP:     
         ...
         if(pMqd->ha_state == SA_AMF_HA_ACTIVE)
         {
            if(pMqd->qdb_up)
            {
               ...
               {
               #if (NCS_MQA_DEBUG==1)
                  m_LOG_MQSV_D(MQD_RED_ACTIVE_COLD_SYNC_RESP_ENCODE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
               #endif
               }
               else 
               {
                  m_LOG_MQSV_D(MQD_RED_ACTIVE_COLD_SYNC_RESP_ENCODE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_NOTICE,rc,__FILE__,__LINE__);
               }
             }
             else
             {
    ...
    case NCS_MBCSV_MSG_WARM_SYNC_RESP:
         ...
         if(rc != NCSCC_RC_SUCCESS)
         {
            m_LOG_MQSV_D(MQD_RED_ACTIVE_WARM_SYNC_RESP_ENCODE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
         }
         else 
         {
            m_LOG_MQSV_D(MQD_RED_ACTIVE_WARM_SYNC_RESP_ENCODE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_INFO,rc,__FILE__,__LINE__);
         }
         break;
    ...
    case NCS_MBCSV_MSG_DATA_RESP:
         rc= mqd_ckpt_encode_cold_sync_data(pMqd,arg);
         if(rc != NCSCC_RC_SUCCESS)
            m_LOG_MQSV_D(MQD_RED_ACTIVE_DATA_RESP_ENCODE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
         else 
            m_LOG_MQSV_D(MQD_RED_ACTIVE_DATA_RESP_ENCODE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_NOTICE,rc,__FILE__,__LINE__);
         break;
...
static uns32 mqd_mbcsv_ckpt_decode_cbk_handler(NCS_MBCSV_CB_ARG *arg)
{
  ...
  switch(arg->info.decode.i_msg_type)
  {
    ...
    case NCS_MBCSV_MSG_COLD_SYNC_REQ:    
         ...
         m_NCS_MEMSET(&pMqd->record_qindex_name, 0,sizeof(SaNameT));
         rc = NCSCC_RC_SUCCESS;
         break;
    ...
    case NCS_MBCSV_MSG_COLD_SYNC_RESP_COMPLETE:
         ...
         if(rc != NCSCC_RC_SUCCESS)
            m_LOG_MQSV_D(MQD_RED_STANDBY_COLD_SYNC_RESP_DECODE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
         else 
            m_LOG_MQSV_D(MQD_RED_STANDBY_COLD_SYNC_RESP_DECODE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_NOTICE,rc,__FILE__,__LINE__);
    ...
    case NCS_MBCSV_MSG_WARM_SYNC_RESP_COMPLETE:
         ...
         if(rc != NCSCC_RC_SUCCESS)
            m_LOG_MQSV_D(MQD_RED_STANDBY_WARM_SYNC_RESP_DECODE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
         else 
            m_LOG_MQSV_D(MQD_RED_STANDBY_WARM_SYNC_RESP_DECODE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_INFO,rc,__FILE__,__LINE__);
         break;
    ...
    case NCS_MBCSV_MSG_DATA_RESP_COMPLETE: 
         rc= mqd_ckpt_decode_cold_sync_resp(pMqd,arg);
         if(rc != NCSCC_RC_SUCCESS)
            m_LOG_MQSV_D(MQD_RED_STANDBY_DATA_RESP_DECODE_FAILURE,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
         else 
            m_LOG_MQSV_D(MQD_RED_STANDBY_DATA_RESP_DECODE_SUCCESS,NCSFL_LC_MQSV_INIT,NCSFL_SEV_NOTICE,rc,__FILE__,__LINE__);
         break;
...
static uns32  mqd_ckpt_decode_warm_sync_response(MQD_CB *pMqd, NCS_MBCSV_CB_ARG *arg)
{
    ...
    m_NCS_MEMSET(&ncs_arg,'\0',sizeof(NCS_MBCSV_ARG));
    ...
    else
    {
       ...
       if(rc != NCSCC_RC_SUCCESS)
       {
          m_LOG_MQSV_D(MQD_RED_MBCSV_DATA_REQ_SEND_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
          return rc;
       }
    }
    return rc;
...
static uns32  mqd_ckpt_encode_cold_sync_data(MQD_CB *pMqd, NCS_MBCSV_CB_ARG *arg)
{
   ...
   m_NCS_MEMSET(&queue_obj_info,0, sizeof(MQD_OBJ_INFO));
   m_NCS_MEMSET(&cold_sync_data,0, sizeof(MQD_A2S_MSG));
   m_NCS_MEMSET(&queue_name,0, sizeof(SaNameT));
   m_NCS_MEMSET(&queue_index_name,0, sizeof(SaNameT));
...
/*   m_HTON_SANAMET_LEN(queue_index_name.length);*/
   ...
   while(queue_record != NULL)
   {
      ...
      rc = mqd_copy_data_to_cold_sync_structure(&queue_obj_info,
                &cold_sync_data.info.qinfo);
      if(rc != NCSCC_RC_SUCCESS)
      {
         /* Log the EDU Error */
                ...
                MQD_A2S_QUEUE_INFO *mbcsv_info)
{
    ...
    m_NCS_MEMSET(mbcsv_info,0, sizeof(MQD_A2S_QUEUE_INFO));
    ...
    {
      mbcsv_info->track_info= m_MMGR_ALLOC_MQD_DEFAULT_VAL(mbcsv_info->track_cnt*sizeof(MQD_A2S_TRACK_INFO));
...
static uns32 mqd_ckpt_decode_cold_sync_resp(MQD_CB *pMqd,NCS_MBCSV_CB_ARG *arg)
{
   ...
   m_NCS_OS_MEMSET(mbcsv_info, 0,sizeof(MQD_A2S_QUEUE_INFO)); 
...
static uns32 mqd_a2s_make_record_from_coldsync(MQD_CB* pMqd,MQD_A2S_QUEUE_INFO q_data_msg)
{
  ...
  /* m_HTON_SANAMET_LEN(record_qindex_name.length);a*/
   ...
   if(!q_obj_node)
   {
      ...
      {
         rc = NCSCC_RC_FAILURE;
         m_LOG_MQSV_D(MQD_OBJ_NODE_ALLOC_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
         return NCSCC_RC_FAILURE;
      }
      new_record=1;
   }  
  ...
  for(index=0;index<q_data_msg.track_cnt;index++)
  {
       ...
       {
          rc = NCSCC_RC_FAILURE;
          m_LOG_MQSV_D(MQD_RED_TRACK_OBJ_ALLOC_FAILED,NCSFL_LC_MQSV_INIT,NCSFL_SEV_ERROR,rc,__FILE__,__LINE__);
          return NCSCC_RC_FAILURE;
       }
       m_NCS_MEMSET(q_track_obj,0,sizeof(MQD_TRACK_OBJ));
