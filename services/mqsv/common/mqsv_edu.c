                                ...
                                EDU_ERR *o_err)
{
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, mqsv_edp_mqsv_evt_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
    return rc;
}
                                ...
                                EDU_ERR *o_err)
{
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, mqsv_message_info_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
    return rc;
                                ...
                                EDU_ERR *o_err)
{
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, mqsv_queue_usage_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
    return rc;
}
                                ...
                                EDU_ERR *o_err)
{
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, mqsv_queue_status_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
    return rc;
}
                                ...
                                EDU_ERR *o_err)
{
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, mqsv_mqa_callback_rules, struct_ptr, 
            ptr_data_len, buf_env, op, o_err);
    return rc;
}
...
static int mqsv_edp_mqnd_ctrl_msg_test_type_fnc(NCSCONTEXT arg)
{
    typedef enum {
        ...
        LCL_TEST_JUMP_OFFSET_MQND_CTRL_EVT_QGRP_CNT_RSP = 5
    }LCL_TEST_JUMP_OFFSET;
    SaBoolT   type;
                                ...
                                EDU_ERR *o_err)
{
    ...
    rc = m_NCS_EDU_RUN_RULES(hdl, edu_tkn, mqsv_qgrp_cnt_info_rules, struct_ptr,
            ptr_data_len, buf_env, op, o_err);
    return rc;
}
