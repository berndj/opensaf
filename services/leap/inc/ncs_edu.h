...
EXTERN_C uns32 ncs_edu_run_edcompile_on_edp(EDU_HDL *edu_hdl,
...
EXTERN_C NCS_BOOL ncs_edu_return_builtin_edp_size(EDU_PROG_HANDLER prog, 
                                                  uns32 *o_size);

EXTERN_C EDU_LABEL
    ncs_edu_run_test_ll_rule(EDU_INST_SET *rule, 
                    NCSCONTEXT ptr, 
                    EDP_OP_TYPE optype,
                    EDU_ERR *o_err);
...
EXTERN_C uns32 
ncs_edu_get_refcount_of_testable_field(EDP_TEST_INSTR_REC *inst_store, 
                                         EDU_INST_SET *rule);
...
EXTERN_C LEAPDLL_API uns32 ncs_encode_tlv_n_32bit(uns8 **stream, 
                                                  uns32 *val_ptr, 
                                                  uns16 n_count);

EXTERN_C LEAPDLL_API uns32 ncs_encode_tlv_n_16bit(uns8 **stream, 
                                                  uns16 *val_ptr, 
                                                  uns16 n_count);

EXTERN_C LEAPDLL_API uns32 ncs_encode_tlv_n_octets(uns8 **stream, uns8 *val, 
                                             uns16 count);
...
EXTERN_C LEAPDLL_API uns8* ncs_decode_tlv_n_octets(uns8 *src, uns8 *dest, 
                                                   uns32 count);

EXTERN_C LEAPDLL_API uns8* ncs_copy_tlv_n_octets(uns8 *src, uns8 *dest, 
                                                 uns32 count);
