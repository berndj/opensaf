...
const char *saf_notification_types[] =
{
		"NONE",
...
#define SA_AIS_ERR_UNAVAILABLE 31
...
void safassert_impl(const char* file, unsigned int line, SaAisErrorT rc, SaAisErrorT expected, int die)
{
    if (rc != expected)
    {
